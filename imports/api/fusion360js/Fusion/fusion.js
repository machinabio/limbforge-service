...
(function (root, factory) {
    ...
    adsk.fusion.AreaProperties = function AreaProperties(handle) {
        if (!(this instanceof adsk.fusion.AreaProperties)) {
            return adsk.fusion.AreaProperties.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.AreaProperties.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.AreaProperties.prototype.constructor = adsk.fusion.AreaProperties;
    adsk.fusion.AreaProperties.classType = function classType () {
        return 'adsk::fusion::AreaProperties';
    };
    adsk.fusion.AreaProperties.interfaceId = 'adsk.fusion.AreaProperties';
    adsk.objectTypes['adsk.fusion.AreaProperties'] = adsk.fusion.AreaProperties;
    adsk.fusion.AreaProperties.cast = function (object) {
        return object instanceof adsk.fusion.AreaProperties ? object : null;
    };

    // Gets the area in the square centimeters.
    Object.defineProperty(adsk.fusion.AreaProperties.prototype, 'area', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.AreaProperties.prototype, 'centroid', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.AreaProperties.prototype, 'perimeter', {
        get : function () {
            var result = this._execute('perimeter');
            return result ? result.value : undefined;
        }
    });

    // Gets the angle of rotation of the principal axes.
    Object.defineProperty(adsk.fusion.AreaProperties.prototype, 'rotationToPrincipal', {
        get : function () {
            var result = this._execute('rotationToPrincipal');
            return result ? result.value : undefined;
        }
    });

    // Returns the accuracy that was used for the calculation.
    Object.defineProperty(adsk.fusion.AreaProperties.prototype, 'accuracy', {
        get : function () {
            var result = this._execute('accuracy');
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.AreaProperties.prototype.getPrincipalAxes = function (xAxis, yAxis) {
        ...
        var result = this._execute('getPrincipalAxes', args);
        return result ? result.value : undefined;
    };
    ...
    // Returns true if successful
    adsk.fusion.AreaProperties.prototype.getMomentsOfInertia = function (ixx, iyy, izz, ixy, iyz, ixz) {
        if (typeof ixx !== 'object') { throw new TypeError('ixx must be an object'); }
        if (typeof iyy !== 'object') { throw new TypeError('iyy must be an object'); }
        if (typeof izz !== 'object') { throw new TypeError('izz must be an object'); }
        if (typeof ixy !== 'object') { throw new TypeError('ixy must be an object'); }
        if (typeof iyz !== 'object') { throw new TypeError('iyz must be an object'); }
        if (typeof ixz !== 'object') { throw new TypeError('ixz must be an object'); }
        var args = {
            ixx : null,
            iyy : null,
            izz : null,
        ...
        var result = this._execute('getMomentsOfInertia', args);
        if (result && result.outargs) {
            ixx.value = (result.outargs.ixx !== undefined) ? result.outargs.ixx : undefined;
            iyy.value = (result.outargs.iyy !== undefined) ? result.outargs.iyy : undefined;
            izz.value = (result.outargs.izz !== undefined) ? result.outargs.izz : undefined;
            ixy.value = (result.outargs.ixy !== undefined) ? result.outargs.ixy : undefined;
            iyz.value = (result.outargs.iyz !== undefined) ? result.outargs.iyz : undefined;
            ixz.value = (result.outargs.ixz !== undefined) ? result.outargs.ixz : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    // ixz : Output Double that returns the XZ partial moment.
    // Returns true if successful
    adsk.fusion.AreaProperties.prototype.getCentroidMomentsOfInertia = function (ixx, iyy, izz, ixy, iyz, ixz) {
        if (typeof ixx !== 'object') { throw new TypeError('ixx must be an object'); }
        if (typeof iyy !== 'object') { throw new TypeError('iyy must be an object'); }
        if (typeof izz !== 'object') { throw new TypeError('izz must be an object'); }
        if (typeof ixy !== 'object') { throw new TypeError('ixy must be an object'); }
        ...
        var result = this._execute('getCentroidMomentsOfInertia', args);
        if (result && result.outargs) {
            ixx.value = (result.outargs.ixx !== undefined) ? result.outargs.ixx : undefined;
            iyy.value = (result.outargs.iyy !== undefined) ? result.outargs.iyy : undefined;
            izz.value = (result.outargs.izz !== undefined) ? result.outargs.izz : undefined;
    ...
    // Returns true if successful
    adsk.fusion.AreaProperties.prototype.getPrincipalMomentsOfInertia = function (i1, i2, i3) {
        if (typeof i1 !== 'object') { throw new TypeError('i1 must be an object'); }
        if (typeof i2 !== 'object') { throw new TypeError('i2 must be an object'); }
        if (typeof i3 !== 'object') { throw new TypeError('i3 must be an object'); }
        var args = {
            i1 : null,
            i2 : null,
            i3 : null
        };
        var result = this._execute('getPrincipalMomentsOfInertia', args);
        if (result && result.outargs) {
            i1.value = (result.outargs.i1 !== undefined) ? result.outargs.i1 : undefined;
            i2.value = (result.outargs.i2 !== undefined) ? result.outargs.i2 : undefined;
            i3.value = (result.outargs.i3 !== undefined) ? result.outargs.i3 : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    // Returns true if successful
    adsk.fusion.AreaProperties.prototype.getRadiusOfGyration = function (kxx, kyy, kzz) {
        if (typeof kxx !== 'object') { throw new TypeError('kxx must be an object'); }
        if (typeof kyy !== 'object') { throw new TypeError('kyy must be an object'); }
        if (typeof kzz !== 'object') { throw new TypeError('kzz must be an object'); }
        var args = {
            kxx : null,
            kyy : null,
            kzz : null
        };
        var result = this._execute('getRadiusOfGyration', args);
        if (result && result.outargs) {
            kxx.value = (result.outargs.kxx !== undefined) ? result.outargs.kxx : undefined;
            kyy.value = (result.outargs.kyy !== undefined) ? result.outargs.kyy : undefined;
            kzz.value = (result.outargs.kzz !== undefined) ? result.outargs.kzz : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.Design.classType = function classType () {
    ...
    // Gets and sets the current design type (DirectDesignType or ParametricDesignType) Changing an exising design from ParametricDesignType to DirectDesignType will result in the timeline and all design history being removed and further operations will not be captured in the timeline.
    ...
    // Gets whether the root component is the active edit target in the user interface. This is the same as checking the state of the radio button next to the root compoonent in the browser. To activate the root component use the ActivateRootComponent method.
    ...
    Object.defineProperty(adsk.fusion.Design.prototype, 'contactSets', {
        get : function () {
            var result = this._execute('contactSets');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ContactSets) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Design.prototype, 'isContactAnalysisEnabled', {
        get : function () {
            var result = this._execute('isContactAnalysisEnabled');
            return result ? result.value : undefined;
        },
        set : function (value) {
            ...
            var result = this._execute('isContactAnalysisEnabled', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Design.prototype, 'isContactSetAnalysis', {
        get : function () {
            var result = this._execute('isContactSetAnalysis');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isContactSetAnalysis', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.Design.prototype.areaProperties = function (inputs, accuracy) {
        if (inputs !== null && !(inputs instanceof adsk.core.ObjectCollection)) { throw new TypeError('inputs must be a adsk.core.ObjectCollection'); }
        if (accuracy === null || (accuracy !== undefined && !isFinite(accuracy))) { throw new TypeError('accuracy must be a number'); }
        var args = {
            inputs : (inputs === null ? inputs : inputs.handle)
        };
    ...
    // accuracy : Specifies the desired level of computational accuracy of the property calculations. The default value of 'LowCalculationAccuracy' returns results within a +/- 1% error margin.
    adsk.fusion.Design.prototype.physicalProperties = function (inputs, accuracy) {
        if (inputs !== null && !(inputs instanceof adsk.core.ObjectCollection)) { throw new TypeError('inputs must be a adsk.core.ObjectCollection'); }
        if (accuracy === null || (accuracy !== undefined && !isFinite(accuracy))) { throw new TypeError('accuracy must be a number'); }
        var args = {
            inputs : (inputs === null ? inputs : inputs.handle)
        ...
        var result = this._execute('physicalProperties', args);
    ...
    adsk.fusion.ExportManager.classType = function classType () {
        return 'adsk::fusion::ExportManager';
    };
    ...
    // Creates an createSTLExportOptions object that's used to export a design in STL format. Creation of the createSTLExportOptions object does not perform the export. You must pass this object to the ExportManager.execute method to perform the export. The createSTLExportOptions supports any available options when exporting to STL format.
    ...
    adsk.fusion.ExportOptions.classType = function classType () {
        return 'adsk::fusion::ExportOptions';
    };
    ...
    adsk.fusion.FeatureHealthStates = {
    ...
    adsk.fusion.FusionDefaultUnitsPreferences.classType = function classType () {
        return 'adsk::fusion::FusionDefaultUnitsPreferences';
    };
    ...
    adsk.fusion.FusionDocument.classType = function classType () {
        return 'adsk::fusion::FusionDocument';
    };
    ...
    adsk.fusion.FusionProductPreferences.classType = function classType () {
        return 'adsk::fusion::FusionProductPreferences';
    };
    ...
    Object.defineProperty(adsk.fusion.FusionProductPreferences.prototype, 'isAutoProjectGeometry', {
        get : function () {
            var result = this._execute('isAutoProjectGeometry');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isAutoProjectGeometry', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.FusionUnitsManager.classType = function classType () {
        return 'adsk::fusion::FusionUnitsManager';
    };
    ...
    adsk.fusion.InterferenceInput.classType = function classType () {
        return 'adsk::fusion::InterferenceInput';
    };
    ...
    adsk.fusion.InterferenceResult.classType = function classType () {
        return 'adsk::fusion::InterferenceResult';
    };
    ...
    adsk.fusion.InterferenceResults.classType = function classType () {
        return 'adsk::fusion::InterferenceResults';
    };
    ...
    adsk.fusion.ModelParameters.classType = function classType () {
        return 'adsk::fusion::ModelParameters';
    };
    ...
    adsk.fusion.Parameter.classType = function classType () {
        return 'adsk::fusion::Parameter';
    };
    ...
    Object.defineProperty(adsk.fusion.Parameter.prototype, 'attributes', {
        get : function () {
    ...
    adsk.fusion.ParameterList.classType = function classType () {
        return 'adsk::fusion::ParameterList';
    };
    ...
    adsk.fusion.PhysicalProperties.classType = function classType () {
        return 'adsk::fusion::PhysicalProperties';
    };
    ...
    // Returns the accuracy that was used for the calculation.
    Object.defineProperty(adsk.fusion.PhysicalProperties.prototype, 'accuracy', {
        get : function () {
            var result = this._execute('accuracy');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.fusion.PhysicalProperties.prototype, 'centerOfMass', {
        get : function () {
            var result = this._execute('centerOfMass');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        }
    });
    ...
    // Returns true if successful
    adsk.fusion.PhysicalProperties.prototype.getPrincipalAxes = function (xAxis, yAxis, zAxis) {
        if (typeof xAxis !== 'object') { throw new TypeError('xAxis must be an object'); }
        if (typeof yAxis !== 'object') { throw new TypeError('yAxis must be an object'); }
    ...
    // i3 : Output Double that specifies the third moment of inertia.
    // Returns true if successful
    adsk.fusion.PhysicalProperties.prototype.getPrincipalMomentsOfInertia = function (i1, i2, i3) {
        if (typeof i1 !== 'object') { throw new TypeError('i1 must be an object'); }
        if (typeof i2 !== 'object') { throw new TypeError('i2 must be an object'); }
        if (typeof i3 !== 'object') { throw new TypeError('i3 must be an object'); }
        var args = {
    ...
    // Returns true if successful
    adsk.fusion.PhysicalProperties.prototype.getRadiusOfGyration = function (kx, ky, kz) {
        if (typeof kx !== 'object') { throw new TypeError('kx must be an object'); }
        if (typeof ky !== 'object') { throw new TypeError('ky must be an object'); }
        if (typeof kz !== 'object') { throw new TypeError('kz must be an object'); }
        var args = {
            kx : null,
            ky : null,
            kz : null
        ...
        var result = this._execute('getRadiusOfGyration', args);
        if (result && result.outargs) {
            kx.value = (result.outargs.kx !== undefined) ? result.outargs.kx : undefined;
            ky.value = (result.outargs.ky !== undefined) ? result.outargs.ky : undefined;
            kz.value = (result.outargs.kz !== undefined) ? result.outargs.kz : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    // rz :
    // Returns true if successful
    adsk.fusion.PhysicalProperties.prototype.getRotationToPrincipal = function (rx, ry, rz) {
        if (typeof rx !== 'object') { throw new TypeError('rx must be an object'); }
        if (typeof ry !== 'object') { throw new TypeError('ry must be an object'); }
        if (typeof rz !== 'object') { throw new TypeError('rz must be an object'); }
        var args = {
            rx : null,
            ry : null,
            rz : null
        };
        var result = this._execute('getRotationToPrincipal', args);
        if (result && result.outargs) {
            rx.value = (result.outargs.rx !== undefined) ? result.outargs.rx : undefined;
            ry.value = (result.outargs.ry !== undefined) ? result.outargs.ry : undefined;
            rz.value = (result.outargs.rz !== undefined) ? result.outargs.rz : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    // Returns true if successful
    adsk.fusion.PhysicalProperties.prototype.getXYZMomentsOfInertia = function (xx, yy, zz, xy, yz, xz) {
        if (typeof xx !== 'object') { throw new TypeError('xx must be an object'); }
        if (typeof yy !== 'object') { throw new TypeError('yy must be an object'); }
        if (typeof zz !== 'object') { throw new TypeError('zz must be an object'); }
        if (typeof xy !== 'object') { throw new TypeError('xy must be an object'); }
        if (typeof yz !== 'object') { throw new TypeError('yz must be an object'); }
        if (typeof xz !== 'object') { throw new TypeError('xz must be an object'); }
        var args = {
            xx : null,
            yy : null,
            zz : null,
        ...
        var result = this._execute('getXYZMomentsOfInertia', args);
        if (result && result.outargs) {
            xx.value = (result.outargs.xx !== undefined) ? result.outargs.xx : undefined;
            yy.value = (result.outargs.yy !== undefined) ? result.outargs.yy : undefined;
            zz.value = (result.outargs.zz !== undefined) ? result.outargs.zz : undefined;
            xy.value = (result.outargs.xy !== undefined) ? result.outargs.xy : undefined;
            yz.value = (result.outargs.yz !== undefined) ? result.outargs.yz : undefined;
            xz.value = (result.outargs.xz !== undefined) ? result.outargs.xz : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.Snapshot.classType = function classType () {
        return 'adsk::fusion::Snapshot';
    };
    ...
    adsk.fusion.Snapshots.classType = function classType () {
        return 'adsk::fusion::Snapshots';
    };
    ...
    adsk.fusion.Timeline.classType = function classType () {
        return 'adsk::fusion::Timeline';
    };
    ...
    adsk.fusion.TimelineGroups.classType = function classType () {
        return 'adsk::fusion::TimelineGroups';
    };
    ...
    adsk.fusion.TimelineObject.classType = function classType () {
        return 'adsk::fusion::TimelineObject';
    };
    ...
    Object.defineProperty(adsk.fusion.TimelineObject.prototype, 'healthState', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.TimelineObject.prototype, 'errorOrWarningMessage', {
        get : function () {
    ...
    adsk.fusion.UserParameters.classType = function classType () {
        return 'adsk::fusion::UserParameters';
    };
    ...
    adsk.fusion.FusionArchiveExportOptions.classType = function classType () {
        return 'adsk::fusion::FusionArchiveExportOptions';
    };
    ...
    adsk.fusion.IGESExportOptions.classType = function classType () {
        return 'adsk::fusion::IGESExportOptions';
    };
    ...
    adsk.fusion.ModelParameter.classType = function classType () {
        return 'adsk::fusion::ModelParameter';
    };
    ...
    adsk.fusion.SATExportOptions.classType = function classType () {
        return 'adsk::fusion::SATExportOptions';
    };
    ...
    adsk.fusion.SMTExportOptions.classType = function classType () {
        return 'adsk::fusion::SMTExportOptions';
    };
    ...
    adsk.fusion.STEPExportOptions.classType = function classType () {
        return 'adsk::fusion::STEPExportOptions';
    };
    ...
    adsk.fusion.STLExportOptions.classType = function classType () {
        return 'adsk::fusion::STLExportOptions';
    };
    ...
    // Gets and sets the current surface deviation, or the distance the mesh can deviate from the actual surface. This is defined in centimetre. Setting this property will automatically set the meshRefinement to MeshRefinementCustom. The default is the value associated with medium mesh refinement.
    ...
    // Gets and sets the maximum length of any mesh edge. This is defined in centimetre. Setting this property will automatically set the meshRefinement to MeshRefinementCustom. The default is the value associated with medium mesh refinement.
    ...
    adsk.fusion.TimelineGroup.classType = function classType () {
        return 'adsk::fusion::TimelineGroup';
    };
    ...
    adsk.fusion.UserParameter.classType = function classType () {
        return 'adsk::fusion::UserParameter';
    };
