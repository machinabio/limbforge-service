...
(function (root, factory) {
    ...
    adsk.core.BoundingBox2D = function BoundingBox2D(handle) {
        if (!(this instanceof adsk.core.BoundingBox2D)) {
            return adsk.core.BoundingBox2D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.BoundingBox2D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.BoundingBox2D.prototype.constructor = adsk.core.BoundingBox2D;
    adsk.core.BoundingBox2D.classType = function classType () {
        return 'adsk::core::BoundingBox2D';
    };
    adsk.core.BoundingBox2D.interfaceId = 'adsk.core.BoundingBox2D';
    adsk.objectTypes['adsk.core.BoundingBox2D'] = adsk.core.BoundingBox2D;
    adsk.core.BoundingBox2D.cast = function (object) {
        return object instanceof adsk.core.BoundingBox2D ? object : null;
    };

    // Gets and sets the minimum point of the box.
    Object.defineProperty(adsk.core.BoundingBox2D.prototype, 'minPoint', {
        get : function () {
            var result = this._execute('minPoint');
        ...
        set : function (value) {
            ...
            var result = this._execute('minPoint', args);
            return result ? result.value : undefined;
        }
    });

    // Gets and sets the maximum point of the box.
    Object.defineProperty(adsk.core.BoundingBox2D.prototype, 'maxPoint', {
        get : function () {
            var result = this._execute('maxPoint');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point2D) : null;
        },
        set : function (value) {
            if (value !== null && !(value instanceof adsk.core.Point2D)) { throw new TypeError('value must be a adsk.core.Point2D'); }
            ...
            var result = this._execute('maxPoint', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.BoundingBox2D.create = function (minPoint, maxPoint) {
        if (minPoint !== null && !(minPoint instanceof adsk.core.Point2D)) { throw new TypeError('minPoint must be a adsk.core.Point2D'); }
        if (maxPoint !== null && !(maxPoint instanceof adsk.core.Point2D)) { throw new TypeError('maxPoint must be a adsk.core.Point2D'); }
        var args = {
            minPoint : (minPoint === null ? minPoint : minPoint.handle),
            maxPoint : (maxPoint === null ? maxPoint : maxPoint.handle)
        };
        var result = adsk.core.Base._executeStatic('adsk.core.BoundingBox2D', 'create', args);
    ...
    adsk.core.BoundingBox2D.prototype.contains = function (point) {
    ...
    adsk.core.BoundingBox2D.prototype.expand = function (point) {
        if (point !== null && !(point instanceof adsk.core.Point2D)) { throw new TypeError('point must be a adsk.core.Point2D'); }
        var args = {
            point : (point === null ? point : point.handle)
        };
        var result = this._execute('expand', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.BoundingBox2D.prototype.intersects = function (boundingBox) {
        if (boundingBox !== null && !(boundingBox instanceof adsk.core.BoundingBox2D)) { throw new TypeError('boundingBox must be a adsk.core.BoundingBox2D'); }
        var args = {
            boundingBox : (boundingBox === null ? boundingBox : boundingBox.handle)
        };
        var result = this._execute('intersects', args);
        return result ? result.value : undefined;
    };

    // Create a copy of this bounding box.
    // Returns the new bounding box copy.
    adsk.core.BoundingBox2D.prototype.copy = function () {
    ...
    adsk.core.BoundingBox2D.prototype.combine = function (boundingBox) {
        if (boundingBox !== null && !(boundingBox instanceof adsk.core.BoundingBox2D)) { throw new TypeError('boundingBox must be a adsk.core.BoundingBox2D'); }
        var args = {
            boundingBox : (boundingBox === null ? boundingBox : boundingBox.handle)
        };
        var result = this._execute('combine', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.BoundingBox3D = function BoundingBox3D(handle) {
        if (!(this instanceof adsk.core.BoundingBox3D)) {
            return adsk.core.BoundingBox3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.BoundingBox3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.BoundingBox3D.prototype.constructor = adsk.core.BoundingBox3D;
    adsk.core.BoundingBox3D.classType = function classType () {
        return 'adsk::core::BoundingBox3D';
    };
    adsk.core.BoundingBox3D.interfaceId = 'adsk.core.BoundingBox3D';
    adsk.objectTypes['adsk.core.BoundingBox3D'] = adsk.core.BoundingBox3D;
    adsk.core.BoundingBox3D.cast = function (object) {
        return object instanceof adsk.core.BoundingBox3D ? object : null;
    };

    // Gets and sets the minimum point corner of the box.
    Object.defineProperty(adsk.core.BoundingBox3D.prototype, 'minPoint', {
        get : function () {
            var result = this._execute('minPoint');
    ...
    Object.defineProperty(adsk.core.BoundingBox3D.prototype, 'maxPoint', {
        get : function () {
            var result = this._execute('maxPoint');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        },
    ...
    adsk.core.BoundingBox3D.create = function (minPoint, maxPoint) {
        if (minPoint !== null && !(minPoint instanceof adsk.core.Point3D)) { throw new TypeError('minPoint must be a adsk.core.Point3D'); }
        if (maxPoint !== null && !(maxPoint instanceof adsk.core.Point3D)) { throw new TypeError('maxPoint must be a adsk.core.Point3D'); }
        var args = {
            minPoint : (minPoint === null ? minPoint : minPoint.handle),
            maxPoint : (maxPoint === null ? maxPoint : maxPoint.handle)
        };
        var result = adsk.core.Base._executeStatic('adsk.core.BoundingBox3D', 'create', args);
    ...
    adsk.core.BoundingBox3D.prototype.contains = function (point) {
    ...
    adsk.core.BoundingBox3D.prototype.expand = function (point) {
        if (point !== null && !(point instanceof adsk.core.Point3D)) { throw new TypeError('point must be a adsk.core.Point3D'); }
        var args = {
            point : (point === null ? point : point.handle)
        };
    ...
    adsk.core.BoundingBox3D.prototype.intersects = function (boundingBox) {
        if (boundingBox !== null && !(boundingBox instanceof adsk.core.BoundingBox3D)) { throw new TypeError('boundingBox must be a adsk.core.BoundingBox3D'); }
        var args = {
            boundingBox : (boundingBox === null ? boundingBox : boundingBox.handle)
        };
        var result = this._execute('intersects', args);
    ...
    adsk.core.BoundingBox3D.prototype.copy = function () {
        var result = this._execute('copy');
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.BoundingBox3D) : null;
    };
    ...
    // boundingBox : The other bounding box. It is not edited but is used to extend the boundaries of the bounding box the method is being called on.
    // Returns true if the combine was successful.
    adsk.core.BoundingBox3D.prototype.combine = function (boundingBox) {
        if (boundingBox !== null && !(boundingBox instanceof adsk.core.BoundingBox3D)) { throw new TypeError('boundingBox must be a adsk.core.BoundingBox3D'); }
        var args = {
            boundingBox : (boundingBox === null ? boundingBox : boundingBox.handle)
        };
    ...
    adsk.core.Curve2D = function Curve2D(handle) {
        if (!(this instanceof adsk.core.Curve2D)) {
            return adsk.core.Curve2D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Curve2D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Curve2D.prototype.constructor = adsk.core.Curve2D;
    adsk.core.Curve2D.classType = function classType () {
        return 'adsk::core::Curve2D';
    };
    adsk.core.Curve2D.interfaceId = 'adsk.core.Curve2D';
    adsk.objectTypes['adsk.core.Curve2D'] = adsk.core.Curve2D;
    adsk.core.Curve2D.cast = function (object) {
        return object instanceof adsk.core.Curve2D ? object : null;
    };
    ...
    adsk.core.Curve3D = function Curve3D(handle) {
        if (!(this instanceof adsk.core.Curve3D)) {
            return adsk.core.Curve3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Curve3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Curve3D.prototype.constructor = adsk.core.Curve3D;
    adsk.core.Curve3D.classType = function classType () {
        return 'adsk::core::Curve3D';
    };
    adsk.core.Curve3D.interfaceId = 'adsk.core.Curve3D';
    adsk.objectTypes['adsk.core.Curve3D'] = adsk.core.Curve3D;
    adsk.core.Curve3D.cast = function (object) {
        return object instanceof adsk.core.Curve3D ? object : null;
    };
    ...
    adsk.core.CurveEvaluator2D = function CurveEvaluator2D(handle) {
        if (!(this instanceof adsk.core.CurveEvaluator2D)) {
            return adsk.core.CurveEvaluator2D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.CurveEvaluator2D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.CurveEvaluator2D.prototype.constructor = adsk.core.CurveEvaluator2D;
    adsk.core.CurveEvaluator2D.classType = function classType () {
        return 'adsk::core::CurveEvaluator2D';
    };
    adsk.core.CurveEvaluator2D.interfaceId = 'adsk.core.CurveEvaluator2D';
    adsk.objectTypes['adsk.core.CurveEvaluator2D'] = adsk.core.CurveEvaluator2D;
    adsk.core.CurveEvaluator2D.cast = function (object) {
        return object instanceof adsk.core.CurveEvaluator2D ? object : null;
    };
    ...
    adsk.core.CurveEvaluator2D.prototype.getTangent = function (parameter, tangent) {
        ...
        var args = {
            parameter : Number(parameter),
            tangent : (tangent === null ? tangent : tangent.handle)
        };
    ...
    adsk.core.CurveEvaluator2D.prototype.getFirstDerivative = function (parameter, firstDerivative) {
        ...
        var args = {
            parameter : Number(parameter),
            firstDerivative : (firstDerivative === null ? firstDerivative : firstDerivative.handle)
        };
    ...
    adsk.core.CurveEvaluator2D.prototype.getSecondDerivative = function (parameter, secondDerivative) {
        ...
        var args = {
            parameter : Number(parameter),
            secondDerivative : (secondDerivative === null ? secondDerivative : secondDerivative.handle)
        };
    ...
    adsk.core.CurveEvaluator2D.prototype.getThirdDerivative = function (parameter, thirdDerivative) {
        ...
        var args = {
            parameter : Number(parameter),
            thirdDerivative : (thirdDerivative === null ? thirdDerivative : thirdDerivative.handle)
        };
    ...
    adsk.core.CurveEvaluator3D = function CurveEvaluator3D(handle) {
        if (!(this instanceof adsk.core.CurveEvaluator3D)) {
            return adsk.core.CurveEvaluator3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.CurveEvaluator3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.CurveEvaluator3D.prototype.constructor = adsk.core.CurveEvaluator3D;
    adsk.core.CurveEvaluator3D.classType = function classType () {
        return 'adsk::core::CurveEvaluator3D';
    };
    adsk.core.CurveEvaluator3D.interfaceId = 'adsk.core.CurveEvaluator3D';
    adsk.objectTypes['adsk.core.CurveEvaluator3D'] = adsk.core.CurveEvaluator3D;
    adsk.core.CurveEvaluator3D.cast = function (object) {
        return object instanceof adsk.core.CurveEvaluator3D ? object : null;
    };
    ...
    adsk.core.Matrix2D = function Matrix2D(handle) {
        if (!(this instanceof adsk.core.Matrix2D)) {
            return adsk.core.Matrix2D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Matrix2D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Matrix2D.prototype.constructor = adsk.core.Matrix2D;
    adsk.core.Matrix2D.classType = function classType () {
        return 'adsk::core::Matrix2D';
    };
    adsk.core.Matrix2D.interfaceId = 'adsk.core.Matrix2D';
    adsk.objectTypes['adsk.core.Matrix2D'] = adsk.core.Matrix2D;
    adsk.core.Matrix2D.cast = function (object) {
        return object instanceof adsk.core.Matrix2D ? object : null;
    };
    ...
    adsk.core.Matrix3D = function Matrix3D(handle) {
        if (!(this instanceof adsk.core.Matrix3D)) {
            return adsk.core.Matrix3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Matrix3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Matrix3D.prototype.constructor = adsk.core.Matrix3D;
    adsk.core.Matrix3D.classType = function classType () {
        return 'adsk::core::Matrix3D';
    };
    adsk.core.Matrix3D.interfaceId = 'adsk.core.Matrix3D';
    adsk.objectTypes['adsk.core.Matrix3D'] = adsk.core.Matrix3D;
    adsk.core.Matrix3D.cast = function (object) {
        return object instanceof adsk.core.Matrix3D ? object : null;
    };
    ...
    adsk.core.Point2D = function Point2D(handle) {
        if (!(this instanceof adsk.core.Point2D)) {
            return adsk.core.Point2D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Point2D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Point2D.prototype.constructor = adsk.core.Point2D;
    adsk.core.Point2D.classType = function classType () {
        return 'adsk::core::Point2D';
    };
    adsk.core.Point2D.interfaceId = 'adsk.core.Point2D';
    adsk.objectTypes['adsk.core.Point2D'] = adsk.core.Point2D;
    adsk.core.Point2D.cast = function (object) {
        return object instanceof adsk.core.Point2D ? object : null;
    };
    ...
    adsk.core.Point3D = function Point3D(handle) {
        if (!(this instanceof adsk.core.Point3D)) {
            return adsk.core.Point3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Point3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Point3D.prototype.constructor = adsk.core.Point3D;
    adsk.core.Point3D.classType = function classType () {
        return 'adsk::core::Point3D';
    };
    adsk.core.Point3D.interfaceId = 'adsk.core.Point3D';
    adsk.objectTypes['adsk.core.Point3D'] = adsk.core.Point3D;
    adsk.core.Point3D.cast = function (object) {
        return object instanceof adsk.core.Point3D ? object : null;
    };
    ...
    adsk.core.Surface = function Surface(handle) {
        if (!(this instanceof adsk.core.Surface)) {
            return adsk.core.Surface.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Surface.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Surface.prototype.constructor = adsk.core.Surface;
    adsk.core.Surface.classType = function classType () {
        return 'adsk::core::Surface';
    };
    adsk.core.Surface.interfaceId = 'adsk.core.Surface';
    adsk.objectTypes['adsk.core.Surface'] = adsk.core.Surface;
    adsk.core.Surface.cast = function (object) {
        return object instanceof adsk.core.Surface ? object : null;
    };
    ...
    adsk.core.SurfaceEvaluator = function SurfaceEvaluator(handle) {
        if (!(this instanceof adsk.core.SurfaceEvaluator)) {
            return adsk.core.SurfaceEvaluator.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.SurfaceEvaluator.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.SurfaceEvaluator.prototype.constructor = adsk.core.SurfaceEvaluator;
    adsk.core.SurfaceEvaluator.classType = function classType () {
        return 'adsk::core::SurfaceEvaluator';
    };
    adsk.core.SurfaceEvaluator.interfaceId = 'adsk.core.SurfaceEvaluator';
    adsk.objectTypes['adsk.core.SurfaceEvaluator'] = adsk.core.SurfaceEvaluator;
    adsk.core.SurfaceEvaluator.cast = function (object) {
        return object instanceof adsk.core.SurfaceEvaluator ? object : null;
    };
    ...
    adsk.core.SurfaceEvaluator.prototype.getCurvature = function (parameter, maxTangent, maxCurvature, minCurvature) {
        ...
        var args = {
            ...
            maxTangent : (maxTangent === null ? maxTangent : maxTangent.handle),
            maxCurvature : null,
            minCurvature : null
        };
        var result = this._execute('getCurvature', args);
    ...
    adsk.core.SurfaceEvaluator.prototype.getFirstDerivative = function (parameter, partialU, partialV) {
        ...
        var args = {
            parameter : (parameter === null ? parameter : parameter.handle),
            partialU : (partialU === null ? partialU : partialU.handle),
            partialV : (partialV === null ? partialV : partialV.handle)
        };
        var result = this._execute('getFirstDerivative', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.SurfaceEvaluator.prototype.getSecondDerivative = function (parameter, partialUU, partialUV, partialVV) {
        ...
        var args = {
            parameter : (parameter === null ? parameter : parameter.handle),
            partialUU : (partialUU === null ? partialUU : partialUU.handle),
            partialUV : (partialUV === null ? partialUV : partialUV.handle),
            partialVV : (partialVV === null ? partialVV : partialVV.handle)
        };
        var result = this._execute('getSecondDerivative', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.SurfaceEvaluator.prototype.getThirdDerivative = function (parameter, partialUUU, partialVVV) {
        ...
        var args = {
            parameter : (parameter === null ? parameter : parameter.handle),
            partialUUU : (partialUUU === null ? partialUUU : partialUUU.handle),
            partialVVV : (partialVVV === null ? partialVVV : partialVVV.handle)
        };
        var result = this._execute('getThirdDerivative', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.Vector2D = function Vector2D(handle) {
        if (!(this instanceof adsk.core.Vector2D)) {
            return adsk.core.Vector2D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Vector2D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Vector2D.prototype.constructor = adsk.core.Vector2D;
    adsk.core.Vector2D.classType = function classType () {
        return 'adsk::core::Vector2D';
    };
    adsk.core.Vector2D.interfaceId = 'adsk.core.Vector2D';
    adsk.objectTypes['adsk.core.Vector2D'] = adsk.core.Vector2D;
    adsk.core.Vector2D.cast = function (object) {
        return object instanceof adsk.core.Vector2D ? object : null;
    };
    ...
    adsk.core.Vector3D = function Vector3D(handle) {
        if (!(this instanceof adsk.core.Vector3D)) {
            return adsk.core.Vector3D.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.core.Vector3D.prototype = Object.create(adsk.core.Base.prototype);
    adsk.core.Vector3D.prototype.constructor = adsk.core.Vector3D;
    adsk.core.Vector3D.classType = function classType () {
        return 'adsk::core::Vector3D';
    };
    adsk.core.Vector3D.interfaceId = 'adsk.core.Vector3D';
    adsk.objectTypes['adsk.core.Vector3D'] = adsk.core.Vector3D;
    adsk.core.Vector3D.cast = function (object) {
        return object instanceof adsk.core.Vector3D ? object : null;
    };
    ...
    adsk.core.Arc2D = function Arc2D(handle) {
        if (!(this instanceof adsk.core.Arc2D)) {
            return adsk.core.Arc2D.cast(handle);
        }
        adsk.core.Curve2D.call(this, handle);
    };
    adsk.core.Arc2D.prototype = Object.create(adsk.core.Curve2D.prototype);
    adsk.core.Arc2D.prototype.constructor = adsk.core.Arc2D;
    adsk.core.Arc2D.classType = function classType () {
        return 'adsk::core::Arc2D';
    };
    adsk.core.Arc2D.interfaceId = 'adsk.core.Arc2D';
    adsk.objectTypes['adsk.core.Arc2D'] = adsk.core.Arc2D;
    adsk.core.Arc2D.cast = function (object) {
        return object instanceof adsk.core.Arc2D ? object : null;
    };

    // Gets and sets the center position of the arc.
    Object.defineProperty(adsk.core.Arc2D.prototype, 'center', {
        get : function () {
    ...
    adsk.core.Arc2D.createByCenter = function (center, radius, startAngle, endAngle, isClockwise) {
        ...
        if (isClockwise === null || (isClockwise !== undefined && typeof isClockwise !== 'boolean')) { throw new TypeError('isClockwise must be a boolean'); }
        var args = {
        ...
        if (isClockwise !== undefined) {
            args.isClockwise = isClockwise;
        }
        var result = adsk.core.Base._executeStatic('adsk.core.Arc2D', 'createByCenter', args);
    ...
    adsk.core.Arc3D = function Arc3D(handle) {
        if (!(this instanceof adsk.core.Arc3D)) {
            return adsk.core.Arc3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.Arc3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.Arc3D.prototype.constructor = adsk.core.Arc3D;
    adsk.core.Arc3D.classType = function classType () {
        return 'adsk::core::Arc3D';
    };
    adsk.core.Arc3D.interfaceId = 'adsk.core.Arc3D';
    adsk.objectTypes['adsk.core.Arc3D'] = adsk.core.Arc3D;
    adsk.core.Arc3D.cast = function (object) {
        return object instanceof adsk.core.Arc3D ? object : null;
    };
    ...
    adsk.core.Circle2D = function Circle2D(handle) {
        if (!(this instanceof adsk.core.Circle2D)) {
            return adsk.core.Circle2D.cast(handle);
        }
        adsk.core.Curve2D.call(this, handle);
    };
    adsk.core.Circle2D.prototype = Object.create(adsk.core.Curve2D.prototype);
    adsk.core.Circle2D.prototype.constructor = adsk.core.Circle2D;
    adsk.core.Circle2D.classType = function classType () {
        return 'adsk::core::Circle2D';
    };
    adsk.core.Circle2D.interfaceId = 'adsk.core.Circle2D';
    adsk.objectTypes['adsk.core.Circle2D'] = adsk.core.Circle2D;
    adsk.core.Circle2D.cast = function (object) {
        return object instanceof adsk.core.Circle2D ? object : null;
    };
    ...
    adsk.core.Circle3D = function Circle3D(handle) {
        if (!(this instanceof adsk.core.Circle3D)) {
            return adsk.core.Circle3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.Circle3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.Circle3D.prototype.constructor = adsk.core.Circle3D;
    adsk.core.Circle3D.classType = function classType () {
        return 'adsk::core::Circle3D';
    };
    adsk.core.Circle3D.interfaceId = 'adsk.core.Circle3D';
    adsk.objectTypes['adsk.core.Circle3D'] = adsk.core.Circle3D;
    adsk.core.Circle3D.cast = function (object) {
        return object instanceof adsk.core.Circle3D ? object : null;
    };
    ...
    adsk.core.Cone = function Cone(handle) {
        if (!(this instanceof adsk.core.Cone)) {
            return adsk.core.Cone.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.Cone.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.Cone.prototype.constructor = adsk.core.Cone;
    adsk.core.Cone.classType = function classType () {
        return 'adsk::core::Cone';
    };
    adsk.core.Cone.interfaceId = 'adsk.core.Cone';
    adsk.objectTypes['adsk.core.Cone'] = adsk.core.Cone;
    adsk.core.Cone.cast = function (object) {
        return object instanceof adsk.core.Cone ? object : null;
    };
    ...
    adsk.core.Cylinder = function Cylinder(handle) {
        if (!(this instanceof adsk.core.Cylinder)) {
            return adsk.core.Cylinder.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.Cylinder.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.Cylinder.prototype.constructor = adsk.core.Cylinder;
    adsk.core.Cylinder.classType = function classType () {
        return 'adsk::core::Cylinder';
    };
    adsk.core.Cylinder.interfaceId = 'adsk.core.Cylinder';
    adsk.objectTypes['adsk.core.Cylinder'] = adsk.core.Cylinder;
    adsk.core.Cylinder.cast = function (object) {
        return object instanceof adsk.core.Cylinder ? object : null;
    };
    ...
    adsk.core.Ellipse2D = function Ellipse2D(handle) {
        if (!(this instanceof adsk.core.Ellipse2D)) {
            return adsk.core.Ellipse2D.cast(handle);
        }
        adsk.core.Curve2D.call(this, handle);
    };
    adsk.core.Ellipse2D.prototype = Object.create(adsk.core.Curve2D.prototype);
    adsk.core.Ellipse2D.prototype.constructor = adsk.core.Ellipse2D;
    adsk.core.Ellipse2D.classType = function classType () {
        return 'adsk::core::Ellipse2D';
    };
    adsk.core.Ellipse2D.interfaceId = 'adsk.core.Ellipse2D';
    adsk.objectTypes['adsk.core.Ellipse2D'] = adsk.core.Ellipse2D;
    adsk.core.Ellipse2D.cast = function (object) {
        return object instanceof adsk.core.Ellipse2D ? object : null;
    };
    ...
    adsk.core.Ellipse3D = function Ellipse3D(handle) {
        if (!(this instanceof adsk.core.Ellipse3D)) {
            return adsk.core.Ellipse3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.Ellipse3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.Ellipse3D.prototype.constructor = adsk.core.Ellipse3D;
    adsk.core.Ellipse3D.classType = function classType () {
        return 'adsk::core::Ellipse3D';
    };
    adsk.core.Ellipse3D.interfaceId = 'adsk.core.Ellipse3D';
    adsk.objectTypes['adsk.core.Ellipse3D'] = adsk.core.Ellipse3D;
    adsk.core.Ellipse3D.cast = function (object) {
        return object instanceof adsk.core.Ellipse3D ? object : null;
    };
    ...
    adsk.core.EllipticalArc2D = function EllipticalArc2D(handle) {
        if (!(this instanceof adsk.core.EllipticalArc2D)) {
            return adsk.core.EllipticalArc2D.cast(handle);
        }
        adsk.core.Curve2D.call(this, handle);
    };
    adsk.core.EllipticalArc2D.prototype = Object.create(adsk.core.Curve2D.prototype);
    adsk.core.EllipticalArc2D.prototype.constructor = adsk.core.EllipticalArc2D;
    adsk.core.EllipticalArc2D.classType = function classType () {
        return 'adsk::core::EllipticalArc2D';
    };
    adsk.core.EllipticalArc2D.interfaceId = 'adsk.core.EllipticalArc2D';
    adsk.objectTypes['adsk.core.EllipticalArc2D'] = adsk.core.EllipticalArc2D;
    adsk.core.EllipticalArc2D.cast = function (object) {
        return object instanceof adsk.core.EllipticalArc2D ? object : null;
    };
    ...
    adsk.core.EllipticalArc3D = function EllipticalArc3D(handle) {
        if (!(this instanceof adsk.core.EllipticalArc3D)) {
            return adsk.core.EllipticalArc3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.EllipticalArc3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.EllipticalArc3D.prototype.constructor = adsk.core.EllipticalArc3D;
    adsk.core.EllipticalArc3D.classType = function classType () {
        return 'adsk::core::EllipticalArc3D';
    };
    adsk.core.EllipticalArc3D.interfaceId = 'adsk.core.EllipticalArc3D';
    adsk.objectTypes['adsk.core.EllipticalArc3D'] = adsk.core.EllipticalArc3D;
    adsk.core.EllipticalArc3D.cast = function (object) {
        return object instanceof adsk.core.EllipticalArc3D ? object : null;
    };
    ...
    adsk.core.EllipticalCone = function EllipticalCone(handle) {
        if (!(this instanceof adsk.core.EllipticalCone)) {
            return adsk.core.EllipticalCone.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.EllipticalCone.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.EllipticalCone.prototype.constructor = adsk.core.EllipticalCone;
    adsk.core.EllipticalCone.classType = function classType () {
        return 'adsk::core::EllipticalCone';
    };
    adsk.core.EllipticalCone.interfaceId = 'adsk.core.EllipticalCone';
    adsk.objectTypes['adsk.core.EllipticalCone'] = adsk.core.EllipticalCone;
    adsk.core.EllipticalCone.cast = function (object) {
        return object instanceof adsk.core.EllipticalCone ? object : null;
    };
    ...
    adsk.core.EllipticalCylinder = function EllipticalCylinder(handle) {
        if (!(this instanceof adsk.core.EllipticalCylinder)) {
            return adsk.core.EllipticalCylinder.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.EllipticalCylinder.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.EllipticalCylinder.prototype.constructor = adsk.core.EllipticalCylinder;
    adsk.core.EllipticalCylinder.classType = function classType () {
        return 'adsk::core::EllipticalCylinder';
    };
    adsk.core.EllipticalCylinder.interfaceId = 'adsk.core.EllipticalCylinder';
    adsk.objectTypes['adsk.core.EllipticalCylinder'] = adsk.core.EllipticalCylinder;
    adsk.core.EllipticalCylinder.cast = function (object) {
        return object instanceof adsk.core.EllipticalCylinder ? object : null;
    };
    ...
    adsk.core.InfiniteLine3D = function InfiniteLine3D(handle) {
        if (!(this instanceof adsk.core.InfiniteLine3D)) {
            return adsk.core.InfiniteLine3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.InfiniteLine3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.InfiniteLine3D.prototype.constructor = adsk.core.InfiniteLine3D;
    adsk.core.InfiniteLine3D.classType = function classType () {
        return 'adsk::core::InfiniteLine3D';
    };
    adsk.core.InfiniteLine3D.interfaceId = 'adsk.core.InfiniteLine3D';
    adsk.objectTypes['adsk.core.InfiniteLine3D'] = adsk.core.InfiniteLine3D;
    adsk.core.InfiniteLine3D.cast = function (object) {
        return object instanceof adsk.core.InfiniteLine3D ? object : null;
    };
    ...
    adsk.core.Line2D = function Line2D(handle) {
        if (!(this instanceof adsk.core.Line2D)) {
            return adsk.core.Line2D.cast(handle);
        }
        adsk.core.Curve2D.call(this, handle);
    };
    adsk.core.Line2D.prototype = Object.create(adsk.core.Curve2D.prototype);
    adsk.core.Line2D.prototype.constructor = adsk.core.Line2D;
    adsk.core.Line2D.classType = function classType () {
        return 'adsk::core::Line2D';
    };
    adsk.core.Line2D.interfaceId = 'adsk.core.Line2D';
    adsk.objectTypes['adsk.core.Line2D'] = adsk.core.Line2D;
    adsk.core.Line2D.cast = function (object) {
        return object instanceof adsk.core.Line2D ? object : null;
    };
    ...
    adsk.core.Line3D = function Line3D(handle) {
        if (!(this instanceof adsk.core.Line3D)) {
            return adsk.core.Line3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.Line3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.Line3D.prototype.constructor = adsk.core.Line3D;
    adsk.core.Line3D.classType = function classType () {
        return 'adsk::core::Line3D';
    };
    adsk.core.Line3D.interfaceId = 'adsk.core.Line3D';
    adsk.objectTypes['adsk.core.Line3D'] = adsk.core.Line3D;
    adsk.core.Line3D.cast = function (object) {
        return object instanceof adsk.core.Line3D ? object : null;
    };
    ...
    adsk.core.NurbsCurve2D = function NurbsCurve2D(handle) {
        if (!(this instanceof adsk.core.NurbsCurve2D)) {
            return adsk.core.NurbsCurve2D.cast(handle);
        }
        adsk.core.Curve2D.call(this, handle);
    };
    adsk.core.NurbsCurve2D.prototype = Object.create(adsk.core.Curve2D.prototype);
    adsk.core.NurbsCurve2D.prototype.constructor = adsk.core.NurbsCurve2D;
    adsk.core.NurbsCurve2D.classType = function classType () {
        return 'adsk::core::NurbsCurve2D';
    };
    adsk.core.NurbsCurve2D.interfaceId = 'adsk.core.NurbsCurve2D';
    adsk.objectTypes['adsk.core.NurbsCurve2D'] = adsk.core.NurbsCurve2D;
    adsk.core.NurbsCurve2D.cast = function (object) {
        return object instanceof adsk.core.NurbsCurve2D ? object : null;
    };
    ...
    adsk.core.NurbsCurve3D = function NurbsCurve3D(handle) {
        if (!(this instanceof adsk.core.NurbsCurve3D)) {
            return adsk.core.NurbsCurve3D.cast(handle);
        }
        adsk.core.Curve3D.call(this, handle);
    };
    adsk.core.NurbsCurve3D.prototype = Object.create(adsk.core.Curve3D.prototype);
    adsk.core.NurbsCurve3D.prototype.constructor = adsk.core.NurbsCurve3D;
    adsk.core.NurbsCurve3D.classType = function classType () {
        return 'adsk::core::NurbsCurve3D';
    };
    adsk.core.NurbsCurve3D.interfaceId = 'adsk.core.NurbsCurve3D';
    adsk.objectTypes['adsk.core.NurbsCurve3D'] = adsk.core.NurbsCurve3D;
    adsk.core.NurbsCurve3D.cast = function (object) {
        return object instanceof adsk.core.NurbsCurve3D ? object : null;
    };

    // Gets the number of control points that define the curve.
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'controlPointCount', {
        get : function () {
            var result = this._execute('controlPointCount');
            return result ? result.value : undefined;
        }
    ...
    // Returns the degree of the curve.
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'degree', {
        get : function () {
            var result = this._execute('degree');
            return result ? result.value : undefined;
        }
    ...
    // Returns the knot count of the curve.
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'knotCount', {
        get : function () {
            var result = this._execute('knotCount');
            return result ? result.value : undefined;
        }
    ...
    // Indicates if the curve is rational or non-rational type.
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'isRational', {
        get : function () {
            var result = this._execute('isRational');
            return result ? result.value : undefined;
        }
    ...
    // Indicates if the curve is closed.
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'isClosed', {
        get : function () {
            var result = this._execute('isClosed');
            return result ? result.value : undefined;
        }
    ...
    // Indicates if the curve is periodic.
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'isPeriodic', {
        get : function () {
            var result = this._execute('isPeriodic');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'controlPoints', {
        get : function () {
            var result = this._execute('controlPoints');
            if (!result || !Array.isArray(result.value)) {
                return undefined
    ...
    Object.defineProperty(adsk.core.NurbsCurve3D.prototype, 'knots', {
        get : function () {
            var result = this._execute('knots');
            return result ? result.value : undefined;
        }
    ...
    adsk.core.NurbsCurve3D.createNonRational = function (controlPoints, degree, knots, isPeriodic) {
        if (!Array.isArray(controlPoints)) { throw new TypeError('controlPoints must be an array'); }
        var controlPointsLength = controlPoints.length;
        var controlPointsIt;
        for (controlPointsIt = 0; controlPointsIt < controlPointsLength; ++controlPointsIt) {
            if (controlPoints[controlPointsIt] !== null && !(controlPoints[controlPointsIt] instanceof adsk.core.Point3D)) { throw new TypeError('controlPoints[controlPointsIt] must be a adsk.core.Point3D'); }
        }
        if (!isFinite(degree)) { throw new TypeError('degree must be a number'); }
        if (!Array.isArray(knots)) { throw new TypeError('knots must be an array'); }
        var knotsLength = knots.length;
        ...
        var result = adsk.core.Base._executeStatic('adsk.core.NurbsCurve3D', 'createNonRational', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.NurbsCurve3D) : null;
    };
    ...
    // isPeriodic : A bool specifying if the spline is to be Periodic. A periodic curve has a start point and end point that meet (with curvature continuity) forming a closed loop.
    // Returns the new NurbsCurve3D object or null if the creation failed.
    adsk.core.NurbsCurve3D.createRational = function (controlPoints, degree, knots, weights, isPeriodic) {
        if (!Array.isArray(controlPoints)) { throw new TypeError('controlPoints must be an array'); }
        var controlPointsLength = controlPoints.length;
        var controlPointsIt;
        for (controlPointsIt = 0; controlPointsIt < controlPointsLength; ++controlPointsIt) {
        ...
        var result = adsk.core.Base._executeStatic('adsk.core.NurbsCurve3D', 'createRational', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.NurbsCurve3D) : null;
    };
    ...
    // isPeriodic : The output value indicating if the spline is Periodic. A periodic curve has a start point and end point that meet (with curvature continuity) forming a closed loop.
    // Returns true if successful.
    adsk.core.NurbsCurve3D.prototype.getData = function (controlPoints, degree, knots, isRational, weights, isPeriodic) {
        if (typeof controlPoints !== 'object') { throw new TypeError('controlPoints must be an object'); }
        if (typeof degree !== 'object') { throw new TypeError('degree must be an object'); }
        if (typeof knots !== 'object') { throw new TypeError('knots must be an object'); }
        if (typeof isRational !== 'object') { throw new TypeError('isRational must be an object'); }
        ...
        if (result && result.outargs) {
            if (Array.isArray(result.outargs.controlPoints)) {
                ...
                controlPoints.value = [];
                for (controlPointsIter = 0; controlPointsIter < result.outargs.controlPoints.length; ++controlPointsIter) {
                    controlPoints.value[controlPointsIter] = (result.outargs.controlPoints[controlPointsIter] !== undefined) ? adsk.createObject(result.outargs.controlPoints[controlPointsIter], adsk.core.Point3D) : null;
                }
            }
            degree.value = (result.outargs.degree !== undefined) ? result.outargs.degree : undefined;
            if (Array.isArray(result.outargs.knots)) {
    ...
    // Returns true if successful.
    adsk.core.NurbsCurve3D.prototype.set = function (controlPoints, degree, knots, isRational, weights, isPeriodic) {
        if (!Array.isArray(controlPoints)) { throw new TypeError('controlPoints must be an array'); }
        var controlPointsLength = controlPoints.length;
        var controlPointsIt;
        for (controlPointsIt = 0; controlPointsIt < controlPointsLength; ++controlPointsIt) {
    ...
    adsk.core.NurbsSurface = function NurbsSurface(handle) {
        if (!(this instanceof adsk.core.NurbsSurface)) {
            return adsk.core.NurbsSurface.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.NurbsSurface.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.NurbsSurface.prototype.constructor = adsk.core.NurbsSurface;
    adsk.core.NurbsSurface.classType = function classType () {
        return 'adsk::core::NurbsSurface';
    };
    adsk.core.NurbsSurface.interfaceId = 'adsk.core.NurbsSurface';
    adsk.objectTypes['adsk.core.NurbsSurface'] = adsk.core.NurbsSurface;
    adsk.core.NurbsSurface.cast = function (object) {
        return object instanceof adsk.core.NurbsSurface ? object : null;
    };
    ...
    adsk.core.NurbsSurface.create = function (degreeU, degreeV, controlPointCountU, controlPointCountV, controlPoints, knotsU, knotsV, weights, propertiesU, propertiesV) {
        if (!isFinite(degreeU)) { throw new TypeError('degreeU must be a number'); }
        if (!isFinite(degreeV)) { throw new TypeError('degreeV must be a number'); }
        if (!isFinite(controlPointCountU)) { throw new TypeError('controlPointCountU must be a number'); }
        if (!isFinite(controlPointCountV)) { throw new TypeError('controlPointCountV must be a number'); }
        if (!Array.isArray(controlPoints)) { throw new TypeError('controlPoints must be an array'); }
        var controlPointsLength = controlPoints.length;
        var controlPointsIt;
        for (controlPointsIt = 0; controlPointsIt < controlPointsLength; ++controlPointsIt) {
        ...
        if (!Array.isArray(knotsU)) { throw new TypeError('knotsU must be an array'); }
        var knotsULength = knotsU.length;
        var knotsUIt;
        for (knotsUIt = 0; knotsUIt < knotsULength; ++knotsUIt) {
            if (!isFinite(knotsU[knotsUIt])) { throw new TypeError('knotsU[knotsUIt] must be a number'); }
        }
        if (!Array.isArray(knotsV)) { throw new TypeError('knotsV must be an array'); }
        var knotsVLength = knotsV.length;
        var knotsVIt;
        for (knotsVIt = 0; knotsVIt < knotsVLength; ++knotsVIt) {
            if (!isFinite(knotsV[knotsVIt])) { throw new TypeError('knotsV[knotsVIt] must be a number'); }
        }
        if (!Array.isArray(weights)) { throw new TypeError('weights must be an array'); }
        var weightsLength = weights.length;
        var weightsIt;
        ...
        if (!isFinite(propertiesU)) { throw new TypeError('propertiesU must be a number'); }
        if (!isFinite(propertiesV)) { throw new TypeError('propertiesV must be a number'); }
        var args = {
            degreeU : Number(degreeU),
            degreeV : Number(degreeV),
            controlPointCountU : Number(controlPointCountU),
            controlPointCountV : Number(controlPointCountV),
            controlPoints : controlPoints,
            knotsU : knotsU,
            knotsV : knotsV,
            weights : weights,
            propertiesU : Number(propertiesU),
            propertiesV : Number(propertiesV)
        };
        var result = adsk.core.Base._executeStatic('adsk.core.NurbsSurface', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.NurbsSurface) : null;
    };
    ...
    // Returns true if successful.
    adsk.core.NurbsSurface.prototype.getData = function (degreeU, degreeV, controlPointCountU, controlPointCountV, controlPoints, knotsU, knotsV, weights, propertiesU, propertiesV) {
        if (typeof degreeU !== 'object') { throw new TypeError('degreeU must be an object'); }
        if (typeof degreeV !== 'object') { throw new TypeError('degreeV must be an object'); }
        if (typeof controlPointCountU !== 'object') { throw new TypeError('controlPointCountU must be an object'); }
        if (typeof controlPointCountV !== 'object') { throw new TypeError('controlPointCountV must be an object'); }
        if (typeof controlPoints !== 'object') { throw new TypeError('controlPoints must be an object'); }
        if (typeof knotsU !== 'object') { throw new TypeError('knotsU must be an object'); }
        if (typeof knotsV !== 'object') { throw new TypeError('knotsV must be an object'); }
        if (typeof weights !== 'object') { throw new TypeError('weights must be an object'); }
        if (typeof propertiesU !== 'object') { throw new TypeError('propertiesU must be an object'); }
        if (typeof propertiesV !== 'object') { throw new TypeError('propertiesV must be an object'); }
        var args = {
            degreeU : null,
            degreeV : null,
            controlPointCountU : null,
            controlPointCountV : null,
            controlPoints : null,
            knotsU : null,
            knotsV : null,
            weights : null,
        ...
        var result = this._execute('getData', args);
        if (result && result.outargs) {
            degreeU.value = (result.outargs.degreeU !== undefined) ? result.outargs.degreeU : undefined;
            degreeV.value = (result.outargs.degreeV !== undefined) ? result.outargs.degreeV : undefined;
            controlPointCountU.value = (result.outargs.controlPointCountU !== undefined) ? result.outargs.controlPointCountU : undefined;
            controlPointCountV.value = (result.outargs.controlPointCountV !== undefined) ? result.outargs.controlPointCountV : undefined;
            if (Array.isArray(result.outargs.controlPoints)) {
                var controlPointsIter;
                controlPoints.value = [];
                for (controlPointsIter = 0; controlPointsIter < result.outargs.controlPoints.length; ++controlPointsIter) {
            ...
            if (Array.isArray(result.outargs.knotsU)) {
                var knotsUIter;
                knotsU.value = [];
                for (knotsUIter = 0; knotsUIter < result.outargs.knotsU.length; ++knotsUIter) {
                    knotsU.value[knotsUIter] = (result.outargs.knotsU[knotsUIter] !== undefined) ? result.outargs.knotsU[knotsUIter] : undefined;
                }
            }
            if (Array.isArray(result.outargs.knotsV)) {
                var knotsVIter;
                knotsV.value = [];
                for (knotsVIter = 0; knotsVIter < result.outargs.knotsV.length; ++knotsVIter) {
                    knotsV.value[knotsVIter] = (result.outargs.knotsV[knotsVIter] !== undefined) ? result.outargs.knotsV[knotsVIter] : undefined;
                }
            }
            if (Array.isArray(result.outargs.weights)) {
                var weightsIter;
            ...
            propertiesU.value = (result.outargs.propertiesU !== undefined) ? result.outargs.propertiesU : undefined;
            propertiesV.value = (result.outargs.propertiesV !== undefined) ? result.outargs.propertiesV : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    // propertiesV : The properties (NurbsSurfaceProperties) of the surface in the V direction.
    // Returns true if successful
    adsk.core.NurbsSurface.prototype.set = function (degreeU, degreeV, controlPointCountU, controlPointCountV, controlPoints, knotsU, knotsV, weights, propertiesU, propertiesV) {
        if (!isFinite(degreeU)) { throw new TypeError('degreeU must be a number'); }
        if (!isFinite(degreeV)) { throw new TypeError('degreeV must be a number'); }
        if (!isFinite(controlPointCountU)) { throw new TypeError('controlPointCountU must be a number'); }
        if (!isFinite(controlPointCountV)) { throw new TypeError('controlPointCountV must be a number'); }
    ...
    adsk.core.NurbsSurface.prototype.copy = function () {
        var result = this._execute('copy');
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.NurbsSurface) : null;
    };
    ...
    adsk.core.Plane = function Plane(handle) {
        if (!(this instanceof adsk.core.Plane)) {
            return adsk.core.Plane.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.Plane.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.Plane.prototype.constructor = adsk.core.Plane;
    adsk.core.Plane.classType = function classType () {
        return 'adsk::core::Plane';
    };
    adsk.core.Plane.interfaceId = 'adsk.core.Plane';
    adsk.objectTypes['adsk.core.Plane'] = adsk.core.Plane;
    adsk.core.Plane.cast = function (object) {
        return object instanceof adsk.core.Plane ? object : null;
    };
    ...
    adsk.core.Sphere = function Sphere(handle) {
        if (!(this instanceof adsk.core.Sphere)) {
            return adsk.core.Sphere.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.Sphere.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.Sphere.prototype.constructor = adsk.core.Sphere;
    adsk.core.Sphere.classType = function classType () {
        return 'adsk::core::Sphere';
    };
    adsk.core.Sphere.interfaceId = 'adsk.core.Sphere';
    adsk.objectTypes['adsk.core.Sphere'] = adsk.core.Sphere;
    adsk.core.Sphere.cast = function (object) {
        return object instanceof adsk.core.Sphere ? object : null;
    };

    // Gets and sets the origin point (center) of the sphere.
    Object.defineProperty(adsk.core.Sphere.prototype, 'origin', {
        get : function () {
            var result = this._execute('origin');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        },
    ...
    Object.defineProperty(adsk.core.Sphere.prototype, 'radius', {
        get : function () {
            var result = this._execute('radius');
            return result ? result.value : undefined;
        },
    ...
    adsk.core.Sphere.create = function (origin, radius) {
        if (origin !== null && !(origin instanceof adsk.core.Point3D)) { throw new TypeError('origin must be a adsk.core.Point3D'); }
        if (!isFinite(radius)) { throw new TypeError('radius must be a number'); }
        var args = {
            origin : (origin === null ? origin : origin.handle),
        ...
        var result = adsk.core.Base._executeStatic('adsk.core.Sphere', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.Sphere) : null;
    };
    ...
    // Returns true if successful.
    adsk.core.Sphere.prototype.getData = function (origin, radius) {
        if (typeof origin !== 'object') { throw new TypeError('origin must be an object'); }
        if (typeof radius !== 'object') { throw new TypeError('radius must be an object'); }
        var args = {
            origin : (origin === null ? origin : origin.handle),
    ...
    // radius : The radius of the sphere.
    // Returns true if successful.
    adsk.core.Sphere.prototype.set = function (origin, radius) {
        if (origin !== null && !(origin instanceof adsk.core.Point3D)) { throw new TypeError('origin must be a adsk.core.Point3D'); }
        if (!isFinite(radius)) { throw new TypeError('radius must be a number'); }
        var args = {
            origin : (origin === null ? origin : origin.handle),
    ...
    adsk.core.Sphere.prototype.copy = function () {
        var result = this._execute('copy');
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.Sphere) : null;
    };
    ...
    adsk.core.Torus = function Torus(handle) {
        if (!(this instanceof adsk.core.Torus)) {
            return adsk.core.Torus.cast(handle);
        }
        adsk.core.Surface.call(this, handle);
    };
    adsk.core.Torus.prototype = Object.create(adsk.core.Surface.prototype);
    adsk.core.Torus.prototype.constructor = adsk.core.Torus;
    adsk.core.Torus.classType = function classType () {
        return 'adsk::core::Torus';
    };
    adsk.core.Torus.interfaceId = 'adsk.core.Torus';
    adsk.objectTypes['adsk.core.Torus'] = adsk.core.Torus;
    adsk.core.Torus.cast = function (object) {
        return object instanceof adsk.core.Torus ? object : null;
    };

    // Gets and sets the origin point (center) of the torus.
    Object.defineProperty(adsk.core.Torus.prototype, 'origin', {
        get : function () {
            var result = this._execute('origin');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Point3D) : null;
        },
    ...
    Object.defineProperty(adsk.core.Torus.prototype, 'axis', {
        get : function () {
            var result = this._execute('axis');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Vector3D) : null;
        },
    ...
    Object.defineProperty(adsk.core.Torus.prototype, 'majorRadius', {
        get : function () {
            var result = this._execute('majorRadius');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.core.Torus.prototype, 'minorRadius', {
        get : function () {
            var result = this._execute('minorRadius');
            return result ? result.value : undefined;
        },
    ...
    adsk.core.Torus.create = function (origin, axis, majorRadius, minorRadius) {
        if (origin !== null && !(origin instanceof adsk.core.Point3D)) { throw new TypeError('origin must be a adsk.core.Point3D'); }
        if (axis !== null && !(axis instanceof adsk.core.Vector3D)) { throw new TypeError('axis must be a adsk.core.Vector3D'); }
        if (!isFinite(majorRadius)) { throw new TypeError('majorRadius must be a number'); }
        if (!isFinite(minorRadius)) { throw new TypeError('minorRadius must be a number'); }
        ...
        var result = adsk.core.Base._executeStatic('adsk.core.Torus', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.Torus) : null;
    };
    ...
    // Returns true if successful.
    adsk.core.Torus.prototype.getData = function (origin, axis, majorRadius, minorRadius) {
        if (typeof origin !== 'object') { throw new TypeError('origin must be an object'); }
        if (typeof axis !== 'object') { throw new TypeError('axis must be an object'); }
        if (typeof majorRadius !== 'object') { throw new TypeError('majorRadius must be an object'); }
        if (typeof minorRadius !== 'object') { throw new TypeError('minorRadius must be an object'); }
    ...
    // minorRadius : The minor radius of the torus.
    // Returns true if successful.
    adsk.core.Torus.prototype.set = function (origin, axis, majorRadius, minorRadius) {
        if (origin !== null && !(origin instanceof adsk.core.Point3D)) { throw new TypeError('origin must be a adsk.core.Point3D'); }
        if (axis !== null && !(axis instanceof adsk.core.Vector3D)) { throw new TypeError('axis must be a adsk.core.Vector3D'); }
        if (!isFinite(majorRadius)) { throw new TypeError('majorRadius must be a number'); }
        if (!isFinite(minorRadius)) { throw new TypeError('minorRadius must be a number'); }
    ...
    adsk.core.Torus.prototype.copy = function () {
        var result = this._execute('copy');
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.Torus) : null;
    };
