...
(function (root, factory) {
    ...
    adsk.core.Command.classType = function classType () {
        return 'adsk::core::Command';
    };
    ...
    // Gets and sets the associated html help file for this command. If this is defined then the help button will be displayed in the lower-left corner of the command dialog and when clicked by the user the help file will be displayed using the application defined by the operating system for that file type. The filename can be either a full path or a relative path with respect to the script or add-in .py, .js, .dll, or .dylib file. If this is an empty string, (which is the default), then the help button will not be displayed.
    Object.defineProperty(adsk.core.Command.prototype, 'helpFile', {
        get : function () {
            var result = this._execute('helpFile');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (value === undefined || value === null || value.constructor !== String) { throw new TypeError('value must be a string'); }
            ...
            var result = this._execute('helpFile', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.CommandCreatedEvent.classType = function classType () {
    ...
    adsk.core.CommandCreatedEventArgs.classType = function classType () {
        return 'adsk::core::CommandCreatedEventArgs';
    };
    ...
    adsk.core.CommandDefinition.classType = function classType () {
    ...
    adsk.core.CommandDefinitions.classType = function classType () {
        return 'adsk::core::CommandDefinitions';
    };
    ...
    adsk.core.CommandEvent.classType = function classType () {
        return 'adsk::core::CommandEvent';
    };
    ...
    adsk.core.CommandEventArgs.classType = function classType () {
        return 'adsk::core::CommandEventArgs';
    };
    ...
    adsk.core.CommandInput.classType = function classType () {
        return 'adsk::core::CommandInput';
    };
    ...
    adsk.core.CommandInputs.classType = function classType () {
        return 'adsk::core::CommandInputs';
    };
    ...
    adsk.core.CommandInputs.prototype.addTableCommandInput = function (id, name, numberOfColumns, columnRatio) {
        if (id === undefined || id === null || id.constructor !== String) { throw new TypeError('id must be a string'); }
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        if (!isFinite(numberOfColumns)) { throw new TypeError('numberOfColumns must be a number'); }
        if (columnRatio === undefined || columnRatio === null || columnRatio.constructor !== String) { throw new TypeError('columnRatio must be a string'); }
        var args = {
            id : id,
            name : name,
    ...
    adsk.core.ControlDefinition.classType = function classType () {
        return 'adsk::core::ControlDefinition';
    };
    ...
    adsk.core.FileDialog.classType = function classType () {
        return 'adsk::core::FileDialog';
    };
    ...
    Object.defineProperty(adsk.core.FileDialog.prototype, 'initialFilename', {
        get : function () {
            var result = this._execute('initialFilename');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (value === undefined || value === null || value.constructor !== String) { throw new TypeError('value must be a string'); }
            ...
            var result = this._execute('initialFilename', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.InputChangedEvent.classType = function classType () {
        return 'adsk::core::InputChangedEvent';
    };
    ...
    adsk.core.InputChangedEventArgs.classType = function classType () {
        return 'adsk::core::InputChangedEventArgs';
    };
    ...
    Object.defineProperty(adsk.core.InputChangedEventArgs.prototype, 'inputs', {
        get : function () {
            var result = this._execute('inputs');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.CommandInputs) : null;
        }
    });
    ...
    adsk.core.KeyboardEvent.classType = function classType () {
        return 'adsk::core::KeyboardEvent';
    };
    ...
    adsk.core.KeyboardEventArgs.classType = function classType () {
        return 'adsk::core::KeyboardEventArgs';
    };
    ...
    adsk.core.ListItem.classType = function classType () {
        return 'adsk::core::ListItem';
    };
    ...
    adsk.core.ListItems.classType = function classType () {
        return 'adsk::core::ListItems';
    };
    ...
    adsk.core.MouseEvent.classType = function classType () {
        return 'adsk::core::MouseEvent';
    };
    ...
    adsk.core.MouseEventArgs.classType = function classType () {
        return 'adsk::core::MouseEventArgs';
    };
    ...
    adsk.core.ProgressDialog.classType = function classType () {
        return 'adsk::core::ProgressDialog';
    };
    ...
    adsk.core.Selection.classType = function classType () {
        return 'adsk::core::Selection';
    };
    ...
    adsk.core.SelectionEvent.classType = function classType () {
        return 'adsk::core::SelectionEvent';
    };
    ...
    adsk.core.SelectionEventArgs.classType = function classType () {
        return 'adsk::core::SelectionEventArgs';
    };
    ...
    // Returns the SelectionCommandInput that is currently active in the command dialog and that the user is selecting entities for. This can be used to determine which set of rules you want to apply to determine if the current entity is selectable or not.
    Object.defineProperty(adsk.core.SelectionEventArgs.prototype, 'activeInput', {
        get : function () {
            var result = this._execute('activeInput');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.SelectionCommandInput) : null;
        }
    ...
    adsk.core.Selections.classType = function classType () {
        return 'adsk::core::Selections';
    };
    ...
    adsk.core.TablePresentationStyles = {
    ...
    adsk.core.Toolbar.classType = function classType () {
        return 'adsk::core::Toolbar';
    };
    ...
    adsk.core.ToolbarControl.classType = function classType () {
        return 'adsk::core::ToolbarControl';
    };
    ...
    adsk.core.ToolbarControlList.classType = function classType () {
        return 'adsk::core::ToolbarControlList';
    };
    ...
    adsk.core.ToolbarControls.classType = function classType () {
        return 'adsk::core::ToolbarControls';
    };
    ...
    // id : Optional unique ID for the control. It must be unique with respect to other controls in this collection. If the default empty string is provided, Fusion will create a unique ID.
    // positionID : Specifies the reference id of the control to position this control relative to. Not setting this value indicates that the control will be created at the end of all other controls in toolbar. The isBefore parameter specifies whether to place the control before or after the reference control.
    // isBefore : Specifies whether to place the control before or after the reference control specified by the positionID parameter. This argument is ignored is positionID is not specified.
    ...
    adsk.core.ToolbarPanel.classType = function classType () {
        return 'adsk::core::ToolbarPanel';
    };
    ...
    adsk.core.ToolbarPanelList.classType = function classType () {
        return 'adsk::core::ToolbarPanelList';
    };
    ...
    adsk.core.ToolbarPanels.classType = function classType () {
        return 'adsk::core::ToolbarPanels';
    };
    ...
    adsk.core.Toolbars.classType = function classType () {
        return 'adsk::core::Toolbars';
    };
    ...
    adsk.core.UserInterface = function UserInterface(handle) {
    ...
    adsk.core.UserInterface.classType = function classType () {
        return 'adsk::core::UserInterface';
    };
    ...
    // filter : A string defining the types of entities valid for selection. The valid list of selection filters can be found here: <a href="SelectionFilters_UM.htm">Selection Filters</a>. You can combine multiple types by using a comma delimiter. For example, the string "PlanarFaces,ConstructionPlanes" will allow the selection of either a planar face or a construction plane.
    ...
    adsk.core.ValidateInputsEvent = function ValidateInputsEvent(handle) {
    ...
    adsk.core.ValidateInputsEvent.classType = function classType () {
        return 'adsk::core::ValidateInputsEvent';
    };
    ...
    adsk.core.ValidateInputsEventArgs.classType = function classType () {
        return 'adsk::core::ValidateInputsEventArgs';
    };
    ...
    // Returns the collection of command inputs that are associated with the command this event is being fired for.
    Object.defineProperty(adsk.core.ValidateInputsEventArgs.prototype, 'inputs', {
        get : function () {
            var result = this._execute('inputs');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.CommandInputs) : null;
        }
    ...
    adsk.core.Workspace.classType = function classType () {
        return 'adsk::core::Workspace';
    };
    ...
    adsk.core.WorkspaceEvent.classType = function classType () {
        return 'adsk::core::WorkspaceEvent';
    };
    ...
    adsk.core.WorkspaceEventArgs.classType = function classType () {
        return 'adsk::core::WorkspaceEventArgs';
    };
    ...
    adsk.core.WorkspaceList = function WorkspaceList(handle) {
    ...
    adsk.core.WorkspaceList.classType = function classType () {
        return 'adsk::core::WorkspaceList';
    };
    ...
    adsk.core.Workspaces.classType = function classType () {
        return 'adsk::core::Workspaces';
    };
    ...
    adsk.core.BoolValueCommandInput.classType = function classType () {
        return 'adsk::core::BoolValueCommandInput';
    };
    ...
    adsk.core.ButtonControlDefinition.classType = function classType () {
        return 'adsk::core::ButtonControlDefinition';
    };
    ...
    adsk.core.ButtonRowCommandInput.classType = function classType () {
        return 'adsk::core::ButtonRowCommandInput';
    };
    ...
    adsk.core.CheckBoxControlDefinition.classType = function classType () {
        return 'adsk::core::CheckBoxControlDefinition';
    };
    ...
    adsk.core.CommandControl.classType = function classType () {
        return 'adsk::core::CommandControl';
    };
    ...
    adsk.core.DirectionCommandInput.classType = function classType () {
        return 'adsk::core::DirectionCommandInput';
    };
    ...
    adsk.core.DistanceValueCommandInput.classType = function classType () {
        return 'adsk::core::DistanceValueCommandInput';
    };
    ...
    // Returns true if the current expression is valid and can be evaluated. If this is false, the value returned should be ignored because there currently is not a valid value.
    Object.defineProperty(adsk.core.DistanceValueCommandInput.prototype, 'isValidExpression', {
        get : function () {
            var result = this._execute('isValidExpression');
            return result ? result.value : undefined;
        }
    ...
    adsk.core.DropDownCommandInput.classType = function classType () {
        return 'adsk::core::DropDownCommandInput';
    };
    ...
    adsk.core.DropDownControl.classType = function classType () {
    ...
    adsk.core.FloatSpinnerCommandInput.classType = function classType () {
        return 'adsk::core::FloatSpinnerCommandInput';
    };
    ...
    Object.defineProperty(adsk.core.FloatSpinnerCommandInput.prototype, 'expression', {
        get : function () {
            var result = this._execute('expression');
            return result ? result.value : undefined;
        },
    ...
    // Returns true if the current expression is valid and can be evaluated. If this is false, the value returned should be ignored because there currently is not a valid value.
    Object.defineProperty(adsk.core.FloatSpinnerCommandInput.prototype, 'isValidExpression', {
        get : function () {
            var result = this._execute('isValidExpression');
            return result ? result.value : undefined;
        }
    ...
    adsk.core.GroupCommandInput.classType = function classType () {
        return 'adsk::core::GroupCommandInput';
    };
    ...
    Object.defineProperty(adsk.core.GroupCommandInput.prototype, 'isEnabledCheckBoxChecked', {
        get : function () {
            var result = this._execute('isEnabledCheckBoxChecked');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isEnabledCheckBoxChecked', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.ImageCommandInput.classType = function classType () {
        return 'adsk::core::ImageCommandInput';
    };
    ...
    adsk.core.IntegerSpinnerCommandInput.classType = function classType () {
        return 'adsk::core::IntegerSpinnerCommandInput';
    };
    ...
    adsk.core.ListControlDefinition.classType = function classType () {
        return 'adsk::core::ListControlDefinition';
    };
    ...
    adsk.core.RadioButtonGroupCommandInput.classType = function classType () {
        return 'adsk::core::RadioButtonGroupCommandInput';
    };
    ...
    adsk.core.SelectionCommandInput.classType = function classType () {
        return 'adsk::core::SelectionCommandInput';
    };
    ...
    Object.defineProperty(adsk.core.SelectionCommandInput.prototype, 'hasFocus', {
        get : function () {
            var result = this._execute('hasFocus');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('hasFocus', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.core.SeparatorControl.classType = function classType () {
    ...
    adsk.core.SliderCommandInput.classType = function classType () {
        return 'adsk::core::SliderCommandInput';
    };
    ...
    adsk.core.SplitButtonControl.classType = function classType () {
    ...
    adsk.core.StringValueCommandInput.classType = function classType () {
        return 'adsk::core::StringValueCommandInput';
    };
    ...
    Object.defineProperty(adsk.core.StringValueCommandInput.prototype, 'isReadOnly', {
        get : function () {
    ...
    adsk.core.TabCommandInput.classType = function classType () {
        return 'adsk::core::TabCommandInput';
    };
    ...
    //=========== TableCommandInput ============
    // Represents a table within a command dialog. The table consists of rows and columns where each cell can contain another command input. In addition to the rows and columns, each table can optional have a toolbar of seperate command inputs that is shown at the bottom of the table. This is the same command input that the loft command uses to show the selected profiles and rails.
    adsk.core.TableCommandInput = function TableCommandInput(handle) {
        if (!(this instanceof adsk.core.TableCommandInput)) {
            return adsk.core.TableCommandInput.cast(handle);
        }
        adsk.core.CommandInput.call(this, handle);
    };
    adsk.core.TableCommandInput.prototype = Object.create(adsk.core.CommandInput.prototype);
    adsk.core.TableCommandInput.prototype.constructor = adsk.core.TableCommandInput;
    adsk.core.TableCommandInput.classType = function classType () {
        return 'adsk::core::TableCommandInput';
    };
    adsk.core.TableCommandInput.interfaceId = 'adsk.core.TableCommandInput';
    adsk.objectTypes['adsk.core.TableCommandInput'] = adsk.core.TableCommandInput;
    adsk.core.TableCommandInput.cast = function (object) {
        return object instanceof adsk.core.TableCommandInput ? object : null;
    };

    // Gets and sets the number of columns displayed within the table.
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'numberOfColumns', {
        get : function () {
            var result = this._execute('numberOfColumns');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('numberOfColumns', args);
            return result ? result.value : undefined;
        }
    });

    // Gets and sets the width ratio of the columns. This is defined using a string like "1:1:1" where this is used where there are three columns all the same width. "2:1" is for two columns where the first column is twice the width of the second column.
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'columnRatio', {
        get : function () {
            var result = this._execute('columnRatio');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (value === undefined || value === null || value.constructor !== String) { throw new TypeError('value must be a string'); }
            ...
            var result = this._execute('columnRatio', args);
            return result ? result.value : undefined;
        }
    });

    // Gets and sets whether a grid is displayed for the table. For a newly created table, this property defaults to false.
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'hasGrid', {
        get : function () {
            var result = this._execute('hasGrid');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('hasGrid', args);
            return result ? result.value : undefined;
        }
    });

    // Gets and sets the spacing between rows. This is defined in pixels. For a newly created table, this property defaults to 1.
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'rowSpacing', {
        get : function () {
            var result = this._execute('rowSpacing');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('rowSpacing', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'columnSpacing', {
        get : function () {
            var result = this._execute('columnSpacing');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('columnSpacing', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'minimumVisibleRows', {
        get : function () {
            var result = this._execute('minimumVisibleRows');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('minimumVisibleRows', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'maximumVisibleRows', {
        get : function () {
            var result = this._execute('maximumVisibleRows');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('maximumVisibleRows', args);
            return result ? result.value : undefined;
        }
    });

    // Gets and sets the presentation style the table is currently using for its display.
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'tablePresentationStyle', {
        get : function () {
            var result = this._execute('tablePresentationStyle');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('tablePresentationStyle', args);
            return result ? result.value : undefined;
        }
    });

    // Returns the number of rows in the table.
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'rowCount', {
        get : function () {
            var result = this._execute('rowCount');
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.core.TableCommandInput.prototype, 'selectedRow', {
        get : function () {
            var result = this._execute('selectedRow');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('selectedRow', args);
            return result ? result.value : undefined;
        }
    });

    // Deletes the specified row. The following rows will be shifted up.
    ...
    // Returns true if the delete was successful.
    adsk.core.TableCommandInput.prototype.deleteRow = function (row) {
        if (!isFinite(row)) { throw new TypeError('row must be a number'); }
        var args = {
            row : Number(row)
        };
        var result = this._execute('deleteRow', args);
        return result ? result.value : undefined;
    };
    ...
    // columnSpan : The number of additional columns that this input uses. The default value of 0 indicates that now additional columns are used.
    // Returns true if the association of the command input to the cell was successful.
    adsk.core.TableCommandInput.prototype.addCommandInput = function (input, row, column, rowSpan, columnSpan) {
        ...
        if (rowSpan === null || (rowSpan !== undefined && !isFinite(rowSpan))) { throw new TypeError('rowSpan must be a number'); }
        if (columnSpan === null || (columnSpan !== undefined && !isFinite(columnSpan))) { throw new TypeError('columnSpan must be a number'); }
        var args = {
        ...
        if (rowSpan !== undefined) {
            args.rowSpan = Number(rowSpan);
        }
        if (columnSpan !== undefined) {
            args.columnSpan = Number(columnSpan);
        }
        var result = this._execute('addCommandInput', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.TableCommandInput.prototype.removeInput = function (row, column) {
        if (!isFinite(row)) { throw new TypeError('row must be a number'); }
        if (!isFinite(column)) { throw new TypeError('column must be a number'); }
        var args = {
            row : Number(row),
        ...
        var result = this._execute('removeInput', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.TableCommandInput.prototype.getPosition = function (input, row, column, rowSpan, columnSpan) {
        if (input !== null && !(input instanceof adsk.core.CommandInput)) { throw new TypeError('input must be a adsk.core.CommandInput'); }
        if (typeof row !== 'object') { throw new TypeError('row must be an object'); }
        if (typeof column !== 'object') { throw new TypeError('column must be an object'); }
        if (typeof rowSpan !== 'object') { throw new TypeError('rowSpan must be an object'); }
        if (typeof columnSpan !== 'object') { throw new TypeError('columnSpan must be an object'); }
        var args = {
            input : (input === null ? input : input.handle),
            row : null,
            column : null,
        ...
        var result = this._execute('getPosition', args);
        if (result && result.outargs) {
            row.value = (result.outargs.row !== undefined) ? result.outargs.row : undefined;
            column.value = (result.outargs.column !== undefined) ? result.outargs.column : undefined;
            rowSpan.value = (result.outargs.rowSpan !== undefined) ? result.outargs.rowSpan : undefined;
            columnSpan.value = (result.outargs.columnSpan !== undefined) ? result.outargs.columnSpan : undefined;
        }
        return result ? result.value : undefined;
    };
    ...
    // Returns true if successful.
    adsk.core.TableCommandInput.prototype.clear = function () {
        var result = this._execute('clear');
        return result ? result.value : undefined;
    };
    ...
    adsk.core.TableCommandInput.prototype.addToolbarCommandInput = function (input) {
        ...
        var result = this._execute('addToolbarCommandInput', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.core.TableCommandInput.prototype.getInputAtPosition = function (row, column) {
        if (!isFinite(row)) { throw new TypeError('row must be a number'); }
        if (!isFinite(column)) { throw new TypeError('column must be a number'); }
        var args = {
            row : Number(row),
        ...
        var result = this._execute('getInputAtPosition', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.core.CommandInput) : null;
    };
    ...
    adsk.core.TextBoxCommandInput.classType = function classType () {
        return 'adsk::core::TextBoxCommandInput';
    };
    ...
    // Gets and sets the formatted text displayed in the dialog. Formatted text includes any html formatting that has been defined. For example, you can use basic html formatting such as <b>Bold</b>, <i>Italic</i>, and <br /> for a line break.
    ...
    adsk.core.ValueCommandInput.classType = function classType () {
        return 'adsk::core::ValueCommandInput';
    };
    ...
    // Returns true if the current expression is valid and can be evaluated. If this is false, the value returned should be ignored because there currently is not a valid value.
    Object.defineProperty(adsk.core.ValueCommandInput.prototype, 'isValidExpression', {
        get : function () {
            var result = this._execute('isValidExpression');
            return result ? result.value : undefined;
        }
    ...
    adsk.core.FloatSliderCommandInput.classType = function classType () {
    ...
    adsk.core.IntegerSliderCommandInput.classType = function classType () {
        return 'adsk::core::IntegerSliderCommandInput';
    };
