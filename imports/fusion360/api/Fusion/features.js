...
(function (root, factory) {
    ...
    adsk.fusion.BaseFeatures.classType = function classType () {
        return 'adsk::fusion::BaseFeatures';
    };
    ...
    adsk.fusion.BaseFeatures.prototype.add = function () {
    ...
    adsk.fusion.BoundaryFillFeatureInput.classType = function classType () {
        return 'adsk::fusion::BoundaryFillFeatureInput';
    };
    ...
    Object.defineProperty(adsk.fusion.BoundaryFillFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
        set : function (value) {
            if (value !== null && !(value instanceof adsk.fusion.BaseFeature)) { throw new TypeError('value must be a adsk.fusion.BaseFeature'); }
            var args = {
                value : value
            };
    ...
    adsk.fusion.BoundaryFillFeatures.classType = function classType () {
        return 'adsk::fusion::BoundaryFillFeatures';
    };
    ...
    adsk.fusion.BoxFeatures.classType = function classType () {
        return 'adsk::fusion::BoxFeatures';
    };
    ...
    adsk.fusion.BRepCell.classType = function classType () {
        return 'adsk::fusion::BRepCell';
    };
    ...
    adsk.fusion.BRepCells.classType = function classType () {
        return 'adsk::fusion::BRepCells';
    };
    ...
    adsk.fusion.ChainedCurveOptions = {
        noChainedCurves : 0,
    ...
    adsk.fusion.ChamferFeatureInput.classType = function classType () {
        return 'adsk::fusion::ChamferFeatureInput';
    };
    ...
    // Gets and sets the collection of edges that will be chamfered. In order to access (get) the input edges of a chamfer, you must roll the timeline back to just before the chamfer feature whose edges you want to access.
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ChamferFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ChamferFeatures.classType = function classType () {
        return 'adsk::fusion::ChamferFeatures';
    };
    ...
    adsk.fusion.ChamferTypeDefinition.classType = function classType () {
        return 'adsk::fusion::ChamferTypeDefinition';
    };
    ...
    adsk.fusion.CircularPatternFeatureInput.classType = function classType () {
        return 'adsk::fusion::CircularPatternFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.CircularPatternFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.CircularPatternFeatures.classType = function classType () {
        return 'adsk::fusion::CircularPatternFeatures';
    };
    ...
    adsk.fusion.CoilFeatureInput.classType = function classType () {
        return 'adsk::fusion::CoilFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.CoilFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.CoilFeatures.classType = function classType () {
        return 'adsk::fusion::CoilFeatures';
    };
    ...
    adsk.fusion.CombineFeatureInput.classType = function classType () {
        return 'adsk::fusion::CombineFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.CombineFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.CombineFeatures.classType = function classType () {
        return 'adsk::fusion::CombineFeatures';
    };
    ...
    adsk.fusion.CylinderFeatures.classType = function classType () {
        return 'adsk::fusion::CylinderFeatures';
    };
    ...
    adsk.fusion.DeleteFaceFeatures = function DeleteFaceFeatures(handle) {
        if (!(this instanceof adsk.fusion.DeleteFaceFeatures)) {
            return adsk.fusion.DeleteFaceFeatures.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.DeleteFaceFeatures.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.DeleteFaceFeatures.prototype.constructor = adsk.fusion.DeleteFaceFeatures;
    adsk.fusion.DeleteFaceFeatures.classType = function classType () {
        return 'adsk::fusion::DeleteFaceFeatures';
    };
    adsk.fusion.DeleteFaceFeatures.interfaceId = 'adsk.fusion.DeleteFaceFeatures';
    adsk.objectTypes['adsk.fusion.DeleteFaceFeatures'] = adsk.fusion.DeleteFaceFeatures;
    adsk.fusion.DeleteFaceFeatures.cast = function (object) {
        return object instanceof adsk.fusion.DeleteFaceFeatures ? object : null;
    };

    // The number of DeleteFaceFeature objects in the collection.
    Object.defineProperty(adsk.fusion.DeleteFaceFeatures.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.DeleteFaceFeatures.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.DeleteFaceFeature) : null;
    };

    // Function that returns the specified DeleteFaceFeature object using the name of the feature.
    // name : The name of the feature within the collection to return. This is the name seen in the timeline.
    // Returns the specified item or null if the specified name was not found.
    adsk.fusion.DeleteFaceFeatures.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    adsk.fusion.DeleteFaceFeatures.prototype.add = function (facesToDelete) {
        if (facesToDelete !== null && !(facesToDelete instanceof adsk.core.Base)) { throw new TypeError('facesToDelete must be a adsk.core.Base'); }
        var args = {
            facesToDelete : (facesToDelete === null ? facesToDelete : facesToDelete.handle)
        };
        var result = this._execute('add', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.DeleteFaceFeature) : null;
    };
    ...
    adsk.fusion.DraftFeatureInput.classType = function classType () {
        return 'adsk::fusion::DraftFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.DraftFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.DraftFeatures.classType = function classType () {
        return 'adsk::fusion::DraftFeatures';
    };
    ...
    adsk.fusion.ExtendFeatureInput.classType = function classType () {
        return 'adsk::fusion::ExtendFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ExtendFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ExtendFeatures.classType = function classType () {
        return 'adsk::fusion::ExtendFeatures';
    };
    ...
    adsk.fusion.ExtentDefinition.classType = function classType () {
        return 'adsk::fusion::ExtentDefinition';
    };
    ...
    adsk.fusion.ExtrudeFeatureInput.classType = function classType () {
        return 'adsk::fusion::ExtrudeFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'startExtent', {
        get : function () {
            var result = this._execute('startExtent');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ExtentDefinition) : null;
        },
        set : function (value) {
            if (value !== null && !(value instanceof adsk.fusion.ExtentDefinition)) { throw new TypeError('value must be a adsk.fusion.ExtentDefinition'); }
            var args = {
                value : value
            };
            var result = this._execute('startExtent', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'extentOne', {
        get : function () {
            var result = this._execute('extentOne');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ExtentDefinition) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'extentTwo', {
        get : function () {
            var result = this._execute('extentTwo');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ExtentDefinition) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'taperAngleOne', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'taperAngleTwo', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeatureInput.prototype, 'hasTwoExtents', {
        get : function () {
    ...
    adsk.fusion.ExtrudeFeatureInput.prototype.setOneSideExtent = function (extent, direction, taperAngle) {
        if (extent !== null && !(extent instanceof adsk.fusion.ExtentDefinition)) { throw new TypeError('extent must be a adsk.fusion.ExtentDefinition'); }
        if (!isFinite(direction)) { throw new TypeError('direction must be a number'); }
        if (taperAngle === null || (taperAngle !== undefined && taperAngle !== null && !(taperAngle instanceof adsk.core.ValueInput))) { throw new TypeError('taperAngle must be a adsk.core.ValueInput'); }
        var args = {
            extent : (extent === null ? extent : extent.handle),
            direction : Number(direction)
        };
        if (taperAngle !== undefined) {
            args.taperAngle = (taperAngle === null ? taperAngle : taperAngle.handle);
        }
        var result = this._execute('setOneSideExtent', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.ExtrudeFeatureInput.prototype.setTwoSidesExtent = function (sideOneExtent, sideTwoExtent, sideOneTaperAngle, sideTwoTaperAngle) {
        ...
        if (sideOneTaperAngle === null || (sideOneTaperAngle !== undefined && sideOneTaperAngle !== null && !(sideOneTaperAngle instanceof adsk.core.ValueInput))) { throw new TypeError('sideOneTaperAngle must be a adsk.core.ValueInput'); }
        if (sideTwoTaperAngle === null || (sideTwoTaperAngle !== undefined && sideTwoTaperAngle !== null && !(sideTwoTaperAngle instanceof adsk.core.ValueInput))) { throw new TypeError('sideTwoTaperAngle must be a adsk.core.ValueInput'); }
        var args = {
            sideOneExtent : (sideOneExtent === null ? sideOneExtent : sideOneExtent.handle),
            sideTwoExtent : (sideTwoExtent === null ? sideTwoExtent : sideTwoExtent.handle)
        };
        if (sideOneTaperAngle !== undefined) {
            args.sideOneTaperAngle = (sideOneTaperAngle === null ? sideOneTaperAngle : sideOneTaperAngle.handle);
        }
        if (sideTwoTaperAngle !== undefined) {
            args.sideTwoTaperAngle = (sideTwoTaperAngle === null ? sideTwoTaperAngle : sideTwoTaperAngle.handle);
        }
        var result = this._execute('setTwoSidesExtent', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.ExtrudeFeatureInput.prototype.setSymmetricExtent = function (distance, isFullLength, taperAngle) {
        ...
        var result = this._execute('setSymmetricExtent', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.ExtrudeFeatures.classType = function classType () {
        return 'adsk::fusion::ExtrudeFeatures';
    };
    ...
    adsk.fusion.Feature.classType = function classType () {
        return 'adsk::fusion::Feature';
    };
    ...
    // Returns the bodies that were modified or created by this feature. This works for both parametric and non-parametric features. For a BaseFeature this returns the bodies that are owned by the base feature.
    ...
    Object.defineProperty(adsk.fusion.Feature.prototype, 'attributes', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Feature.prototype, 'baseFeature', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Feature.prototype, 'healthState', {
        get : function () {
            var result = this._execute('healthState');
            return result ? result.value : undefined;
        }
    });

    // Returns the error or warning message in the case where the healthState property returns either WarningFeatureHealthState or ErrorFeatureHealthState. Otherwise this property returns an empty string.
    Object.defineProperty(adsk.fusion.Feature.prototype, 'errorOrWarningMessage', {
        get : function () {
            var result = this._execute('errorOrWarningMessage');
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.FeatureList.classType = function classType () {
        return 'adsk::fusion::FeatureList';
    };
    ...
    adsk.fusion.Features.classType = function classType () {
        return 'adsk::fusion::Features';
    };
    ...
    // Returns the collection that provides access to the existing box features and supports the creation of new box features.
    ...
    // Returns the collection that provides access to the existing cylinder features and supports the creation of new cylinder features.
    ...
    Object.defineProperty(adsk.fusion.Features.prototype, 'surfaceDeleteFaceFeatures', {
        get : function () {
            var result = this._execute('surfaceDeleteFaceFeatures');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SurfaceDeleteFaceFeatures) : null;
        }
    });

    // Returns the collection that provides access to the existing Delete Face features.
    Object.defineProperty(adsk.fusion.Features.prototype, 'deleteFaceFeatures', {
        get : function () {
            var result = this._execute('deleteFaceFeatures');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.DeleteFaceFeatures) : null;
        }
    });
    ...
    adsk.fusion.FilletEdgeSet.classType = function classType () {
        return 'adsk::fusion::FilletEdgeSet';
    };
    ...
    adsk.fusion.FilletEdgeSets.classType = function classType () {
        return 'adsk::fusion::FilletEdgeSets';
    };
    ...
    adsk.fusion.FilletFeatureInput.classType = function classType () {
        return 'adsk::fusion::FilletFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.FilletFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.FilletFeatures.classType = function classType () {
        return 'adsk::fusion::FilletFeatures';
    };
    ...
    adsk.fusion.FormFeatures.classType = function classType () {
        return 'adsk::fusion::FormFeatures';
    };
    ...
    adsk.fusion.HoleFeatureInput.classType = function classType () {
        return 'adsk::fusion::HoleFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.HoleFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.HoleFeatures.classType = function classType () {
        return 'adsk::fusion::HoleFeatures';
    };
    ...
    adsk.fusion.HolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::HolePositionDefinition';
    };
    ...
    adsk.fusion.LoftCenterLineOrRail = function LoftCenterLineOrRail(handle) {
        if (!(this instanceof adsk.fusion.LoftCenterLineOrRail)) {
            return adsk.fusion.LoftCenterLineOrRail.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.LoftCenterLineOrRail.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.LoftCenterLineOrRail.prototype.constructor = adsk.fusion.LoftCenterLineOrRail;
    adsk.fusion.LoftCenterLineOrRail.classType = function classType () {
        return 'adsk::fusion::LoftCenterLineOrRail';
    };
    adsk.fusion.LoftCenterLineOrRail.interfaceId = 'adsk.fusion.LoftCenterLineOrRail';
    adsk.objectTypes['adsk.fusion.LoftCenterLineOrRail'] = adsk.fusion.LoftCenterLineOrRail;
    adsk.fusion.LoftCenterLineOrRail.cast = function (object) {
        return object instanceof adsk.fusion.LoftCenterLineOrRail ? object : null;
    };

    // Indicates if this object is a loft centerline (true) or a rail (false).
    Object.defineProperty(adsk.fusion.LoftCenterLineOrRail.prototype, 'isCenterLine', {
        get : function () {
            var result = this._execute('isCenterLine');
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.LoftCenterLineOrRail.prototype, 'entity', {
        get : function () {
        ...
        set : function (value) {
            ...
            var result = this._execute('entity', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.LoftCenterLineOrRail.prototype.deleteMe = function () {
        var result = this._execute('deleteMe');
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.LoftCenterLineOrRails = function LoftCenterLineOrRails(handle) {
        if (!(this instanceof adsk.fusion.LoftCenterLineOrRails)) {
            return adsk.fusion.LoftCenterLineOrRails.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.LoftCenterLineOrRails.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.LoftCenterLineOrRails.prototype.constructor = adsk.fusion.LoftCenterLineOrRails;
    adsk.fusion.LoftCenterLineOrRails.classType = function classType () {
        return 'adsk::fusion::LoftCenterLineOrRails';
    };
    adsk.fusion.LoftCenterLineOrRails.interfaceId = 'adsk.fusion.LoftCenterLineOrRails';
    adsk.objectTypes['adsk.fusion.LoftCenterLineOrRails'] = adsk.fusion.LoftCenterLineOrRails;
    adsk.fusion.LoftCenterLineOrRails.cast = function (object) {
        return object instanceof adsk.fusion.LoftCenterLineOrRails ? object : null;
    };

    // The number of centerlines or rails in the collection.
    Object.defineProperty(adsk.fusion.LoftCenterLineOrRails.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.fusion.LoftCenterLineOrRails.prototype, 'isCenterLine', {
        get : function () {
            var result = this._execute('isCenterLine');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.LoftCenterLineOrRails.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftCenterLineOrRail) : null;
    };
    ...
    adsk.fusion.LoftCenterLineOrRails.prototype.addCenterLine = function (entity) {
        ...
        var result = this._execute('addCenterLine', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftCenterLineOrRail) : null;
    };
    ...
    // Returns the new LoftCenterLineOrRail object or null in the case of a failure.
    adsk.fusion.LoftCenterLineOrRails.prototype.addRail = function (entity) {
        if (entity !== null && !(entity instanceof adsk.core.Base)) { throw new TypeError('entity must be a adsk.core.Base'); }
        var args = {
            entity : (entity === null ? entity : entity.handle)
        };
        var result = this._execute('addRail', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftCenterLineOrRail) : null;
    };

    //=========== LoftEndCondition ============
    // The base class for all loft end conditions.
    adsk.fusion.LoftEndCondition = function LoftEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftEndCondition)) {
            return adsk.fusion.LoftEndCondition.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.LoftEndCondition.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.LoftEndCondition.prototype.constructor = adsk.fusion.LoftEndCondition;
    adsk.fusion.LoftEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftEndCondition';
    };
    adsk.fusion.LoftEndCondition.interfaceId = 'adsk.fusion.LoftEndCondition';
    adsk.objectTypes['adsk.fusion.LoftEndCondition'] = adsk.fusion.LoftEndCondition;
    adsk.fusion.LoftEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftEndCondition ? object : null;
    };

    // Returns the parent loft section.
    Object.defineProperty(adsk.fusion.LoftEndCondition.prototype, 'parentLoftSection', {
        get : function () {
            var result = this._execute('parentLoftSection');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftSection) : null;
        }
    });
    ...
    adsk.fusion.LoftFeatureInput = function LoftFeatureInput(handle) {
        if (!(this instanceof adsk.fusion.LoftFeatureInput)) {
            return adsk.fusion.LoftFeatureInput.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.LoftFeatureInput.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.LoftFeatureInput.prototype.constructor = adsk.fusion.LoftFeatureInput;
    adsk.fusion.LoftFeatureInput.classType = function classType () {
        return 'adsk::fusion::LoftFeatureInput';
    };
    adsk.fusion.LoftFeatureInput.interfaceId = 'adsk.fusion.LoftFeatureInput';
    adsk.objectTypes['adsk.fusion.LoftFeatureInput'] = adsk.fusion.LoftFeatureInput;
    adsk.fusion.LoftFeatureInput.cast = function (object) {
        return object instanceof adsk.fusion.LoftFeatureInput ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.LoftFeatureInput.prototype, 'loftSections', {
        get : function () {
            var result = this._execute('loftSections');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftSections) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.LoftFeatureInput.prototype, 'centerLineOrRails', {
        get : function () {
            var result = this._execute('centerLineOrRails');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftCenterLineOrRails) : null;
        }
    });

    // Gets and sets the type of operation performed by the loft.
    Object.defineProperty(adsk.fusion.LoftFeatureInput.prototype, 'operation', {
        get : function () {
            var result = this._execute('operation');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.fusion.LoftFeatureInput.prototype, 'creationOccurrence', {
        get : function () {
            var result = this._execute('creationOccurrence');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.Occurrence) : null;
        },
    ...
    Object.defineProperty(adsk.fusion.LoftFeatureInput.prototype, 'isSolid', {
        get : function () {
            var result = this._execute('isSolid');
            return result ? result.value : undefined;
        },
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.LoftFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.LoftFeatures.classType = function classType () {
        return 'adsk::fusion::LoftFeatures';
    };
    ...
    adsk.fusion.LoftFeatures.prototype.createInput = function (operation) {
        if (!isFinite(operation)) { throw new TypeError('operation must be a number'); }
        var args = {
            operation : Number(operation)
        };
        var result = this._execute('createInput', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftFeatureInput) : null;
    };
    ...
    adsk.fusion.LoftFeatures.prototype.add = function (input) {
        if (input !== null && !(input instanceof adsk.fusion.LoftFeatureInput)) { throw new TypeError('input must be a adsk.fusion.LoftFeatureInput'); }
        var args = {
            input : (input === null ? input : input.handle)
        };
        var result = this._execute('add', args);
    ...
    adsk.fusion.LoftSection = function LoftSection(handle) {
        if (!(this instanceof adsk.fusion.LoftSection)) {
            return adsk.fusion.LoftSection.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.LoftSection.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.LoftSection.prototype.constructor = adsk.fusion.LoftSection;
    adsk.fusion.LoftSection.classType = function classType () {
        return 'adsk::fusion::LoftSection';
    };
    adsk.fusion.LoftSection.interfaceId = 'adsk.fusion.LoftSection';
    adsk.objectTypes['adsk.fusion.LoftSection'] = adsk.fusion.LoftSection;
    adsk.fusion.LoftSection.cast = function (object) {
        return object instanceof adsk.fusion.LoftSection ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.LoftSection.prototype, 'entity', {
        get : function () {
            var result = this._execute('entity');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        },
    ...
    Object.defineProperty(adsk.fusion.LoftSection.prototype, 'index', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.LoftSection.prototype, 'endCondition', {
        get : function () {
            var result = this._execute('endCondition');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftEndCondition) : null;
        }
    });

    // Deletes this LoftSection.
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.deleteMe = function () {
        var result = this._execute('deleteMe');
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.LoftSection.prototype.reorder = function (newIndex) {
        if (!isFinite(newIndex)) { throw new TypeError('newIndex must be a number'); }
        var args = {
    ...
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.setFreeEndCondition = function () {
        var result = this._execute('setFreeEndCondition');
        return result ? result.value : undefined;
    };
    ...
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.setDirectionEndCondition = function (angle, weight) {
        if (angle === null || (angle !== undefined && angle !== null && !(angle instanceof adsk.core.ValueInput))) { throw new TypeError('angle must be a adsk.core.ValueInput'); }
        if (weight === null || (weight !== undefined && weight !== null && !(weight instanceof adsk.core.ValueInput))) { throw new TypeError('weight must be a adsk.core.ValueInput'); }
        var args;
        if (angle !== undefined || weight !== undefined) {
            args = {};
            if (angle !== undefined) {
                args.angle = (angle === null ? angle : angle.handle);
            }
            if (weight !== undefined) {
                args.weight = (weight === null ? weight : weight.handle);
            }
        }
        var result = this._execute('setDirectionEndCondition', args);
        return result ? result.value : undefined;
    };
    ...
    // weight : Input ValueInput object that defines the weight or the amount of influence of end condition on the loft. This defaults to a value of 1.0. If the ValueInput object is a string it must be an valid expression that can be evaluated as a unitless value. In any case, the value must be greater than 0.
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.setTangentEndCondition = function (weight) {
        if (weight !== null && !(weight instanceof adsk.core.ValueInput)) { throw new TypeError('weight must be a adsk.core.ValueInput'); }
        var args = {
            weight : (weight === null ? weight : weight.handle)
        };
        var result = this._execute('setTangentEndCondition', args);
        return result ? result.value : undefined;
    };
    ...
    // weight : Input ValueInput object that defines the weight or the amount of influence of end condition on the loft. This defaults to a value of 1.0. If the ValueInput object is a string it must be an valid expression that can be evaluated as a unitless value. In any case, the value must be greater than 0.
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.setSmoothEndCondition = function (weight) {
        if (weight !== null && !(weight instanceof adsk.core.ValueInput)) { throw new TypeError('weight must be a adsk.core.ValueInput'); }
        var args = {
            weight : (weight === null ? weight : weight.handle)
        };
        var result = this._execute('setSmoothEndCondition', args);
        return result ? result.value : undefined;
    };

    // Sets the end condition to be sharp where the section is a point. This is the default condition for a point section.
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.setPointSharpEndCondition = function () {
        var result = this._execute('setPointSharpEndCondition');
        return result ? result.value : undefined;
    };
    ...
    // weight : Input ValueInput object that defines the weight or the amount of influence of end condition on the loft. This defaults to a value of 1.0. If the ValueInput object is a string it must be an valid expression that can be evaluated as a unitless value. In any case, the value must be greater than 0.
    // Returns true if the operation was successful.
    adsk.fusion.LoftSection.prototype.setPointTangentEndCondition = function (weight) {
        if (weight !== null && !(weight instanceof adsk.core.ValueInput)) { throw new TypeError('weight must be a adsk.core.ValueInput'); }
        var args = {
            weight : (weight === null ? weight : weight.handle)
        };
        var result = this._execute('setPointTangentEndCondition', args);
        return result ? result.value : undefined;
    };

    //=========== LoftSections ============
    // The set of two or more sections used to define the shape of the loft.
    adsk.fusion.LoftSections = function LoftSections(handle) {
        if (!(this instanceof adsk.fusion.LoftSections)) {
            return adsk.fusion.LoftSections.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.LoftSections.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.LoftSections.prototype.constructor = adsk.fusion.LoftSections;
    adsk.fusion.LoftSections.classType = function classType () {
        return 'adsk::fusion::LoftSections';
    };
    adsk.fusion.LoftSections.interfaceId = 'adsk.fusion.LoftSections';
    adsk.objectTypes['adsk.fusion.LoftSections'] = adsk.fusion.LoftSections;
    adsk.fusion.LoftSections.cast = function (object) {
        return object instanceof adsk.fusion.LoftSections ? object : null;
    };

    // The number of LoftSections in the collection.
    Object.defineProperty(adsk.fusion.LoftSections.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.LoftSections.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
    ...
    adsk.fusion.LoftSections.prototype.add = function (entity) {
        if (entity !== null && !(entity instanceof adsk.core.Base)) { throw new TypeError('entity must be a adsk.core.Base'); }
        var args = {
            entity : (entity === null ? entity : entity.handle)
        };
    ...
    adsk.fusion.MirrorFeatureInput.classType = function classType () {
        return 'adsk::fusion::MirrorFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.MirrorFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.MirrorFeatures.classType = function classType () {
        return 'adsk::fusion::MirrorFeatures';
    };
    ...
    adsk.fusion.MoveFeatureInput.classType = function classType () {
        return 'adsk::fusion::MoveFeatureInput';
    };
    ...
    // Gets and sets the tranform to apply to the input entities. This can describe a move (translation) or a rotation. The matrix must define an orthogonal transform. That is the axes remain perpendicular to each other and there isn't any scale or mirror defined.
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.MoveFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.MoveFeatures.classType = function classType () {
        return 'adsk::fusion::MoveFeatures';
    };
    ...
    adsk.fusion.OffsetFeatureInput.classType = function classType () {
        return 'adsk::fusion::OffsetFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.OffsetFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.OffsetFeatures.classType = function classType () {
        return 'adsk::fusion::OffsetFeatures';
    };
    ...
    // entities : The BRepBody or BRepFace objects to offset. If a BRepBody is used it must be open, (the isSolid property must be False). Faces from both solid and quilt bodies can be offset. Input faces need not be from the same closed or open body.
    ...
    adsk.fusion.PatchFeatureInput = function PatchFeatureInput(handle) {
        if (!(this instanceof adsk.fusion.PatchFeatureInput)) {
            return adsk.fusion.PatchFeatureInput.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.PatchFeatureInput.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.PatchFeatureInput.prototype.constructor = adsk.fusion.PatchFeatureInput;
    adsk.fusion.PatchFeatureInput.classType = function classType () {
        return 'adsk::fusion::PatchFeatureInput';
    };
    adsk.fusion.PatchFeatureInput.interfaceId = 'adsk.fusion.PatchFeatureInput';
    adsk.objectTypes['adsk.fusion.PatchFeatureInput'] = adsk.fusion.PatchFeatureInput;
    adsk.fusion.PatchFeatureInput.cast = function (object) {
        return object instanceof adsk.fusion.PatchFeatureInput ? object : null;
    };

    // Gets and set the input geometry that will be used to define the boundary. This can be a sketch profile, a single sketch curve, a single B-Rep edge, or a Path object. If a single sketch curve or B-Rep edge is input, that is not closed, Fusion will automatically find connected sketch curves or B-Rep edges in order to define a closed loop. All sketch curves are valid as input. BRepEdges are valid if they are an "open" edge, which means they are only used by one face. If a Path is input it must define a closed shape and the B-Rep edges must be valid "open" edges.
    Object.defineProperty(adsk.fusion.PatchFeatureInput.prototype, 'boundaryCurve', {
        get : function () {
            var result = this._execute('boundaryCurve');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        },
        set : function (value) {
            if (value !== null && !(value instanceof adsk.core.Base)) { throw new TypeError('value must be a adsk.core.Base'); }
            ...
            var result = this._execute('boundaryCurve', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.PatchFeatureInput.prototype, 'operation', {
        get : function () {
            var result = this._execute('operation');
            return result ? result.value : undefined;
        },
    ...
    // Gets and sets type of surface continuity to use when matching boundary edges to face edges. When a new PatchFeatureInput is created, this is initialized to ConnectedSurfaceContinuityType. This value is ignored when creating a patch for sketch curves.
    Object.defineProperty(adsk.fusion.PatchFeatureInput.prototype, 'continuity', {
        get : function () {
            var result = this._execute('continuity');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (!isFinite(value)) { throw new TypeError('value must be a number'); }
            ...
            var result = this._execute('continuity', args);
            return result ? result.value : undefined;
        }
    });

    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.PatchFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    Object.defineProperty(adsk.fusion.PatchFeatureInput.prototype, 'creationOccurrence', {
        get : function () {
            var result = this._execute('creationOccurrence');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.Occurrence) : null;
        },
    ...
    adsk.fusion.PatchFeatures.classType = function classType () {
        return 'adsk::fusion::PatchFeatures';
    };
    ...
    // boundaryCurve : Defines the input geometry that will be used to define the boundary. This can be a sketch profile, a single sketch curve, a single B-Rep edge, or a Path object. If a single sketch curve or B-Rep edge is input, that is not closed, Fusion will automatically find connected sketch curves or B-Rep edges in order to define a closed loop. All sketch curves are valid as input. BRepEdges are valid if they are an "open" edge, which means they are only used by one face. If a Path is input it must define a closed shape and the B-Rep edges must be valid "open" edges.
    ...
    adsk.fusion.PatchFeatures.prototype.createInput = function (boundaryCurve, operation) {
        if (boundaryCurve !== null && !(boundaryCurve instanceof adsk.core.Base)) { throw new TypeError('boundaryCurve must be a adsk.core.Base'); }
        if (!isFinite(operation)) { throw new TypeError('operation must be a number'); }
        var args = {
            boundaryCurve : (boundaryCurve === null ? boundaryCurve : boundaryCurve.handle),
            operation : Number(operation)
        };
        var result = this._execute('createInput', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.PatchFeatureInput) : null;
    };
    ...
    adsk.fusion.PatchFeatures.prototype.add = function (input) {
        if (input !== null && !(input instanceof adsk.fusion.PatchFeatureInput)) { throw new TypeError('input must be a adsk.fusion.PatchFeatureInput'); }
        var args = {
            input : (input === null ? input : input.handle)
        };
        var result = this._execute('add', args);
    ...
    adsk.fusion.Path.classType = function classType () {
        return 'adsk::fusion::Path';
    };
    ...
    adsk.fusion.Path.create = function (curves, chainOptions) {
        if (curves !== null && !(curves instanceof adsk.core.Base)) { throw new TypeError('curves must be a adsk.core.Base'); }
        if (!isFinite(chainOptions)) { throw new TypeError('chainOptions must be a number'); }
        var args = {
            curves : (curves === null ? curves : curves.handle),
            chainOptions : Number(chainOptions)
        };
        var result = adsk.core.Base._executeStatic('adsk.fusion.Path', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.Path) : null;
    };
    ...
    adsk.fusion.Path.prototype.addCurves = function (curves, chainOptions) {
        if (curves !== null && !(curves instanceof adsk.core.Base)) { throw new TypeError('curves must be a adsk.core.Base'); }
        if (!isFinite(chainOptions)) { throw new TypeError('chainOptions must be a number'); }
        var args = {
            curves : (curves === null ? curves : curves.handle),
        ...
        var result = this._execute('addCurves', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.PathEntity.classType = function classType () {
        return 'adsk::fusion::PathEntity';
    };
    ...
    Object.defineProperty(adsk.fusion.PathEntity.prototype, 'isOpposedToEntity', {
        get : function () {
            var result = this._execute('isOpposedToEntity');
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.PathPatternFeatureInput.classType = function classType () {
        return 'adsk::fusion::PathPatternFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.PathPatternFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.PathPatternFeatures.classType = function classType () {
        return 'adsk::fusion::PathPatternFeatures';
    };
    ...
    adsk.fusion.PatternElement.classType = function classType () {
        return 'adsk::fusion::PatternElement';
    };
    ...
    adsk.fusion.PatternElements.classType = function classType () {
        return 'adsk::fusion::PatternElements';
    };
    ...
    adsk.fusion.PipeFeatures.classType = function classType () {
        return 'adsk::fusion::PipeFeatures';
    };
    ...
    adsk.fusion.RectangularPatternFeatureInput.classType = function classType () {
        return 'adsk::fusion::RectangularPatternFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.RectangularPatternFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.RectangularPatternFeatures.classType = function classType () {
        return 'adsk::fusion::RectangularPatternFeatures';
    };
    ...
    adsk.fusion.RemoveFeatures.classType = function classType () {
        return 'adsk::fusion::RemoveFeatures';
    };
    ...
    adsk.fusion.ReplaceFaceFeatureInput.classType = function classType () {
        return 'adsk::fusion::ReplaceFaceFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ReplaceFaceFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ReplaceFaceFeatures.classType = function classType () {
        return 'adsk::fusion::ReplaceFaceFeatures';
    };
    ...
    adsk.fusion.ReverseNormalFeatures.classType = function classType () {
        return 'adsk::fusion::ReverseNormalFeatures';
    };
    ...
    adsk.fusion.RevolveFeatureInput.classType = function classType () {
        return 'adsk::fusion::RevolveFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.RevolveFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.RevolveFeatures.classType = function classType () {
        return 'adsk::fusion::RevolveFeatures';
    };
    ...
    adsk.fusion.RibFeatures.classType = function classType () {
        return 'adsk::fusion::RibFeatures';
    };
    ...
    adsk.fusion.RuleFilletFeatures.classType = function classType () {
        return 'adsk::fusion::RuleFilletFeatures';
    };
    ...
    adsk.fusion.ScaleFeatureInput.classType = function classType () {
        return 'adsk::fusion::ScaleFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ScaleFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ScaleFeatures.classType = function classType () {
        return 'adsk::fusion::ScaleFeatures';
    };
    ...
    adsk.fusion.ShellFeatureInput.classType = function classType () {
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ShellFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ShellFeatures.classType = function classType () {
        return 'adsk::fusion::ShellFeatures';
    };
    ...
    adsk.fusion.SilhouetteSplitFeatureInput.classType = function classType () {
        return 'adsk::fusion::SilhouetteSplitFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.SilhouetteSplitFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.SilhouetteSplitFeatures.classType = function classType () {
        return 'adsk::fusion::SilhouetteSplitFeatures';
    };
    ...
    adsk.fusion.SphereFeatures.classType = function classType () {
        return 'adsk::fusion::SphereFeatures';
    };
    ...
    adsk.fusion.SplitBodyFeatureInput.classType = function classType () {
        return 'adsk::fusion::SplitBodyFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.SplitBodyFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.SplitBodyFeatures.classType = function classType () {
        return 'adsk::fusion::SplitBodyFeatures';
    };
    ...
    adsk.fusion.SplitFaceFeatureInput.classType = function classType () {
        return 'adsk::fusion::SplitFaceFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.SplitFaceFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.SplitFaceFeatures.classType = function classType () {
        return 'adsk::fusion::SplitFaceFeatures';
    };
    ...
    adsk.fusion.StitchFeatureInput.classType = function classType () {
        return 'adsk::fusion::StitchFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.StitchFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.StitchFeatures.classType = function classType () {
        return 'adsk::fusion::StitchFeatures';
    };
    ...
    adsk.fusion.SurfaceDeleteFaceFeatures = function SurfaceDeleteFaceFeatures(handle) {
        if (!(this instanceof adsk.fusion.SurfaceDeleteFaceFeatures)) {
            return adsk.fusion.SurfaceDeleteFaceFeatures.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.SurfaceDeleteFaceFeatures.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.SurfaceDeleteFaceFeatures.prototype.constructor = adsk.fusion.SurfaceDeleteFaceFeatures;
    adsk.fusion.SurfaceDeleteFaceFeatures.classType = function classType () {
        return 'adsk::fusion::SurfaceDeleteFaceFeatures';
    };
    adsk.fusion.SurfaceDeleteFaceFeatures.interfaceId = 'adsk.fusion.SurfaceDeleteFaceFeatures';
    adsk.objectTypes['adsk.fusion.SurfaceDeleteFaceFeatures'] = adsk.fusion.SurfaceDeleteFaceFeatures;
    adsk.fusion.SurfaceDeleteFaceFeatures.cast = function (object) {
        return object instanceof adsk.fusion.SurfaceDeleteFaceFeatures ? object : null;
    };

    // The number of SurfaceDeleteFaceFeature objects in the collection.
    Object.defineProperty(adsk.fusion.SurfaceDeleteFaceFeatures.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.SurfaceDeleteFaceFeatures.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SurfaceDeleteFaceFeature) : null;
    };

    // Function that returns the specified SurfaceDeleteFaceFeature object using the name of the feature.
    // name : The name of the feature within the collection to return. This is the name seen in the timeline.
    // Returns the specified item or null if the specified name was not found.
    adsk.fusion.SurfaceDeleteFaceFeatures.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    adsk.fusion.SurfaceDeleteFaceFeatures.prototype.add = function (facesToDelete) {
        if (facesToDelete !== null && !(facesToDelete instanceof adsk.core.Base)) { throw new TypeError('facesToDelete must be a adsk.core.Base'); }
        var args = {
            facesToDelete : (facesToDelete === null ? facesToDelete : facesToDelete.handle)
        };
    ...
    adsk.fusion.SweepFeatureInput.classType = function classType () {
        return 'adsk::fusion::SweepFeatureInput';
    };
    ...
    // Gets and sets the sweep orientation. It defaults to PerpendicularOrientationType. This property is ignored when a guide rail has been specified.
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.SweepFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.SweepFeatures.classType = function classType () {
        return 'adsk::fusion::SweepFeatures';
    };
    ...
    adsk.fusion.ThickenFeatureInput.classType = function classType () {
        return 'adsk::fusion::ThickenFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ThickenFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ThickenFeatures.classType = function classType () {
        return 'adsk::fusion::ThickenFeatures';
    };
    ...
    adsk.fusion.ThreadDataQuery.classType = function classType () {
        return 'adsk::fusion::ThreadDataQuery';
    };
    ...
    adsk.fusion.ThreadFeatureInput.classType = function classType () {
        return 'adsk::fusion::ThreadFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ThreadFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.ThreadFeatures.classType = function classType () {
        return 'adsk::fusion::ThreadFeatures';
    };
    ...
    adsk.fusion.ThreadInfo.classType = function classType () {
        return 'adsk::fusion::ThreadInfo';
    };
    ...
    adsk.fusion.TorusFeatures.classType = function classType () {
        return 'adsk::fusion::TorusFeatures';
    };
    ...
    adsk.fusion.TrimFeatureInput.classType = function classType () {
        return 'adsk::fusion::TrimFeatureInput';
    };
    ...
    // When creating a feature that is owned by a base feature, set this property to the base feature you want to associate the new feature with. By default, this is null, meaning it will not be associated with a base feature. Because of a current limitation, if you want to create a feature associated with a base feature, you must set this property AND call the startEdit method of the base feature, create the feature, and then call the finishEdit method of the base feature. The base feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.TrimFeatureInput.prototype, 'targetBaseFeature', {
        get : function () {
            var result = this._execute('targetBaseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        },
    ...
    adsk.fusion.TrimFeatures.classType = function classType () {
        return 'adsk::fusion::TrimFeatures';
    };
    ...
    adsk.fusion.UnstitchFeatures.classType = function classType () {
        return 'adsk::fusion::UnstitchFeatures';
    };
    ...
    adsk.fusion.WebFeatures.classType = function classType () {
        return 'adsk::fusion::WebFeatures';
    };
    ...
    adsk.fusion.AllExtentDefinition.classType = function classType () {
        return 'adsk::fusion::AllExtentDefinition';
    };
    ...
    adsk.fusion.AngleExtentDefinition.classType = function classType () {
        return 'adsk::fusion::AngleExtentDefinition';
    };
    ...
    adsk.fusion.AtCenterHolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::AtCenterHolePositionDefinition';
    };
    ...
    adsk.fusion.BaseFeature.classType = function classType () {
    ...
    Object.defineProperty(adsk.fusion.BaseFeature.prototype, 'constructionPlanes', {
        get : function () {
            ...
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.ConstructionPlane) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.BaseFeature.prototype, 'constructionAxes', {
        get : function () {
            ...
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.ConstructionAxis) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.BaseFeature.prototype, 'constructionPoints', {
        get : function () {
            ...
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.ConstructionPoint) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.BaseFeature.prototype, 'sketches', {
        get : function () {
            ...
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.Sketch) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.BaseFeature.prototype, 'meshBodies', {
        get : function () {
            ...
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.MeshBody) : null;
            }
            return resultValue
        }
    });
    ...
    // Returns true if successful.
    adsk.fusion.BaseFeature.prototype.startEdit = function () {
        var result = this._execute('startEdit');
        return result ? result.value : undefined;
    };

    // Exits from edit mode in the user-interface. If this base feature in not in edit mode, then nothing happens.
    // Returns true if successful.
    adsk.fusion.BaseFeature.prototype.finishEdit = function () {
        var result = this._execute('finishEdit');
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.BoundaryFillFeature.classType = function classType () {
        return 'adsk::fusion::BoundaryFillFeature';
    };
    ...
    adsk.fusion.BoxFeature.classType = function classType () {
        return 'adsk::fusion::BoxFeature';
    };
    ...
    adsk.fusion.ChamferFeature.classType = function classType () {
        return 'adsk::fusion::ChamferFeature';
    };
    ...
    adsk.fusion.ChordLengthFilletEdgeSet.classType = function classType () {
    ...
    // Gets and sets the edges that will be filleted. In order to access (get) the input edges of a fillet, you must roll the timeline back to just before the fillet feature whose edges you want to access.
    ...
    adsk.fusion.CircularPatternFeature.classType = function classType () {
        return 'adsk::fusion::CircularPatternFeature';
    };
    ...
    adsk.fusion.CoilFeature.classType = function classType () {
        return 'adsk::fusion::CoilFeature';
    };
    ...
    adsk.fusion.CombineFeature.classType = function classType () {
        return 'adsk::fusion::CombineFeature';
    };
    ...
    adsk.fusion.ConstantRadiusFilletEdgeSet.classType = function classType () {
    ...
    adsk.fusion.CylinderFeature.classType = function classType () {
        return 'adsk::fusion::CylinderFeature';
    };
    ...
    adsk.fusion.DeleteFaceFeature = function DeleteFaceFeature(handle) {
        if (!(this instanceof adsk.fusion.DeleteFaceFeature)) {
            return adsk.fusion.DeleteFaceFeature.cast(handle);
        }
        adsk.fusion.Feature.call(this, handle);
    };
    adsk.fusion.DeleteFaceFeature.prototype = Object.create(adsk.fusion.Feature.prototype);
    adsk.fusion.DeleteFaceFeature.prototype.constructor = adsk.fusion.DeleteFaceFeature;
    adsk.fusion.DeleteFaceFeature.classType = function classType () {
        return 'adsk::fusion::DeleteFaceFeature';
    };
    adsk.fusion.DeleteFaceFeature.interfaceId = 'adsk.fusion.DeleteFaceFeature';
    adsk.objectTypes['adsk.fusion.DeleteFaceFeature'] = adsk.fusion.DeleteFaceFeature;
    adsk.fusion.DeleteFaceFeature.cast = function (object) {
        return object instanceof adsk.fusion.DeleteFaceFeature ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.DeleteFaceFeature.prototype, 'deletedFaces', {
        get : function () {
            var result = this._execute('deletedFaces');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
        ...
        set : function (value) {
            ...
            var result = this._execute('deletedFaces', args);
            return result ? result.value : undefined;
        }
    });

    // The NativeObject is the object outside the context of an assembly and in the context of it's parent component. Returns null in the case where this object is not in the context of an assembly but is already the native object.
    Object.defineProperty(adsk.fusion.DeleteFaceFeature.prototype, 'nativeObject', {
        get : function () {
            var result = this._execute('nativeObject');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.DeleteFaceFeature) : null;
        }
    ...
    adsk.fusion.DeleteFaceFeature.prototype.createForAssemblyContext = function (occurrence) {
        if (occurrence !== null && !(occurrence instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrence must be a adsk.fusion.Occurrence'); }
        var args = {
            occurrence : (occurrence === null ? occurrence : occurrence.handle)
        };
    ...
    adsk.fusion.DistanceAndAngleChamferTypeDefinition.classType = function classType () {
        return 'adsk::fusion::DistanceAndAngleChamferTypeDefinition';
    };
    ...
    adsk.fusion.DistanceExtentDefinition.classType = function classType () {
        return 'adsk::fusion::DistanceExtentDefinition';
    };
    ...
    adsk.fusion.DistanceExtentDefinition.create = function (distance) {
        ...
        var result = adsk.core.Base._executeStatic('adsk.fusion.DistanceExtentDefinition', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.DistanceExtentDefinition) : null;
    };
    ...
    adsk.fusion.DraftFeature.classType = function classType () {
        return 'adsk::fusion::DraftFeature';
    };
    ...
    adsk.fusion.EqualDistanceChamferTypeDefinition.classType = function classType () {
        return 'adsk::fusion::EqualDistanceChamferTypeDefinition';
    };
    ...
    adsk.fusion.ExtendFeature.classType = function classType () {
        return 'adsk::fusion::ExtendFeature';
    };
    ...
    adsk.fusion.ExtrudeFeature.classType = function classType () {
        return 'adsk::fusion::ExtrudeFeature';
    };
    ...
    // Gets and sets the extent used to define the start of the extrusion. You can set this property with either a ProfilePlaneStartDefinition, ProfilePlaneWithOffsetStartDefinition or a EntityStartDefinition object. You can get any of those objects by using the static create method on the class.
    Object.defineProperty(adsk.fusion.ExtrudeFeature.prototype, 'startExtent', {
        get : function () {
            var result = this._execute('startExtent');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ExtentDefinition) : null;
        },
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeature.prototype, 'extentOne', {
        get : function () {
            var result = this._execute('extentOne');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ExtentDefinition) : null;
        },
        set : function (value) {
            ...
            var result = this._execute('extentOne', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.ExtrudeFeature.prototype, 'extentTwo', {
        get : function () {
            var result = this._execute('extentTwo');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ExtentDefinition) : null;
        },
        set : function (value) {
            ...
            var result = this._execute('extentTwo', args);
            return result ? result.value : undefined;
        }
    });
    ...
    // taperAngle : Optional argument that specifies the taper angle. If omitted a taper angle of 0 is used.
    // Returns true is setting the input to a one sided extent was successful.
    adsk.fusion.ExtrudeFeature.prototype.setOneSideExtent = function (extent, direction, taperAngle) {
        if (extent !== null && !(extent instanceof adsk.fusion.ExtentDefinition)) { throw new TypeError('extent must be a adsk.fusion.ExtentDefinition'); }
        if (!isFinite(direction)) { throw new TypeError('direction must be a number'); }
        if (taperAngle === null || (taperAngle !== undefined && taperAngle !== null && !(taperAngle instanceof adsk.core.ValueInput))) { throw new TypeError('taperAngle must be a adsk.core.ValueInput'); }
        var args = {
    ...
    adsk.fusion.FilletFeature.classType = function classType () {
        return 'adsk::fusion::FilletFeature';
    };
    ...
    adsk.fusion.FormFeature.classType = function classType () {
        return 'adsk::fusion::FormFeature';
    };
    ...
    adsk.fusion.FromEntityStartDefinition = function FromEntityStartDefinition(handle) {
        if (!(this instanceof adsk.fusion.FromEntityStartDefinition)) {
            return adsk.fusion.FromEntityStartDefinition.cast(handle);
        }
        adsk.fusion.ExtentDefinition.call(this, handle);
    };
    adsk.fusion.FromEntityStartDefinition.prototype = Object.create(adsk.fusion.ExtentDefinition.prototype);
    adsk.fusion.FromEntityStartDefinition.prototype.constructor = adsk.fusion.FromEntityStartDefinition;
    adsk.fusion.FromEntityStartDefinition.classType = function classType () {
        return 'adsk::fusion::FromEntityStartDefinition';
    };
    adsk.fusion.FromEntityStartDefinition.interfaceId = 'adsk.fusion.FromEntityStartDefinition';
    adsk.objectTypes['adsk.fusion.FromEntityStartDefinition'] = adsk.fusion.FromEntityStartDefinition;
    adsk.fusion.FromEntityStartDefinition.cast = function (object) {
        return object instanceof adsk.fusion.FromEntityStartDefinition ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.FromEntityStartDefinition.prototype, 'offset', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.FromEntityStartDefinition.prototype, 'entity', {
        get : function () {
            var result = this._execute('entity');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        },
    ...
    adsk.fusion.FromEntityStartDefinition.create = function (entity, offset) {
        if (entity !== null && !(entity instanceof adsk.core.Base)) { throw new TypeError('entity must be a adsk.core.Base'); }
        ...
        var result = adsk.core.Base._executeStatic('adsk.fusion.FromEntityStartDefinition', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.FromEntityStartDefinition) : null;
    };
    ...
    adsk.fusion.HoleFeature.classType = function classType () {
        return 'adsk::fusion::HoleFeature';
    };
    ...
    adsk.fusion.LoftDirectionEndCondition = function LoftDirectionEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftDirectionEndCondition)) {
            return adsk.fusion.LoftDirectionEndCondition.cast(handle);
        }
        adsk.fusion.LoftEndCondition.call(this, handle);
    };
    adsk.fusion.LoftDirectionEndCondition.prototype = Object.create(adsk.fusion.LoftEndCondition.prototype);
    adsk.fusion.LoftDirectionEndCondition.prototype.constructor = adsk.fusion.LoftDirectionEndCondition;
    adsk.fusion.LoftDirectionEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftDirectionEndCondition';
    };
    adsk.fusion.LoftDirectionEndCondition.interfaceId = 'adsk.fusion.LoftDirectionEndCondition';
    adsk.objectTypes['adsk.fusion.LoftDirectionEndCondition'] = adsk.fusion.LoftDirectionEndCondition;
    adsk.fusion.LoftDirectionEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftDirectionEndCondition ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.LoftDirectionEndCondition.prototype, 'angle', {
        get : function () {
            var result = this._execute('angle');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.LoftDirectionEndCondition.prototype, 'weight', {
        get : function () {
    ...
    adsk.fusion.LoftFeature.classType = function classType () {
        return 'adsk::fusion::LoftFeature';
    };
    ...
    // Returns the set of sections that the loft passes through. This property returns null in the case where the feature is non-parametric.
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'loftSections', {
        get : function () {
            var result = this._execute('loftSections');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftSections) : null;
        }
    ...
    // Returns the single centerline or the set of rails that define the shape of the loft. This property returns null in the case where the feature is non-parametric.
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'centerLineOrRails', {
        get : function () {
            var result = this._execute('centerLineOrRails');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftCenterLineOrRails) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'startFace', {
        get : function () {
            var result = this._execute('startFace');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BRepFace) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'endFace', {
        get : function () {
            var result = this._execute('endFace');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BRepFace) : null;
        }
    });

    // Property that returns all of the side faces (i.e. those running through the sections) of the feature.
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'sideFaces', {
        get : function () {
            var result = this._execute('sideFaces');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BRepFaces) : null;
        }
    ...
    // Gets and sets the type of operation performed by the extrusion.
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'operation', {
        get : function () {
            var result = this._execute('operation');
            return result ? result.value : undefined;
        },
    ...
    // Indicates if this feature was initially created as a solid or a surface.
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'isSolid', {
        get : function () {
            var result = this._execute('isSolid');
            return result ? result.value : undefined;
        }
    ...
    // applied to the proxy - e.g. the assembly transform is applied to geometry.
    // **
    Object.defineProperty(adsk.fusion.LoftFeature.prototype, 'nativeObject', {
        get : function () {
            var result = this._execute('nativeObject');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.LoftFeature) : null;
        }
    ...
    // occurrence : The occurrence that defines the context to create the proxy in.
    // Returns the proxy object or null if this isn't the NativeObject.
    adsk.fusion.LoftFeature.prototype.createForAssemblyContext = function (occurrence) {
        if (occurrence !== null && !(occurrence instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrence must be a adsk.fusion.Occurrence'); }
        var args = {
            occurrence : (occurrence === null ? occurrence : occurrence.handle)
        };
    ...
    adsk.fusion.LoftFreeEndCondition = function LoftFreeEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftFreeEndCondition)) {
            return adsk.fusion.LoftFreeEndCondition.cast(handle);
        }
        adsk.fusion.LoftEndCondition.call(this, handle);
    };
    adsk.fusion.LoftFreeEndCondition.prototype = Object.create(adsk.fusion.LoftEndCondition.prototype);
    adsk.fusion.LoftFreeEndCondition.prototype.constructor = adsk.fusion.LoftFreeEndCondition;
    adsk.fusion.LoftFreeEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftFreeEndCondition';
    };
    adsk.fusion.LoftFreeEndCondition.interfaceId = 'adsk.fusion.LoftFreeEndCondition';
    adsk.objectTypes['adsk.fusion.LoftFreeEndCondition'] = adsk.fusion.LoftFreeEndCondition;
    adsk.fusion.LoftFreeEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftFreeEndCondition ? object : null;
    };

    //=========== LoftPointSharpEndCondition ============
    // Represents a "Point Sharp" loft end condition.
    adsk.fusion.LoftPointSharpEndCondition = function LoftPointSharpEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftPointSharpEndCondition)) {
            return adsk.fusion.LoftPointSharpEndCondition.cast(handle);
        }
        adsk.fusion.LoftEndCondition.call(this, handle);
    };
    adsk.fusion.LoftPointSharpEndCondition.prototype = Object.create(adsk.fusion.LoftEndCondition.prototype);
    adsk.fusion.LoftPointSharpEndCondition.prototype.constructor = adsk.fusion.LoftPointSharpEndCondition;
    adsk.fusion.LoftPointSharpEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftPointSharpEndCondition';
    };
    adsk.fusion.LoftPointSharpEndCondition.interfaceId = 'adsk.fusion.LoftPointSharpEndCondition';
    adsk.objectTypes['adsk.fusion.LoftPointSharpEndCondition'] = adsk.fusion.LoftPointSharpEndCondition;
    adsk.fusion.LoftPointSharpEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftPointSharpEndCondition ? object : null;
    };

    //=========== LoftPointTangentEndCondition ============
    // Represents a "Point Tangent" loft end condition.
    adsk.fusion.LoftPointTangentEndCondition = function LoftPointTangentEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftPointTangentEndCondition)) {
            return adsk.fusion.LoftPointTangentEndCondition.cast(handle);
        }
        adsk.fusion.LoftEndCondition.call(this, handle);
    };
    adsk.fusion.LoftPointTangentEndCondition.prototype = Object.create(adsk.fusion.LoftEndCondition.prototype);
    adsk.fusion.LoftPointTangentEndCondition.prototype.constructor = adsk.fusion.LoftPointTangentEndCondition;
    adsk.fusion.LoftPointTangentEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftPointTangentEndCondition';
    };
    adsk.fusion.LoftPointTangentEndCondition.interfaceId = 'adsk.fusion.LoftPointTangentEndCondition';
    adsk.objectTypes['adsk.fusion.LoftPointTangentEndCondition'] = adsk.fusion.LoftPointTangentEndCondition;
    adsk.fusion.LoftPointTangentEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftPointTangentEndCondition ? object : null;
    };

    // Gets the valueInput or Parameter that defines the weight of the loft. If this object was obtained from a LoftFeatureInput object then this will return a valueInput object with the initial value provided. If this object was obtained from an exiting LoftFeature then it returns a Parameter. In the case of a parameter, to change the weight, edit the value of the associated parameter.
    Object.defineProperty(adsk.fusion.LoftPointTangentEndCondition.prototype, 'weight', {
        get : function () {
            var result = this._execute('weight');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    adsk.fusion.LoftSmoothEndCondition = function LoftSmoothEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftSmoothEndCondition)) {
            return adsk.fusion.LoftSmoothEndCondition.cast(handle);
        }
        adsk.fusion.LoftEndCondition.call(this, handle);
    };
    adsk.fusion.LoftSmoothEndCondition.prototype = Object.create(adsk.fusion.LoftEndCondition.prototype);
    adsk.fusion.LoftSmoothEndCondition.prototype.constructor = adsk.fusion.LoftSmoothEndCondition;
    adsk.fusion.LoftSmoothEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftSmoothEndCondition';
    };
    adsk.fusion.LoftSmoothEndCondition.interfaceId = 'adsk.fusion.LoftSmoothEndCondition';
    adsk.objectTypes['adsk.fusion.LoftSmoothEndCondition'] = adsk.fusion.LoftSmoothEndCondition;
    adsk.fusion.LoftSmoothEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftSmoothEndCondition ? object : null;
    };

    // Gets the valueInput or Parameter that defines the weight of the loft. If this object was obtained from a LoftFeatureInput object then this will return a valueInput object with the initial value provided. If this object was obtained from an exiting LoftFeature then it returns a Parameter. In the case of a parameter, to change the weight, edit the value of the associated parameter.
    Object.defineProperty(adsk.fusion.LoftSmoothEndCondition.prototype, 'weight', {
        get : function () {
            var result = this._execute('weight');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    adsk.fusion.LoftTangentEndCondition = function LoftTangentEndCondition(handle) {
        if (!(this instanceof adsk.fusion.LoftTangentEndCondition)) {
            return adsk.fusion.LoftTangentEndCondition.cast(handle);
        }
        adsk.fusion.LoftEndCondition.call(this, handle);
    };
    adsk.fusion.LoftTangentEndCondition.prototype = Object.create(adsk.fusion.LoftEndCondition.prototype);
    adsk.fusion.LoftTangentEndCondition.prototype.constructor = adsk.fusion.LoftTangentEndCondition;
    adsk.fusion.LoftTangentEndCondition.classType = function classType () {
        return 'adsk::fusion::LoftTangentEndCondition';
    };
    adsk.fusion.LoftTangentEndCondition.interfaceId = 'adsk.fusion.LoftTangentEndCondition';
    adsk.objectTypes['adsk.fusion.LoftTangentEndCondition'] = adsk.fusion.LoftTangentEndCondition;
    adsk.fusion.LoftTangentEndCondition.cast = function (object) {
        return object instanceof adsk.fusion.LoftTangentEndCondition ? object : null;
    };

    // Gets the valueInput or Parameter that defines the weight of the loft. If this object was obtained from a LoftFeatureInput object then this will return a valueInput object with the initial value provided. If this object was obtained from an exiting LoftFeature then it returns a Parameter. In the case of a parameter, to change the weight, edit the value of the associated parameter.
    Object.defineProperty(adsk.fusion.LoftTangentEndCondition.prototype, 'weight', {
        get : function () {
            var result = this._execute('weight');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    adsk.fusion.MirrorFeature.classType = function classType () {
        return 'adsk::fusion::MirrorFeature';
    };
    ...
    adsk.fusion.MoveFeature.classType = function classType () {
        return 'adsk::fusion::MoveFeature';
    };
    ...
    adsk.fusion.OffsetFeature.classType = function classType () {
        return 'adsk::fusion::OffsetFeature';
    };
    ...
    // entities : The BRepBody or BRepFace objects to offset. If a BRepBody is used it must be open, (the isSolid property must be False). Faces from both solid and open bodies can be offset. Input faces need not be from the same closed or open body.
    ...
    adsk.fusion.OffsetStartDefinition = function OffsetStartDefinition(handle) {
        if (!(this instanceof adsk.fusion.OffsetStartDefinition)) {
            return adsk.fusion.OffsetStartDefinition.cast(handle);
        }
        adsk.fusion.ExtentDefinition.call(this, handle);
    };
    adsk.fusion.OffsetStartDefinition.prototype = Object.create(adsk.fusion.ExtentDefinition.prototype);
    adsk.fusion.OffsetStartDefinition.prototype.constructor = adsk.fusion.OffsetStartDefinition;
    adsk.fusion.OffsetStartDefinition.classType = function classType () {
        return 'adsk::fusion::OffsetStartDefinition';
    };
    adsk.fusion.OffsetStartDefinition.interfaceId = 'adsk.fusion.OffsetStartDefinition';
    adsk.objectTypes['adsk.fusion.OffsetStartDefinition'] = adsk.fusion.OffsetStartDefinition;
    adsk.fusion.OffsetStartDefinition.cast = function (object) {
        return object instanceof adsk.fusion.OffsetStartDefinition ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.OffsetStartDefinition.prototype, 'offset', {
        get : function () {
            var result = this._execute('offset');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.OffsetStartDefinition.prototype, 'profilePlane', {
        get : function () {
            var result = this._execute('profilePlane');
    ...
    adsk.fusion.OffsetStartDefinition.create = function (offset) {
        ...
        var result = adsk.core.Base._executeStatic('adsk.fusion.OffsetStartDefinition', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.OffsetStartDefinition) : null;
    };
    ...
    adsk.fusion.OnEdgeHolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::OnEdgeHolePositionDefinition';
    };
    ...
    adsk.fusion.OneSideToExtentDefinition.classType = function classType () {
        return 'adsk::fusion::OneSideToExtentDefinition';
    };
    ...
    adsk.fusion.PatchFeature.classType = function classType () {
        return 'adsk::fusion::PatchFeature';
    };
    ...
    Object.defineProperty(adsk.fusion.PatchFeature.prototype, 'operation', {
        get : function () {
            var result = this._execute('operation');
            return result ? result.value : undefined;
        }
    ...
    // Gets and sets the type of surface continuity used when creating the patch face. This is only used when BRepEdges are input and defines the continuity of how the patch face connects to the face adjacent to each of the input edges.
    Object.defineProperty(adsk.fusion.PatchFeature.prototype, 'continuity', {
        get : function () {
            var result = this._execute('continuity');
            return result ? result.value : undefined;
        },
    ...
    // applied to the proxy - e.g. the assembly transform is applied to geometry.
    // **
    Object.defineProperty(adsk.fusion.PatchFeature.prototype, 'nativeObject', {
        get : function () {
            var result = this._execute('nativeObject');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.PatchFeature) : null;
        }
    ...
    // occurrence : The occurrence that defines the context to create the proxy in.
    // Returns the proxy object or null if this is not the NativeObject.
    adsk.fusion.PatchFeature.prototype.createForAssemblyContext = function (occurrence) {
        if (occurrence !== null && !(occurrence instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrence must be a adsk.fusion.Occurrence'); }
        var args = {
            occurrence : (occurrence === null ? occurrence : occurrence.handle)
        };
    ...
    adsk.fusion.PathPatternFeature.classType = function classType () {
        return 'adsk::fusion::PathPatternFeature';
    };
    ...
    adsk.fusion.PipeFeature.classType = function classType () {
        return 'adsk::fusion::PipeFeature';
    };
    ...
    adsk.fusion.PlaneAndOffsetsHolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::PlaneAndOffsetsHolePositionDefinition';
    };
    ...
    adsk.fusion.PointHolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::PointHolePositionDefinition';
    };
    ...
    adsk.fusion.ProfilePlaneStartDefinition = function ProfilePlaneStartDefinition(handle) {
        if (!(this instanceof adsk.fusion.ProfilePlaneStartDefinition)) {
            return adsk.fusion.ProfilePlaneStartDefinition.cast(handle);
        }
        adsk.fusion.ExtentDefinition.call(this, handle);
    };
    adsk.fusion.ProfilePlaneStartDefinition.prototype = Object.create(adsk.fusion.ExtentDefinition.prototype);
    adsk.fusion.ProfilePlaneStartDefinition.prototype.constructor = adsk.fusion.ProfilePlaneStartDefinition;
    adsk.fusion.ProfilePlaneStartDefinition.classType = function classType () {
        return 'adsk::fusion::ProfilePlaneStartDefinition';
    };
    adsk.fusion.ProfilePlaneStartDefinition.interfaceId = 'adsk.fusion.ProfilePlaneStartDefinition';
    adsk.objectTypes['adsk.fusion.ProfilePlaneStartDefinition'] = adsk.fusion.ProfilePlaneStartDefinition;
    adsk.fusion.ProfilePlaneStartDefinition.cast = function (object) {
        return object instanceof adsk.fusion.ProfilePlaneStartDefinition ? object : null;
    };

    // Returns the geometric definition of the profile plane.
    Object.defineProperty(adsk.fusion.ProfilePlaneStartDefinition.prototype, 'profilePlane', {
        get : function () {
            var result = this._execute('profilePlane');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Plane) : null;
        }
    ...
    adsk.fusion.ProfilePlaneStartDefinition.create = function () {
        var result = adsk.core.Base._executeStatic('adsk.fusion.ProfilePlaneStartDefinition', 'create');
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ProfilePlaneStartDefinition) : null;
    };
    ...
    adsk.fusion.RectangularPatternFeature.classType = function classType () {
        return 'adsk::fusion::RectangularPatternFeature';
    };
    ...
    adsk.fusion.RemoveFeature.classType = function classType () {
        return 'adsk::fusion::RemoveFeature';
    };
    ...
    // Gets and sets the body or component occurrence to remove. In order to access (get) the item removed, you must roll the timeline back to just before the remove feature whose item you want to access.
    ...
    adsk.fusion.ReplaceFaceFeature.classType = function classType () {
        return 'adsk::fusion::ReplaceFaceFeature';
    };
    ...
    adsk.fusion.ReverseNormalFeature.classType = function classType () {
        return 'adsk::fusion::ReverseNormalFeature';
    };
    ...
    adsk.fusion.RevolveFeature.classType = function classType () {
        return 'adsk::fusion::RevolveFeature';
    };
    ...
    adsk.fusion.RibFeature.classType = function classType () {
        return 'adsk::fusion::RibFeature';
    };
    ...
    adsk.fusion.RuleFilletFeature.classType = function classType () {
        return 'adsk::fusion::RuleFilletFeature';
    };
    ...
    adsk.fusion.ScaleFeature.classType = function classType () {
        return 'adsk::fusion::ScaleFeature';
    };
    ...
    adsk.fusion.ShellFeature.classType = function classType () {
    ...
    adsk.fusion.SilhouetteSplitFeature.classType = function classType () {
        return 'adsk::fusion::SilhouetteSplitFeature';
    };
    ...
    adsk.fusion.SketchPointHolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::SketchPointHolePositionDefinition';
    };
    ...
    // Provides positioning information for a hole that is positioned by a sketch point.
    adsk.fusion.SketchPointsHolePositionDefinition = function SketchPointsHolePositionDefinition(handle) {
        if (!(this instanceof adsk.fusion.SketchPointsHolePositionDefinition)) {
            return adsk.fusion.SketchPointsHolePositionDefinition.cast(handle);
        }
        adsk.fusion.HolePositionDefinition.call(this, handle);
    };
    adsk.fusion.SketchPointsHolePositionDefinition.prototype = Object.create(adsk.fusion.HolePositionDefinition.prototype);
    adsk.fusion.SketchPointsHolePositionDefinition.prototype.constructor = adsk.fusion.SketchPointsHolePositionDefinition;
    adsk.fusion.SketchPointsHolePositionDefinition.classType = function classType () {
        return 'adsk::fusion::SketchPointsHolePositionDefinition';
    };
    adsk.fusion.SketchPointsHolePositionDefinition.interfaceId = 'adsk.fusion.SketchPointsHolePositionDefinition';
    adsk.objectTypes['adsk.fusion.SketchPointsHolePositionDefinition'] = adsk.fusion.SketchPointsHolePositionDefinition;
    adsk.fusion.SketchPointsHolePositionDefinition.cast = function (object) {
        return object instanceof adsk.fusion.SketchPointsHolePositionDefinition ? object : null;
    };

    // Returns the sketch point that defines the center of the hole.
    Object.defineProperty(adsk.fusion.SketchPointsHolePositionDefinition.prototype, 'sketchPoints', {
        get : function () {
    ...
    adsk.fusion.SphereFeature.classType = function classType () {
        return 'adsk::fusion::SphereFeature';
    };
    ...
    adsk.fusion.SplitBodyFeature.classType = function classType () {
        return 'adsk::fusion::SplitBodyFeature';
    };
    ...
    adsk.fusion.SplitFaceFeature.classType = function classType () {
        return 'adsk::fusion::SplitFaceFeature';
    };
    ...
    adsk.fusion.StitchFeature.classType = function classType () {
        return 'adsk::fusion::StitchFeature';
    };
    ...
    // Returns the parameter controlling the tolerance. You can edit the tolerance by editing the value of the parameter object.
    ...
    adsk.fusion.SurfaceDeleteFaceFeature = function SurfaceDeleteFaceFeature(handle) {
        if (!(this instanceof adsk.fusion.SurfaceDeleteFaceFeature)) {
            return adsk.fusion.SurfaceDeleteFaceFeature.cast(handle);
        }
        adsk.fusion.Feature.call(this, handle);
    };
    adsk.fusion.SurfaceDeleteFaceFeature.prototype = Object.create(adsk.fusion.Feature.prototype);
    adsk.fusion.SurfaceDeleteFaceFeature.prototype.constructor = adsk.fusion.SurfaceDeleteFaceFeature;
    adsk.fusion.SurfaceDeleteFaceFeature.classType = function classType () {
        return 'adsk::fusion::SurfaceDeleteFaceFeature';
    };
    adsk.fusion.SurfaceDeleteFaceFeature.interfaceId = 'adsk.fusion.SurfaceDeleteFaceFeature';
    adsk.objectTypes['adsk.fusion.SurfaceDeleteFaceFeature'] = adsk.fusion.SurfaceDeleteFaceFeature;
    adsk.fusion.SurfaceDeleteFaceFeature.cast = function (object) {
        return object instanceof adsk.fusion.SurfaceDeleteFaceFeature ? object : null;
    };

    // Gets and sets the set of faces that are deleted by this feature. To be able to use this property to both get and set the faces, you need to first roll the timeline to immediately before this feature. This can be accomplished using the following code where thisFeature is a reference to a SurfaceDeleteFaceFeature: thisFeature.timelineObject.rollTo(True)
    Object.defineProperty(adsk.fusion.SurfaceDeleteFaceFeature.prototype, 'deletedFaces', {
        get : function () {
            var result = this._execute('deletedFaces');
            if (!result || !Array.isArray(result.value)) {
                return undefined
    ...
    // applied to the proxy - e.g. the assembly transform is applied to geometry.
    // **
    Object.defineProperty(adsk.fusion.SurfaceDeleteFaceFeature.prototype, 'nativeObject', {
        get : function () {
            var result = this._execute('nativeObject');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SurfaceDeleteFaceFeature) : null;
        }
    ...
    // occurrence : The occurrence that defines the context to create the proxy in.
    // Returns the proxy object or null if this is not the NativeObject.
    adsk.fusion.SurfaceDeleteFaceFeature.prototype.createForAssemblyContext = function (occurrence) {
        if (occurrence !== null && !(occurrence instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrence must be a adsk.fusion.Occurrence'); }
        var args = {
            occurrence : (occurrence === null ? occurrence : occurrence.handle)
        };
    ...
    adsk.fusion.SweepFeature.classType = function classType () {
        return 'adsk::fusion::SweepFeature';
    };
    ...
    // Gets the distance for the second side. Returns nothing if the path is only on one side of the profile or if the sweep definition includes a guide rail. It's always the distance against the normal of the profile if available. This property returns nothing in the case where the feature is non-parametric.
    ...
    adsk.fusion.SymmetricExtentDefinition = function SymmetricExtentDefinition(handle) {
        if (!(this instanceof adsk.fusion.SymmetricExtentDefinition)) {
            return adsk.fusion.SymmetricExtentDefinition.cast(handle);
        }
        adsk.fusion.ExtentDefinition.call(this, handle);
    };
    adsk.fusion.SymmetricExtentDefinition.prototype = Object.create(adsk.fusion.ExtentDefinition.prototype);
    adsk.fusion.SymmetricExtentDefinition.prototype.constructor = adsk.fusion.SymmetricExtentDefinition;
    adsk.fusion.SymmetricExtentDefinition.classType = function classType () {
        return 'adsk::fusion::SymmetricExtentDefinition';
    };
    adsk.fusion.SymmetricExtentDefinition.interfaceId = 'adsk.fusion.SymmetricExtentDefinition';
    adsk.objectTypes['adsk.fusion.SymmetricExtentDefinition'] = adsk.fusion.SymmetricExtentDefinition;
    adsk.fusion.SymmetricExtentDefinition.cast = function (object) {
        return object instanceof adsk.fusion.SymmetricExtentDefinition ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.SymmetricExtentDefinition.prototype, 'isFullLength', {
        get : function () {
            var result = this._execute('isFullLength');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.fusion.SymmetricExtentDefinition.prototype, 'distance', {
        get : function () {
            var result = this._execute('distance');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.SymmetricExtentDefinition.prototype, 'taperAngle', {
        get : function () {
            var result = this._execute('taperAngle');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    adsk.fusion.SymmetricExtentDefinition.create = function (distance, isFullLength) {
        if (distance !== null && !(distance instanceof adsk.core.ValueInput)) { throw new TypeError('distance must be a adsk.core.ValueInput'); }
        if (typeof isFullLength !== 'boolean') { throw new TypeError('isFullLength must be a boolean'); }
        var args = {
            distance : (distance === null ? distance : distance.handle),
        ...
        var result = adsk.core.Base._executeStatic('adsk.fusion.SymmetricExtentDefinition', 'create', args);
    ...
    adsk.fusion.ThickenFeature.classType = function classType () {
        return 'adsk::fusion::ThickenFeature';
    };
    ...
    // Returns the parameter controlling the thickness. You can edit the thickness value by editing the value of the parameter object.
    ...
    adsk.fusion.ThreadFeature.classType = function classType () {
        return 'adsk::fusion::ThreadFeature';
    };
    ...
    adsk.fusion.ThroughAllExtentDefinition = function ThroughAllExtentDefinition(handle) {
        if (!(this instanceof adsk.fusion.ThroughAllExtentDefinition)) {
            return adsk.fusion.ThroughAllExtentDefinition.cast(handle);
        }
        adsk.fusion.ExtentDefinition.call(this, handle);
    };
    adsk.fusion.ThroughAllExtentDefinition.prototype = Object.create(adsk.fusion.ExtentDefinition.prototype);
    adsk.fusion.ThroughAllExtentDefinition.prototype.constructor = adsk.fusion.ThroughAllExtentDefinition;
    adsk.fusion.ThroughAllExtentDefinition.classType = function classType () {
        return 'adsk::fusion::ThroughAllExtentDefinition';
    };
    adsk.fusion.ThroughAllExtentDefinition.interfaceId = 'adsk.fusion.ThroughAllExtentDefinition';
    adsk.objectTypes['adsk.fusion.ThroughAllExtentDefinition'] = adsk.fusion.ThroughAllExtentDefinition;
    adsk.fusion.ThroughAllExtentDefinition.cast = function (object) {
        return object instanceof adsk.fusion.ThroughAllExtentDefinition ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.ThroughAllExtentDefinition.prototype, 'isPositiveDirection', {
        get : function () {
            var result = this._execute('isPositiveDirection');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isPositiveDirection', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.ToEntityExtentDefinition = function ToEntityExtentDefinition(handle) {
        if (!(this instanceof adsk.fusion.ToEntityExtentDefinition)) {
            return adsk.fusion.ToEntityExtentDefinition.cast(handle);
        }
        adsk.fusion.ExtentDefinition.call(this, handle);
    };
    adsk.fusion.ToEntityExtentDefinition.prototype = Object.create(adsk.fusion.ExtentDefinition.prototype);
    adsk.fusion.ToEntityExtentDefinition.prototype.constructor = adsk.fusion.ToEntityExtentDefinition;
    adsk.fusion.ToEntityExtentDefinition.classType = function classType () {
        return 'adsk::fusion::ToEntityExtentDefinition';
    };
    adsk.fusion.ToEntityExtentDefinition.interfaceId = 'adsk.fusion.ToEntityExtentDefinition';
    adsk.objectTypes['adsk.fusion.ToEntityExtentDefinition'] = adsk.fusion.ToEntityExtentDefinition;
    adsk.fusion.ToEntityExtentDefinition.cast = function (object) {
        return object instanceof adsk.fusion.ToEntityExtentDefinition ? object : null;
    };
    ...
    Object.defineProperty(adsk.fusion.ToEntityExtentDefinition.prototype, 'entity', {
        get : function () {
            var result = this._execute('entity');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        },
    ...
    Object.defineProperty(adsk.fusion.ToEntityExtentDefinition.prototype, 'offset', {
        get : function () {
            var result = this._execute('offset');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.ToEntityExtentDefinition.prototype, 'isChained', {
        get : function () {
            var result = this._execute('isChained');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isChained', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.ToEntityExtentDefinition.prototype, 'directionHint', {
        get : function () {
            var result = this._execute('directionHint');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Vector3D) : null;
        },
        set : function (value) {
            ...
            var result = this._execute('directionHint', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.ToEntityExtentDefinition.prototype, 'isMinimumSolution', {
        get : function () {
            var result = this._execute('isMinimumSolution');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isMinimumSolution', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.ToEntityExtentDefinition.create = function (entity, isChained, offset) {
        if (entity !== null && !(entity instanceof adsk.core.Base)) { throw new TypeError('entity must be a adsk.core.Base'); }
        if (typeof isChained !== 'boolean') { throw new TypeError('isChained must be a boolean'); }
        if (offset === null || (offset !== undefined && offset !== null && !(offset instanceof adsk.core.ValueInput))) { throw new TypeError('offset must be a adsk.core.ValueInput'); }
        var args = {
            entity : (entity === null ? entity : entity.handle),
            isChained : isChained
        };
        if (offset !== undefined) {
            args.offset = (offset === null ? offset : offset.handle);
        }
        var result = adsk.core.Base._executeStatic('adsk.fusion.ToEntityExtentDefinition', 'create', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ToEntityExtentDefinition) : null;
    };
    ...
    adsk.fusion.TorusFeature.classType = function classType () {
        return 'adsk::fusion::TorusFeature';
    };
    ...
    adsk.fusion.TrimFeature.classType = function classType () {
        return 'adsk::fusion::TrimFeature';
    };
    ...
    adsk.fusion.TwoDistancesChamferTypeDefinition.classType = function classType () {
        return 'adsk::fusion::TwoDistancesChamferTypeDefinition';
    };
    ...
    adsk.fusion.TwoSidesAngleExtentDefinition.classType = function classType () {
        return 'adsk::fusion::TwoSidesAngleExtentDefinition';
    };
    ...
    adsk.fusion.TwoSidesDistanceExtentDefinition.classType = function classType () {
        return 'adsk::fusion::TwoSidesDistanceExtentDefinition';
    };
    ...
    adsk.fusion.TwoSidesToExtentDefinition.classType = function classType () {
        return 'adsk::fusion::TwoSidesToExtentDefinition';
    };
    ...
    adsk.fusion.UnstitchFeature.classType = function classType () {
        return 'adsk::fusion::UnstitchFeature';
    };
    ...
    adsk.fusion.VariableRadiusFilletEdgeSet.classType = function classType () {
    ...
    adsk.fusion.WebFeature.classType = function classType () {
        return 'adsk::fusion::WebFeature';
    };
