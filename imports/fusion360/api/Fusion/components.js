...
(function (root, factory) {
    ...
    adsk.fusion.AsBuiltJoint.classType = function classType () {
        return 'adsk::fusion::AsBuiltJoint';
    };
    ...
    Object.defineProperty(adsk.fusion.AsBuiltJoint.prototype, 'attributes', {
        get : function () {
    ...
    adsk.fusion.AsBuiltJointInput.classType = function classType () {
        return 'adsk::fusion::AsBuiltJointInput';
    };
    ...
    adsk.fusion.AsBuiltJointList.classType = function classType () {
        return 'adsk::fusion::AsBuiltJointList';
    };
    ...
    adsk.fusion.AsBuiltJoints.classType = function classType () {
        return 'adsk::fusion::AsBuiltJoints';
    };
    ...
    adsk.fusion.BaseComponent.classType = function classType () {
        return 'adsk::fusion::BaseComponent';
    };
    ...
    // hitPoints : An ObjectCollection of Point3D objects that represent the coordinates where the ray hit the found entity. There will be the same number of hit points as returned entities and they will be in the collections in the same order. In other words, hit point 1 corresponds with found entity 1, hit point 2 corresponds with found entity 2, and so on. Because of the proximity tolerance the hitPoint may not actually lie on the entity but will be within the proximity tolerance to it. It's an optional out argument, returns the hit points if the input ObjectCollection object is not null.
    ...
    adsk.fusion.BaseComponent.prototype.findBRepUsingRay = function (originPoint, rayDirection, entityType, proximityTolerance, visibleEntitiesOnly, hitPoints) {
        if (originPoint !== null && !(originPoint instanceof adsk.core.Point3D)) { throw new TypeError('originPoint must be a adsk.core.Point3D'); }
        if (rayDirection !== null && !(rayDirection instanceof adsk.core.Vector3D)) { throw new TypeError('rayDirection must be a adsk.core.Vector3D'); }
        if (!isFinite(entityType)) { throw new TypeError('entityType must be a number'); }
        if (proximityTolerance === null || (proximityTolerance !== undefined && !isFinite(proximityTolerance))) { throw new TypeError('proximityTolerance must be a number'); }
        if (visibleEntitiesOnly === null || (visibleEntitiesOnly !== undefined && typeof visibleEntitiesOnly !== 'boolean')) { throw new TypeError('visibleEntitiesOnly must be a boolean'); }
        if (hitPoints === null || (hitPoints !== undefined && hitPoints !== null && !(hitPoints instanceof adsk.core.ObjectCollection))) { throw new TypeError('hitPoints must be a adsk.core.ObjectCollection'); }
        var args = {
            originPoint : (originPoint === null ? originPoint : originPoint.handle),
            rayDirection : (rayDirection === null ? rayDirection : rayDirection.handle),
            entityType : Number(entityType)
        };
        if (proximityTolerance !== undefined) {
            args.proximityTolerance = Number(proximityTolerance);
        }
        if (visibleEntitiesOnly !== undefined) {
            args.visibleEntitiesOnly = visibleEntitiesOnly;
        }
        if (hitPoints !== undefined) {
            args.hitPoints = (hitPoints === null ? hitPoints : hitPoints.handle);
        }
        var result = this._execute('findBRepUsingRay', args);
    ...
    adsk.fusion.BaseComponent.prototype.findBRepUsingPoint = function (point, entityType, proximityTolerance, visibleEntitiesOnly) {
    ...
    adsk.fusion.ComponentList.classType = function classType () {
        return 'adsk::fusion::ComponentList';
    };
    ...
    adsk.fusion.Components.classType = function classType () {
        return 'adsk::fusion::Components';
    };
    ...
    adsk.fusion.ContactSet = function ContactSet(handle) {
        if (!(this instanceof adsk.fusion.ContactSet)) {
            return adsk.fusion.ContactSet.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.ContactSet.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.ContactSet.prototype.constructor = adsk.fusion.ContactSet;
    adsk.fusion.ContactSet.classType = function classType () {
        return 'adsk::fusion::ContactSet';
    };
    adsk.fusion.ContactSet.interfaceId = 'adsk.fusion.ContactSet';
    adsk.objectTypes['adsk.fusion.ContactSet'] = adsk.fusion.ContactSet;
    adsk.fusion.ContactSet.cast = function (object) {
        return object instanceof adsk.fusion.ContactSet ? object : null;
    };

    // Gets and sets the name of the contact set.
    Object.defineProperty(adsk.fusion.ContactSet.prototype, 'name', {
        get : function () {
            var result = this._execute('name');
            return result ? result.value : undefined;
        },
    ...
    Object.defineProperty(adsk.fusion.ContactSet.prototype, 'occurencesAndBodies', {
        get : function () {
            var result = this._execute('occurencesAndBodies');
        ...
        set : function (value) {
            ...
            for (valueIt = 0; valueIt < valueLength; ++valueIt) {
                if (value[valueIt] !== null && !(value[valueIt] instanceof adsk.core.Base)) { throw new TypeError('value[valueIt] must be a adsk.core.Base'); }
            }
            var args = {
                value : value
            };
            var result = this._execute('occurencesAndBodies', args);
            return result ? result.value : undefined;
        }
    });

    // Gets and sets if this contact set is currently suppressed.
    Object.defineProperty(adsk.fusion.ContactSet.prototype, 'isSuppressed', {
        get : function () {
            var result = this._execute('isSuppressed');
            return result ? result.value : undefined;
        },
    ...
    adsk.fusion.ContactSet.prototype.deleteMe = function () {
        var result = this._execute('deleteMe');
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.ContactSets = function ContactSets(handle) {
        if (!(this instanceof adsk.fusion.ContactSets)) {
            return adsk.fusion.ContactSets.cast(handle);
        }
        adsk.core.Base.call(this, handle);
    };
    adsk.fusion.ContactSets.prototype = Object.create(adsk.core.Base.prototype);
    adsk.fusion.ContactSets.prototype.constructor = adsk.fusion.ContactSets;
    adsk.fusion.ContactSets.classType = function classType () {
        return 'adsk::fusion::ContactSets';
    };
    adsk.fusion.ContactSets.interfaceId = 'adsk.fusion.ContactSets';
    adsk.objectTypes['adsk.fusion.ContactSets'] = adsk.fusion.ContactSets;
    adsk.fusion.ContactSets.cast = function (object) {
        return object instanceof adsk.fusion.ContactSets ? object : null;
    };

    // Returns the number of contacts sets in the design.
    Object.defineProperty(adsk.fusion.ContactSets.prototype, 'count', {
        get : function () {
            var result = this._execute('count');
            return result ? result.value : undefined;
        }
    ...
    // index : The index of the item within the collection to return. The first item in the collection has an index of 0.
    // Returns the specified item or null if an invalid index was specified.
    adsk.fusion.ContactSets.prototype.item = function (index) {
        if (!isFinite(index)) { throw new TypeError('index must be a number'); }
        var args = {
            index : Number(index)
        };
        var result = this._execute('item', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ContactSet) : null;
    };

    //
    // name :
    //
    adsk.fusion.ContactSets.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    adsk.fusion.ContactSets.prototype.add = function (occurrencesAndBodies) {
        if (!Array.isArray(occurrencesAndBodies)) { throw new TypeError('occurrencesAndBodies must be an array'); }
        var occurrencesAndBodiesLength = occurrencesAndBodies.length;
        var occurrencesAndBodiesIt;
        for (occurrencesAndBodiesIt = 0; occurrencesAndBodiesIt < occurrencesAndBodiesLength; ++occurrencesAndBodiesIt) {
            if (occurrencesAndBodies[occurrencesAndBodiesIt] !== null && !(occurrencesAndBodies[occurrencesAndBodiesIt] instanceof adsk.core.Base)) { throw new TypeError('occurrencesAndBodies[occurrencesAndBodiesIt] must be a adsk.core.Base'); }
        }
        var args = {
            occurrencesAndBodies : occurrencesAndBodies
        };
        var result = this._execute('add', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.ContactSet) : null;
    };
    ...
    adsk.fusion.Joint.classType = function classType () {
        return 'adsk::fusion::Joint';
    };
    ...
    // Returns the parameter controlling the offset between the two input geometries. This is effectively the offset distance between the two planes defined by the primary and secondary axes of the input geometries.
    ...
    Object.defineProperty(adsk.fusion.Joint.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.Joint.prototype, 'healthState', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Joint.prototype, 'errorOrWarningMessage', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Joint.prototype, 'occurrenceOne', {
        get : function () {
            var result = this._execute('occurrenceOne');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.Occurrence) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.Joint.prototype, 'occurrenceTwo', {
        get : function () {
            var result = this._execute('occurrenceTwo');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.Occurrence) : null;
        }
    ...
    adsk.fusion.JointGeometry.classType = function classType () {
    ...
    // Returns the direction of the primary axis that's been calculated for this joint geometry. Conceptually, this is the X-axis of the computed coordinate system.
    ...
    // Returns the direction of the secondary axis that's been calculated for this joint geometry. Conceptually, this is the Y-axis of the computed coordinate system.
    ...
    // Returns the direction of the third axis that's been calculated for this joint geometry. Conceptually, this is the Z-axis of the computed coordinate system.
    ...
    adsk.fusion.JointInput.classType = function classType () {
        return 'adsk::fusion::JointInput';
    };
    ...
    adsk.fusion.JointLimits.classType = function classType () {
        return 'adsk::fusion::JointLimits';
    };
    ...
    adsk.fusion.JointList.classType = function classType () {
        return 'adsk::fusion::JointList';
    };
    ...
    adsk.fusion.JointMotion.classType = function classType () {
        return 'adsk::fusion::JointMotion';
    };
    ...
    adsk.fusion.JointOrigin.classType = function classType () {
        return 'adsk::fusion::JointOrigin';
    };
    ...
    Object.defineProperty(adsk.fusion.JointOrigin.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    adsk.fusion.JointOriginInput.classType = function classType () {
        return 'adsk::fusion::JointOriginInput';
    };
    ...
    adsk.fusion.JointOriginList.classType = function classType () {
        return 'adsk::fusion::JointOriginList';
    };
    ...
    adsk.fusion.JointOrigins.classType = function classType () {
        return 'adsk::fusion::JointOrigins';
    };
    ...
    adsk.fusion.Joints.classType = function classType () {
        return 'adsk::fusion::Joints';
    };
    ...
    adsk.fusion.Occurrence.classType = function classType () {
    ...
    // Gets and sets whether this occurrence is isolated in the UI. When an occurrence is isolated it is the only one visible in the user-interface. Only one occurrence can be isolated at a time so setting this property to true will unisolate an occurrence that is currently isolated. Setting this property to false for an occurrence that is current isolated will unisolate it so that no occurrence will be isolated.
    ...
    Object.defineProperty(adsk.fusion.Occurrence.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.Occurrence.prototype, 'bRepBodies', {
        get : function () {
            var result = this._execute('bRepBodies');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BRepBodies) : null;
        }
    ...
    adsk.fusion.Occurrence.prototype.getPhysicalProperties = function (accuracy) {
        ...
        var result = this._execute('getPhysicalProperties', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.PhysicalProperties) : null;
    };
    ...
    adsk.fusion.OccurrenceList.classType = function classType () {
        return 'adsk::fusion::OccurrenceList';
    };
    ...
    adsk.fusion.OccurrenceList.prototype.itemByName = function (name) {
        if (name === undefined || name === null || name.constructor !== String) { throw new TypeError('name must be a string'); }
        var args = {
            name : name
        };
    ...
    adsk.fusion.Occurrences.classType = function classType () {
        return 'adsk::fusion::Occurrences';
    };
    ...
    adsk.fusion.RigidGroup.classType = function classType () {
        return 'adsk::fusion::RigidGroup';
    };
    ...
    Object.defineProperty(adsk.fusion.RigidGroup.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    adsk.fusion.RigidGroupList.classType = function classType () {
        return 'adsk::fusion::RigidGroupList';
    };
    ...
    adsk.fusion.RigidGroups.classType = function classType () {
        return 'adsk::fusion::RigidGroups';
    };
    ...
    adsk.fusion.BallJointMotion.classType = function classType () {
        return 'adsk::fusion::BallJointMotion';
    };
    ...
    adsk.fusion.Component.classType = function classType () {
    ...
    // Returns the collection of attributes associated with this face.
    Object.defineProperty(adsk.fusion.Component.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'isBodiesFolderLightBulbOn', {
        get : function () {
            var result = this._execute('isBodiesFolderLightBulbOn');
            return result ? result.value : undefined;
        },
        set : function (value) {
            if (typeof value !== 'boolean') { throw new TypeError('value must be a boolean'); }
            ...
            var result = this._execute('isBodiesFolderLightBulbOn', args);
            return result ? result.value : undefined;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'allJoints', {
        get : function () {
            var result = this._execute('allJoints');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.Joint) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'allAsBuiltJoints', {
        get : function () {
            var result = this._execute('allAsBuiltJoints');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.AsBuiltJoint) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'allJointOrigins', {
        get : function () {
            var result = this._execute('allJointOrigins');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.JointOrigin) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.Component.prototype, 'allRigidGroups', {
        get : function () {
            var result = this._execute('allRigidGroups');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
    ...
    // name : The name to use for the new document. If this is an empty string, Fusion will use the name of the component being saved.
    ...
    // accuracy : Specifies the desired level of computational accuracy of the property calculations. The default value of 'LowCalculationAccuracy' returns results within a +/- 1% error margin.
    adsk.fusion.Component.prototype.getPhysicalProperties = function (accuracy) {
        if (accuracy === null || (accuracy !== undefined && !isFinite(accuracy))) { throw new TypeError('accuracy must be a number'); }
        var args;
        if (accuracy !== undefined) {
            args = {};
    ...
    adsk.fusion.Component.prototype.transformOccurrences = function (occurrences, transforms, ignoreJoints) {
        if (!Array.isArray(occurrences)) { throw new TypeError('occurrences must be an array'); }
        var occurrencesLength = occurrences.length;
        var occurrencesIt;
        for (occurrencesIt = 0; occurrencesIt < occurrencesLength; ++occurrencesIt) {
            if (occurrences[occurrencesIt] !== null && !(occurrences[occurrencesIt] instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrences[occurrencesIt] must be a adsk.fusion.Occurrence'); }
        }
        if (!Array.isArray(transforms)) { throw new TypeError('transforms must be an array'); }
        var transformsLength = transforms.length;
        var transformsIt;
        for (transformsIt = 0; transformsIt < transformsLength; ++transformsIt) {
            if (transforms[transformsIt] !== null && !(transforms[transformsIt] instanceof adsk.core.Matrix3D)) { throw new TypeError('transforms[transformsIt] must be a adsk.core.Matrix3D'); }
        }
        if (typeof ignoreJoints !== 'boolean') { throw new TypeError('ignoreJoints must be a boolean'); }
        var args = {
            occurrences : occurrences,
            transforms : transforms,
            ignoreJoints : ignoreJoints
        };
        var result = this._execute('transformOccurrences', args);
        return result ? result.value : undefined;
    };
    ...
    adsk.fusion.CylindricalJointMotion.classType = function classType () {
        return 'adsk::fusion::CylindricalJointMotion';
    };
    ...
    adsk.fusion.PinSlotJointMotion.classType = function classType () {
        return 'adsk::fusion::PinSlotJointMotion';
    };
    ...
    adsk.fusion.PlanarJointMotion.classType = function classType () {
        return 'adsk::fusion::PlanarJointMotion';
    };
    ...
    adsk.fusion.RevoluteJointMotion.classType = function classType () {
        return 'adsk::fusion::RevoluteJointMotion';
    };
    ...
    adsk.fusion.RigidJointMotion.classType = function classType () {
        return 'adsk::fusion::RigidJointMotion';
    };
    ...
    adsk.fusion.SliderJointMotion.classType = function classType () {
        return 'adsk::fusion::SliderJointMotion';
    };
