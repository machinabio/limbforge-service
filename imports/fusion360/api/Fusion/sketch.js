...
(function (root, factory) {
    ...
    adsk.fusion.GeometricConstraint.classType = function classType () {
        return 'adsk::fusion::GeometricConstraint';
    };
    ...
    Object.defineProperty(adsk.fusion.GeometricConstraint.prototype, 'attributes', {
        get : function () {
    ...
    adsk.fusion.GeometricConstraintList.classType = function classType () {
        return 'adsk::fusion::GeometricConstraintList';
    };
    ...
    adsk.fusion.GeometricConstraints.classType = function classType () {
        return 'adsk::fusion::GeometricConstraints';
    };
    ...
    adsk.fusion.Profile.classType = function classType () {
        return 'adsk::fusion::Profile';
    };
    ...
    adsk.fusion.Profile.prototype.areaProperties = function (accuracy) {
        if (accuracy === null || (accuracy !== undefined && !isFinite(accuracy))) { throw new TypeError('accuracy must be a number'); }
        var args;
        if (accuracy !== undefined) {
            args = {};
            args.accuracy = Number(accuracy);
        }
        var result = this._execute('areaProperties', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.AreaProperties) : null;
    };
    ...
    adsk.fusion.ProfileCurve.classType = function classType () {
        return 'adsk::fusion::ProfileCurve';
    };
    ...
    adsk.fusion.ProfileCurves.classType = function classType () {
        return 'adsk::fusion::ProfileCurves';
    };
    ...
    adsk.fusion.ProfileLoop.classType = function classType () {
        return 'adsk::fusion::ProfileLoop';
    };
    ...
    adsk.fusion.ProfileLoops.classType = function classType () {
        return 'adsk::fusion::ProfileLoops';
    };
    ...
    adsk.fusion.Profiles.classType = function classType () {
        return 'adsk::fusion::Profiles';
    };
    ...
    adsk.fusion.Sketch.classType = function classType () {
    ...
    // Gets and sets the construction plane or planar face the sketch is associated to. This is only valid when the IsParametric property is True otherwise this returns null and setting the property will fail. Setting this property is the equivalent of the Redefine command.
    ...
    Object.defineProperty(adsk.fusion.Sketch.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.Sketch.prototype, 'baseOrFormFeature', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Sketch.prototype, 'healthState', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.Sketch.prototype, 'errorOrWarningMessage', {
        get : function () {
    ...
    // Returns true if the operation was successful.
    adsk.fusion.Sketch.prototype.redefine = function (planarEntity) {
    ...
    adsk.fusion.SketchArcs.classType = function classType () {
        return 'adsk::fusion::SketchArcs';
    };
    ...
    adsk.fusion.SketchCircles.classType = function classType () {
        return 'adsk::fusion::SketchCircles';
    };
    ...
    adsk.fusion.SketchConicCurves.classType = function classType () {
        return 'adsk::fusion::SketchConicCurves';
    };
    ...
    adsk.fusion.SketchCurves.classType = function classType () {
        return 'adsk::fusion::SketchCurves';
    };
    ...
    adsk.fusion.SketchDimension.classType = function classType () {
        return 'adsk::fusion::SketchDimension';
    };
    ...
    // Gets and sets if the dimension is Driving or is Driven. Setting this property to true for a given dimension may fail if the result would overconstrain the sketch. Fusion does not allow overconstrained sketches.
    ...
    Object.defineProperty(adsk.fusion.SketchDimension.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    adsk.fusion.SketchDimensionList.classType = function classType () {
        return 'adsk::fusion::SketchDimensionList';
    };
    ...
    adsk.fusion.SketchDimensions.classType = function classType () {
        return 'adsk::fusion::SketchDimensions';
    };
    ...
    adsk.fusion.SketchDimensions.prototype.addDistanceDimension = function (pointOne, pointTwo, orientation, textPoint, isDriving) {
        if (pointOne !== null && !(pointOne instanceof adsk.fusion.SketchPoint)) { throw new TypeError('pointOne must be a adsk.fusion.SketchPoint'); }
        if (pointTwo !== null && !(pointTwo instanceof adsk.fusion.SketchPoint)) { throw new TypeError('pointTwo must be a adsk.fusion.SketchPoint'); }
        ...
        if (isDriving === null || (isDriving !== undefined && typeof isDriving !== 'boolean')) { throw new TypeError('isDriving must be a boolean'); }
        var args = {
            pointOne : (pointOne === null ? pointOne : pointOne.handle),
            pointTwo : (pointTwo === null ? pointTwo : pointTwo.handle),
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addOffsetDimension = function (line, entityTwo, textPoint, isDriving) {
        if (line !== null && !(line instanceof adsk.fusion.SketchLine)) { throw new TypeError('line must be a adsk.fusion.SketchLine'); }
        if (entityTwo !== null && !(entityTwo instanceof adsk.fusion.SketchEntity)) { throw new TypeError('entityTwo must be a adsk.fusion.SketchEntity'); }
        if (textPoint !== null && !(textPoint instanceof adsk.core.Point3D)) { throw new TypeError('textPoint must be a adsk.core.Point3D'); }
        if (isDriving === null || (isDriving !== undefined && typeof isDriving !== 'boolean')) { throw new TypeError('isDriving must be a boolean'); }
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addAngularDimension = function (lineOne, lineTwo, textPoint, isDriving) {
        if (lineOne !== null && !(lineOne instanceof adsk.fusion.SketchLine)) { throw new TypeError('lineOne must be a adsk.fusion.SketchLine'); }
        if (lineTwo !== null && !(lineTwo instanceof adsk.fusion.SketchLine)) { throw new TypeError('lineTwo must be a adsk.fusion.SketchLine'); }
        if (textPoint !== null && !(textPoint instanceof adsk.core.Point3D)) { throw new TypeError('textPoint must be a adsk.core.Point3D'); }
        if (isDriving === null || (isDriving !== undefined && typeof isDriving !== 'boolean')) { throw new TypeError('isDriving must be a boolean'); }
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addDiameterDimension = function (entity, textPoint, isDriving) {
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addRadialDimension = function (entity, textPoint, isDriving) {
        if (entity !== null && !(entity instanceof adsk.fusion.SketchCurve)) { throw new TypeError('entity must be a adsk.fusion.SketchCurve'); }
        if (textPoint !== null && !(textPoint instanceof adsk.core.Point3D)) { throw new TypeError('textPoint must be a adsk.core.Point3D'); }
        if (isDriving === null || (isDriving !== undefined && typeof isDriving !== 'boolean')) { throw new TypeError('isDriving must be a boolean'); }
        var args = {
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addEllipseMajorRadiusDimension = function (ellipse, textPoint, isDriving) {
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addEllipseMinorRadiusDimension = function (ellipse, textPoint, isDriving) {
        if (ellipse !== null && !(ellipse instanceof adsk.fusion.SketchCurve)) { throw new TypeError('ellipse must be a adsk.fusion.SketchCurve'); }
        if (textPoint !== null && !(textPoint instanceof adsk.core.Point3D)) { throw new TypeError('textPoint must be a adsk.core.Point3D'); }
        if (isDriving === null || (isDriving !== undefined && typeof isDriving !== 'boolean')) { throw new TypeError('isDriving must be a boolean'); }
        var args = {
    ...
    // isDriving : Optional argument that specifies if a driving (the dimension controls the geoemtry) or a driven (the geometry controls the dimension) dimension is created. If not provided a driving dimension will be created.
    // Returns the newly created dimension or null if the creation failed.
    adsk.fusion.SketchDimensions.prototype.addConcentricCircleDimension = function (circleOne, circleTwo, textPoint, isDriving) {
    ...
    adsk.fusion.SketchEllipses.classType = function classType () {
        return 'adsk::fusion::SketchEllipses';
    };
    ...
    adsk.fusion.SketchEllipticalArcs.classType = function classType () {
        return 'adsk::fusion::SketchEllipticalArcs';
    };
    ...
    adsk.fusion.SketchEntity.classType = function classType () {
        return 'adsk::fusion::SketchEntity';
    };
    ...
    // Returns the collection of attributes associated with this face.
    Object.defineProperty(adsk.fusion.SketchEntity.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    adsk.fusion.SketchEntityList.classType = function classType () {
        return 'adsk::fusion::SketchEntityList';
    };
    ...
    adsk.fusion.Sketches.classType = function classType () {
        return 'adsk::fusion::Sketches';
    };
    ...
    // Returns the newly created Sketch or null if the creation failed.
    adsk.fusion.Sketches.prototype.addToBaseOrFormFeature = function (planarEntity, targetBaseOrFormFeature, includeFaceEdges) {
        if (planarEntity !== null && !(planarEntity instanceof adsk.core.Base)) { throw new TypeError('planarEntity must be a adsk.core.Base'); }
        if (targetBaseOrFormFeature !== null && !(targetBaseOrFormFeature instanceof adsk.core.Base)) { throw new TypeError('targetBaseOrFormFeature must be a adsk.core.Base'); }
        if (typeof includeFaceEdges !== 'boolean') { throw new TypeError('includeFaceEdges must be a boolean'); }
        var args = {
            planarEntity : (planarEntity === null ? planarEntity : planarEntity.handle),
            targetBaseOrFormFeature : (targetBaseOrFormFeature === null ? targetBaseOrFormFeature : targetBaseOrFormFeature.handle),
            includeFaceEdges : includeFaceEdges
        };
        var result = this._execute('addToBaseOrFormFeature', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.Sketch) : null;
    };
    ...
    adsk.fusion.SketchFittedSplines.classType = function classType () {
        return 'adsk::fusion::SketchFittedSplines';
    };
    ...
    // Returns the newly created SketchFittedSpline object if the creation was successful or null if it failed.
    adsk.fusion.SketchFittedSplines.prototype.addByNurbsCurve = function (nurbsCurve) {
        ...
        var result = this._execute('addByNurbsCurve', args);
        return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SketchFittedSpline) : null;
    };
    ...
    adsk.fusion.SketchFixedSplines.classType = function classType () {
        return 'adsk::fusion::SketchFixedSplines';
    };
    ...
    adsk.fusion.SketchLineList.classType = function classType () {
        return 'adsk::fusion::SketchLineList';
    };
    ...
    adsk.fusion.SketchLines.classType = function classType () {
        return 'adsk::fusion::SketchLines';
    };
    ...
    adsk.fusion.SketchPointList.classType = function classType () {
        return 'adsk::fusion::SketchPointList';
    };
    ...
    adsk.fusion.SketchPoints.classType = function classType () {
        return 'adsk::fusion::SketchPoints';
    };
    ...
    adsk.fusion.SketchTextInput.classType = function classType () {
        return 'adsk::fusion::SketchTextInput';
    };
    ...
    adsk.fusion.SketchTexts.classType = function classType () {
        return 'adsk::fusion::SketchTexts';
    };
    ...
    adsk.fusion.CircularPatternConstraint.classType = function classType () {
        return 'adsk::fusion::CircularPatternConstraint';
    };
    ...
    adsk.fusion.CoincidentConstraint.classType = function classType () {
        return 'adsk::fusion::CoincidentConstraint';
    };
    ...
    adsk.fusion.CollinearConstraint.classType = function classType () {
        return 'adsk::fusion::CollinearConstraint';
    };
    ...
    adsk.fusion.ConcentricConstraint.classType = function classType () {
        return 'adsk::fusion::ConcentricConstraint';
    };
    ...
    adsk.fusion.EqualConstraint.classType = function classType () {
        return 'adsk::fusion::EqualConstraint';
    };
    ...
    adsk.fusion.HorizontalConstraint.classType = function classType () {
        return 'adsk::fusion::HorizontalConstraint';
    };
    ...
    adsk.fusion.HorizontalPointsConstraint.classType = function classType () {
        return 'adsk::fusion::HorizontalPointsConstraint';
    };
    ...
    adsk.fusion.MidPointConstraint.classType = function classType () {
        return 'adsk::fusion::MidPointConstraint';
    };
    ...
    adsk.fusion.OffsetConstraint.classType = function classType () {
        return 'adsk::fusion::OffsetConstraint';
    };
    ...
    Object.defineProperty(adsk.fusion.OffsetConstraint.prototype, 'parentCurves', {
        get : function () {
            var result = this._execute('parentCurves');
            ...
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.SketchCurve) : null;
            }
            return resultValue
        }
    });
    ...
    Object.defineProperty(adsk.fusion.OffsetConstraint.prototype, 'childCurves', {
        get : function () {
            var result = this._execute('childCurves');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
    ...
    Object.defineProperty(adsk.fusion.OffsetConstraint.prototype, 'distance', {
        get : function () {
    ...
    // Returns the dimension controlling the offset distance. This can return null in the case where the dimension has been deleted. To change the offset distance you can use the parameter property of the returned dimension to get the parameter that controls the value and use properties on the parameter to change the value. This can return either a SketchOffsetCurvesDimension or an SketchOffsetDimension. A SketchOffsetCurvesDimension is created automatically when curves are offset but if it is deleted the offset can also be controlled by a SketchOffsetDimension.
    Object.defineProperty(adsk.fusion.OffsetConstraint.prototype, 'dimension', {
        get : function () {
            var result = this._execute('dimension');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SketchDimension) : null;
        }
    });
    ...
    // applied to the proxy - e.g. the assembly transform is applied to geometry.
    // **
    Object.defineProperty(adsk.fusion.OffsetConstraint.prototype, 'nativeObject', {
        get : function () {
            var result = this._execute('nativeObject');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.OffsetConstraint) : null;
        }
    });
    ...
    // occurrence : The occurrence that defines the context to create the proxy in.
    // Returns the proxy object or null if this isn't the NativeObject.
    adsk.fusion.OffsetConstraint.prototype.createForAssemblyContext = function (occurrence) {
        if (occurrence !== null && !(occurrence instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrence must be a adsk.fusion.Occurrence'); }
        var args = {
            occurrence : (occurrence === null ? occurrence : occurrence.handle)
        };
    ...
    adsk.fusion.ParallelConstraint.classType = function classType () {
        return 'adsk::fusion::ParallelConstraint';
    };
    ...
    adsk.fusion.PerpendicularConstraint.classType = function classType () {
        return 'adsk::fusion::PerpendicularConstraint';
    };
    ...
    adsk.fusion.PolygonConstraint.classType = function classType () {
        return 'adsk::fusion::PolygonConstraint';
    };
    ...
    Object.defineProperty(adsk.fusion.PolygonConstraint.prototype, 'lines', {
        get : function () {
            var result = this._execute('lines');
            if (!result || !Array.isArray(result.value)) {
                return undefined
            }
            var resultIter;
            var resultValue = [];
            for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
                resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.fusion.SketchLine) : null;
            }
            return resultValue
        }
    });
    ...
    adsk.fusion.RectangularPatternConstraint.classType = function classType () {
        return 'adsk::fusion::RectangularPatternConstraint';
    };
    ...
    adsk.fusion.SketchAngularDimension.classType = function classType () {
        return 'adsk::fusion::SketchAngularDimension';
    };
    ...
    adsk.fusion.SketchConcentricCircleDimension.classType = function classType () {
        return 'adsk::fusion::SketchConcentricCircleDimension';
    };
    ...
    adsk.fusion.SketchCurve.classType = function classType () {
        return 'adsk::fusion::SketchCurve';
    };
    ...
    adsk.fusion.SketchCurve.prototype.intersections = function (sketchCurves, intersectingCurves, intersectionPoints) {
        ...
        var args = {
            ...
            intersectingCurves : (intersectingCurves === null ? intersectingCurves : intersectingCurves.handle),
            intersectionPoints : (intersectionPoints === null ? intersectionPoints : intersectionPoints.handle)
        };
    ...
    adsk.fusion.SketchDiameterDimension.classType = function classType () {
        return 'adsk::fusion::SketchDiameterDimension';
    };
    ...
    adsk.fusion.SketchEllipseMajorRadiusDimension.classType = function classType () {
        return 'adsk::fusion::SketchEllipseMajorRadiusDimension';
    };
    ...
    adsk.fusion.SketchEllipseMinorRadiusDimension.classType = function classType () {
        return 'adsk::fusion::SketchEllipseMinorRadiusDimension';
    };
    ...
    adsk.fusion.SketchLinearDimension.classType = function classType () {
        return 'adsk::fusion::SketchLinearDimension';
    };
    ...
    adsk.fusion.SketchOffsetCurvesDimension.classType = function classType () {
        return 'adsk::fusion::SketchOffsetCurvesDimension';
    };
    ...
    Object.defineProperty(adsk.fusion.SketchOffsetCurvesDimension.prototype, 'offsetConstraint', {
        get : function () {
            var result = this._execute('offsetConstraint');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.OffsetConstraint) : null;
        }
    });
    ...
    // applied to the proxy - e.g. the assembly transform is applied to geometry.
    // **
    Object.defineProperty(adsk.fusion.SketchOffsetCurvesDimension.prototype, 'nativeObject', {
        get : function () {
            var result = this._execute('nativeObject');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SketchOffsetCurvesDimension) : null;
        }
    });
    ...
    // occurrence : The occurrence that defines the context to create the proxy in.
    // Returns the proxy object or null if this isn't the NativeObject.
    adsk.fusion.SketchOffsetCurvesDimension.prototype.createForAssemblyContext = function (occurrence) {
        if (occurrence !== null && !(occurrence instanceof adsk.fusion.Occurrence)) { throw new TypeError('occurrence must be a adsk.fusion.Occurrence'); }
        var args = {
            occurrence : (occurrence === null ? occurrence : occurrence.handle)
        };
    ...
    adsk.fusion.SketchOffsetDimension.classType = function classType () {
        return 'adsk::fusion::SketchOffsetDimension';
    };
    ...
    adsk.fusion.SketchPoint.classType = function classType () {
    ...
    adsk.fusion.SketchRadialDimension.classType = function classType () {
        return 'adsk::fusion::SketchRadialDimension';
    };
    ...
    adsk.fusion.SketchText.classType = function classType () {
        return 'adsk::fusion::SketchText';
    };
    ...
    adsk.fusion.SketchText.prototype.explode = function () {
        var result = this._execute('explode');
        if (!result || !Array.isArray(result.value)) {
            return undefined
        }
        var resultIter;
    ...
    adsk.fusion.SketchText.prototype.asCurves = function () {
        var result = this._execute('asCurves');
        if (!result || !Array.isArray(result.value)) {
            return undefined
        }
        var resultIter;
        var resultValue = [];
        for (resultIter = 0; resultIter < result.value.length; ++resultIter) {
            resultValue[resultIter] = (result.value[resultIter] !== undefined) ? adsk.createObject(result.value[resultIter], adsk.core.Curve3D) : null;
        }
        return resultValue
    };
    ...
    adsk.fusion.SmoothConstraint.classType = function classType () {
        return 'adsk::fusion::SmoothConstraint';
    };
    ...
    adsk.fusion.SymmetryConstraint.classType = function classType () {
        return 'adsk::fusion::SymmetryConstraint';
    };
    ...
    adsk.fusion.TangentConstraint.classType = function classType () {
        return 'adsk::fusion::TangentConstraint';
    };
    ...
    adsk.fusion.VerticalConstraint.classType = function classType () {
        return 'adsk::fusion::VerticalConstraint';
    };
    ...
    adsk.fusion.VerticalPointsConstraint.classType = function classType () {
        return 'adsk::fusion::VerticalPointsConstraint';
    };
    ...
    adsk.fusion.SketchArc.classType = function classType () {
        return 'adsk::fusion::SketchArc';
    };
    ...
    adsk.fusion.SketchCircle.classType = function classType () {
        return 'adsk::fusion::SketchCircle';
    };
    ...
    adsk.fusion.SketchConicCurve.classType = function classType () {
        return 'adsk::fusion::SketchConicCurve';
    };
    ...
    adsk.fusion.SketchEllipse.classType = function classType () {
        return 'adsk::fusion::SketchEllipse';
    };
    ...
    Object.defineProperty(adsk.fusion.SketchEllipse.prototype, 'majorAxisLine', {
        get : function () {
            var result = this._execute('majorAxisLine');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SketchLine) : null;
        }
    });
    ...
    Object.defineProperty(adsk.fusion.SketchEllipse.prototype, 'minorAxisLine', {
        get : function () {
            var result = this._execute('minorAxisLine');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.SketchLine) : null;
        }
    });
    ...
    adsk.fusion.SketchEllipticalArc.classType = function classType () {
        return 'adsk::fusion::SketchEllipticalArc';
    };
    ...
    adsk.fusion.SketchFittedSpline.classType = function classType () {
        return 'adsk::fusion::SketchFittedSpline';
    };
    ...
    adsk.fusion.SketchFixedSpline.classType = function classType () {
        return 'adsk::fusion::SketchFixedSpline';
    };
    ...
    adsk.fusion.SketchLine.classType = function classType () {
