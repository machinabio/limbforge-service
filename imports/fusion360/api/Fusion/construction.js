...
(function (root, factory) {
    ...
    adsk.fusion.ConstructionAxes = function ConstructionAxes(handle) {
    ...
    adsk.fusion.ConstructionAxes.classType = function classType () {
        return 'adsk::fusion::ConstructionAxes';
    };
    ...
    adsk.fusion.ConstructionAxis = function ConstructionAxis(handle) {
    ...
    adsk.fusion.ConstructionAxis.classType = function classType () {
    ...
    // Gets the display size of the construction axis.
    ...
    Object.defineProperty(adsk.fusion.ConstructionAxis.prototype, 'baseFeature', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.ConstructionAxis.prototype, 'attributes', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.ConstructionAxis.prototype, 'healthState', {
        get : function () {
    ...
    Object.defineProperty(adsk.fusion.ConstructionAxis.prototype, 'errorOrWarningMessage', {
        get : function () {
    ...
    adsk.fusion.ConstructionAxisDefinition = function ConstructionAxisDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisInput = function ConstructionAxisInput(handle) {
    ...
    adsk.fusion.ConstructionAxisInput.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisInput';
    };
    ...
    Object.defineProperty(adsk.fusion.ConstructionAxisInput.prototype, 'targetBaseOrFormFeature', {
        ...
        set : function (value) {
            ...
            var result = this._execute('targetBaseOrFormFeature', args);
            return result ? result.value : undefined;
        }
    });
    ...
    adsk.fusion.ConstructionPlane = function ConstructionPlane(handle) {
    ...
    adsk.fusion.ConstructionPlane.classType = function classType () {
    ...
    Object.defineProperty(adsk.fusion.ConstructionPlane.prototype, 'baseFeature', {
        get : function () {
            var result = this._execute('baseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.ConstructionPlane.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.ConstructionPlane.prototype, 'healthState', {
        get : function () {
            var result = this._execute('healthState');
            return result ? result.value : undefined;
        }
    ...
    // Returns the error or warning message in the case where the healthState property returns either WarningFeatureHealthState or ErrorFeatureHealthState. Otherwise this property returns an empty string.
    Object.defineProperty(adsk.fusion.ConstructionPlane.prototype, 'errorOrWarningMessage', {
        get : function () {
            var result = this._execute('errorOrWarningMessage');
            return result ? result.value : undefined;
        }
    ...
    Object.defineProperty(adsk.fusion.ConstructionPlane.prototype, 'transform', {
        get : function () {
    ...
    adsk.fusion.ConstructionPlaneDefinition = function ConstructionPlaneDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneInput = function ConstructionPlaneInput(handle) {
    ...
    adsk.fusion.ConstructionPlaneInput.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneInput';
    };
    ...
    // When creating a construction plane that is owned by a base or form feature, set this property to the base or form feature you want to associate the new construction plane with. By default, this is null, meaning it will not be associated with a base or form feature. Because of a current limitation, if you want to create a construction plane associated with a base or form feature, you must set this property AND call the edit method of the base or form feature, create the feature, and then call the finishEdit method of the base or form feature. The base or form feature must be in an "edit" state to be able to add any additional items to it.
    Object.defineProperty(adsk.fusion.ConstructionPlaneInput.prototype, 'targetBaseOrFormFeature', {
        get : function () {
            var result = this._execute('targetBaseOrFormFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Base) : null;
        },
    ...
    adsk.fusion.ConstructionPlanes = function ConstructionPlanes(handle) {
    ...
    adsk.fusion.ConstructionPlanes.classType = function classType () {
        return 'adsk::fusion::ConstructionPlanes';
    };
    ...
    adsk.fusion.ConstructionPoint = function ConstructionPoint(handle) {
    ...
    adsk.fusion.ConstructionPoint.classType = function classType () {
        return 'adsk::fusion::ConstructionPoint';
    };
    ...
    Object.defineProperty(adsk.fusion.ConstructionPoint.prototype, 'baseFeature', {
        get : function () {
            var result = this._execute('baseFeature');
            return (result && result.value) ? adsk.createObject(result.value, adsk.fusion.BaseFeature) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.ConstructionPoint.prototype, 'attributes', {
        get : function () {
            var result = this._execute('attributes');
            return (result && result.value) ? adsk.createObject(result.value, adsk.core.Attributes) : null;
        }
    ...
    Object.defineProperty(adsk.fusion.ConstructionPoint.prototype, 'healthState', {
        get : function () {
            var result = this._execute('healthState');
            return result ? result.value : undefined;
        }
    ...
    // Returns the error or warning message in the case where the healthState property returns either WarningFeatureHealthState or ErrorFeatureHealthState. Otherwise this property returns an empty string.
    Object.defineProperty(adsk.fusion.ConstructionPoint.prototype, 'errorOrWarningMessage', {
        get : function () {
            var result = this._execute('errorOrWarningMessage');
            return result ? result.value : undefined;
        }
    ...
    adsk.fusion.ConstructionPointDefinition = function ConstructionPointDefinition(handle) {
    ...
    adsk.fusion.ConstructionPointDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPointDefinition';
    };
    ...
    adsk.fusion.ConstructionPointInput = function ConstructionPointInput(handle) {
    ...
    adsk.fusion.ConstructionPointInput.classType = function classType () {
        return 'adsk::fusion::ConstructionPointInput';
    };
    ...
    adsk.fusion.ConstructionPoints = function ConstructionPoints(handle) {
    ...
    adsk.fusion.ConstructionPoints.classType = function classType () {
        return 'adsk::fusion::ConstructionPoints';
    };
    ...
    adsk.fusion.ConstructionAxisByLineDefinition = function ConstructionAxisByLineDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisByLineDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisByLineDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisCircularFaceDefinition = function ConstructionAxisCircularFaceDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisCircularFaceDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisCircularFaceDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisEdgeDefinition = function ConstructionAxisEdgeDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisEdgeDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisEdgeDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisNormalToFaceAtPointDefinition = function ConstructionAxisNormalToFaceAtPointDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisNormalToFaceAtPointDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisNormalToFaceAtPointDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisPerpendicularAtPointDefinition = function ConstructionAxisPerpendicularAtPointDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisPerpendicularAtPointDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisPerpendicularAtPointDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisTwoPlaneDefinition = function ConstructionAxisTwoPlaneDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisTwoPlaneDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisTwoPlaneDefinition';
    };
    ...
    adsk.fusion.ConstructionAxisTwoPointDefinition = function ConstructionAxisTwoPointDefinition(handle) {
    ...
    adsk.fusion.ConstructionAxisTwoPointDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionAxisTwoPointDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneAtAngleDefinition = function ConstructionPlaneAtAngleDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneAtAngleDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneAtAngleDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneByPlaneDefinition = function ConstructionPlaneByPlaneDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneByPlaneDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneByPlaneDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneDistanceOnPathDefinition = function ConstructionPlaneDistanceOnPathDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneDistanceOnPathDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneDistanceOnPathDefinition';
    };
    ...
    Object.defineProperty(adsk.fusion.ConstructionPlaneDistanceOnPathDefinition.prototype, 'distance', {
        get : function () {
    ...
    adsk.fusion.ConstructionPlaneMidplaneDefinition = function ConstructionPlaneMidplaneDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneMidplaneDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneMidplaneDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneOffsetDefinition = function ConstructionPlaneOffsetDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneOffsetDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneOffsetDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneTangentAtPointDefinition = function ConstructionPlaneTangentAtPointDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneTangentAtPointDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneTangentAtPointDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneTangentDefinition = function ConstructionPlaneTangentDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneTangentDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneTangentDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneThreePointsDefinition = function ConstructionPlaneThreePointsDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneThreePointsDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneThreePointsDefinition';
    };
    ...
    adsk.fusion.ConstructionPlaneTwoEdgesDefinition = function ConstructionPlaneTwoEdgesDefinition(handle) {
    ...
    adsk.fusion.ConstructionPlaneTwoEdgesDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPlaneTwoEdgesDefinition';
    };
    ...
    adsk.fusion.ConstructionPointCenterDefinition = function ConstructionPointCenterDefinition(handle) {
    ...
    adsk.fusion.ConstructionPointCenterDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPointCenterDefinition';
    };
    ...
    adsk.fusion.ConstructionPointEdgePlaneDefinition = function ConstructionPointEdgePlaneDefinition(handle) {
    ...
    adsk.fusion.ConstructionPointEdgePlaneDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPointEdgePlaneDefinition';
    };
    ...
    adsk.fusion.ConstructionPointPointDefinition = function ConstructionPointPointDefinition(handle) {
    ...
    adsk.fusion.ConstructionPointPointDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPointPointDefinition';
    };
    ...
    adsk.fusion.ConstructionPointThreePlanesDefinition = function ConstructionPointThreePlanesDefinition(handle) {
    ...
    adsk.fusion.ConstructionPointThreePlanesDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPointThreePlanesDefinition';
    };
    ...
    adsk.fusion.ConstructionPointTwoEdgesDefinition = function ConstructionPointTwoEdgesDefinition(handle) {
    ...
    adsk.fusion.ConstructionPointTwoEdgesDefinition.classType = function classType () {
        return 'adsk::fusion::ConstructionPointTwoEdgesDefinition';
    };
